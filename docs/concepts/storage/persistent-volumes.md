...
With Kubernetes 1.8, we have added Alpha support for expanding persistent volumes. In v1.9, the following volume
types support expanding Persistent volume claims.
...
#### A note about expanding EBS volumes

Expanding EBS volumes is time consuming operation.  Also, there is a per-volume quota of one modification every 6 hours.
