...
3. For soft pod anti-affiniy, `topologyKey` can be any value when specified. If the `topologyKey` was not specified, then it will use default value as `failure-domain.beta.kubernetes.io/zone`.
