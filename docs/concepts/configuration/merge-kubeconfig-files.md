...
1. Determine the actual user informatin to use. Build user information using the same
...
All file references inside of a kubeconfig file are resolved relative to the location
