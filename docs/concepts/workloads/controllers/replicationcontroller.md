...
delete`](/docs/user-guide/kubectl/v1.7/#delete).  Kubectl will scale the ReplicationController to zero and wait
...
Using kubectl, specify the `--cascade=false` option to [`kubectl delete`](/docs/user-guide/kubectl/v1.7/#delete).
...
[`kubectl rolling-update`](/docs/user-guide/kubectl/v1.7/#rolling-update). Visit [`kubectl rolling-update` task](/docs/tasks/run-application/rolling-update-replication-controller/) for more concrete examples. 
...
object](/docs/api-reference/v1.7/#replicationcontroller-v1-core).
