...
DaemonSet are similar to [Deployments](/docs/concepts/workloads/controllers/deployment.md) in that
they both create Pods, and those Pods have processes which are not expected to terminate (e.g. web servers,
storage servers).

Use a Deploymt for stateless services, like frontends, where scaling up and down the
