...
For information on using and managing a Kubernetes cluster on GKE, consult [the official documentation](/docs/).
...
For information on using and managing a Kubernetes cluster on DigitalOcean, consult [the official documentation](/docs/).
...
For information on using and managing a Kubernetes cluster on Packet, consult [the official documentation](/docs/).
