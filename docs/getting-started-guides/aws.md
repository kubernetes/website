...
* [conjure-up](/docs/setup/ubuntu/) is an open-source installer for Kubernetes that creates Kubernetes clusters with native AWS integrations on Ubuntu.
...
AWS                  | Juju         | Ubuntu        | flannel, calico, canal     | [docs](/docs/setup/ubuntu)      | 100%     | Commercial, Community
