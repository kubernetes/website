...
<li><a href="/docs/getting-started-guides/ubuntu/">Installing Kubernetes on Ubuntu</a>: Deploy a Kubernetes cluster on-premise, baremetal, cloud providers, or localhost with Charms and <code>conjure-up</code>.</li>
</ul>
