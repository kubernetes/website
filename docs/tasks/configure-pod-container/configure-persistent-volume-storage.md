...
This page shows how to configure a Pod to use a PersistentVolume for stoarage.
...
PersistentVolume uses a file or directory on the Node that is running the Pod.
...
means it has not yet been claimed by a Pod.
