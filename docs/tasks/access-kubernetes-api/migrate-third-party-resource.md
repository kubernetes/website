...
Kubernetes does not automatically migrate existing TPRs because of API changes introduced as part of
...
{% capture whatsnext %}
* Learn more about [custom resources](/docs/concepts/extensions/custom-resources/).
