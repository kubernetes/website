...
[ConfigMap](/docs/tasks/configure-pod-container/), so
...
* Learn more about [Services](/docs/concepts/services-networking/)
* Learn more about [ConfigMaps](/docs/tasks/configure-pod-container/)
