...
Once you have installed the Weave Net addon, you can follow the [NetworkPolicy getting started guide](/docs/tasks/administer-cluster/declare-network-policy) to try out Kubernetes NetworkPolicy.
