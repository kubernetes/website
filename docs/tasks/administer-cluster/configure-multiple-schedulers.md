...
{% include code.html language="yaml" file="my-scheduler.yaml" ghlink="/docs/tasks/clusters/my-scheduler.yaml" %}
...
- Pod spec without any scheduler name
  ...
  {% include code.html language="yaml" file="pod1.yaml" ghlink="/docs/tasks/clusters/pod1.yaml" %}
...
- Pod spec with `default-scheduler`
  ...
  {% include code.html language="yaml" file="pod2.yaml" ghlink="/docs/tasks/clusters/pod2.yaml" %}
...
- Pod spec with `my-scheduler`
  ...
  {% include code.html language="yaml" file="pod3.yaml" ghlink="/docs/tasks/clusters/pod3.yaml" %}
