...
By default Kubernetes retrieves termination messages from the termination message file
specified in the `terminationMessagePath` field of a Container. The default file
used is `/dev/termination-log`. By customizing this field you can tell Kubernetes
