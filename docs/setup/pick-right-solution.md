...
* [Ubuntu on LXD](/docs/setup/ubuntu/local/) supports a nine-instance deployment on localhost.
...
* [Google Compute Engine (GCE)](/docs/setup/gce/)
* [AWS](/docs/setup/aws/)
* [Azure](/docs/setup/azure/)
* [Tectonic by CoreOS](https://coreos.com/tectonic)
* [CenturyLink Cloud](/docs/setup/clc/)
* [IBM Bluemix](https://github.com/patrocinio/kubernetes-softlayer)
* [Stackpoint.io](/docs/setup/stackpoint/)
...
* [CoreOS on AWS or GCE](/docs/setup/coreos/)
* [Kubernetes on Ubuntu](/docs/setup/ubuntu/)
* [Kubespray](/docs/setup/kubespray/)

## On-Premises VMs

* [Vagrant](/docs/setup/coreos/) (uses CoreOS and flannel)
* [CloudStack](/docs/setup/cloudstack/) (uses Ansible, CoreOS and flannel)
* [Vmware vSphere](/docs/setup/vsphere/)  (uses Debian)
* [Vmware Photon Controller](/docs/setup/photon-controller/)  (uses Debian)
* [Vmware vSphere, OpenStack, or Bare Metal](/docs/setup/ubuntu/) (uses Juju, Ubuntu and flannel)
* [Vmware](/docs/setup/coreos/)  (uses CoreOS and flannel)
* [CoreOS on libvirt](/docs/setup/libvirt-coreos/)  (uses CoreOS)
* [oVirt](/docs/setup/ovirt/)
* [OpenStack Heat](/docs/setup/openstack-heat/) (uses CentOS and flannel)
* [Fedora (Multi Node)](/docs/setup/fedora/flannel_multi_node_cluster/) (uses Fedora and flannel)

## Bare Metal

* [Offline](/docs/setup/coreos/bare_metal_offline/) (no internet required.  Uses CoreOS and Flannel)
* [Fedora via Ansible](/docs/setup/fedora/fedora_ansible_config/)
* [Fedora (Single Node)](/docs/setup/fedora/fedora_manual_config/)
* [Fedora (Multi Node)](/docs/setup/fedora/flannel_multi_node_cluster/)
* [CentOS](/docs/setup/centos/centos_manual_config/)
* [Kubernetes on Ubuntu](/docs/setup/ubuntu/)
* [CoreOS on AWS or GCE](/docs/setup/coreos/)
...
GCE                  | Saltstack    | Debian | GCE         | [docs](/docs/setup/gce/)                                    | Project
Azure Container Service |              | Ubuntu | Azure       | [docs](https://azure.microsoft.com/en-us/services/container-service/)                    |  Commercial
Azure (IaaS)    |              | Ubuntu | Azure       | [docs](/docs/setup/azure/)                    |  [Community (Microsoft)](https://github.com/Azure/acs-engine)
Bare-metal           | Ansible      | Fedora | flannel     | [docs](/docs/setup/fedora/fedora_ansible_config/)           |  Project
Bare-metal           | custom       | Fedora | _none_      | [docs](/docs/setup/fedora/fedora_manual_config/)            |  Project
Bare-metal           | custom       | Fedora | flannel     | [docs](/docs/setup/fedora/flannel_multi_node_cluster/)      |  Community ([@aveshagarwal](https://github.com/aveshagarwal))
libvirt              | custom       | Fedora | flannel     | [docs](/docs/setup/fedora/flannel_multi_node_cluster/)      |  Community ([@aveshagarwal](https://github.com/aveshagarwal))
KVM                  | custom       | Fedora | flannel     | [docs](/docs/setup/fedora/flannel_multi_node_cluster/)      |  Community ([@aveshagarwal](https://github.com/aveshagarwal))
Mesos/Docker         | custom       | Ubuntu | Docker      | [docs](/docs/setup/mesos-docker/)                           |  Community ([Kubernetes-Mesos Authors](https://github.com/mesosphere/kubernetes-mesos/blob/master/AUTHORS.md))
Mesos/GCE            |              |        |             | [docs](/docs/setup/mesos/)                                  |  Community ([Kubernetes-Mesos Authors](https://github.com/mesosphere/kubernetes-mesos/blob/master/AUTHORS.md))
DCOS                 | Marathon   | CoreOS/Alpine | custom | [docs](/docs/setup/dcos/)                                   |  Community ([Kubernetes-Mesos Authors](https://github.com/mesosphere/kubernetes-mesos/blob/master/AUTHORS.md))
AWS                  | CoreOS       | CoreOS | flannel     | [docs](/docs/setup/aws/)                                 |  Community
...
Bare-metal (Offline) | CoreOS       | CoreOS | flannel     | [docs](/docs/setup/coreos/bare_metal_offline/)              |  Community ([@jeffbean](https://github.com/jeffbean))
CloudStack           | Ansible      | CoreOS | flannel     | [docs](/docs/setup/cloudstack/)                             |  Community ([@sebgoa](https://github.com/sebgoa))
Vmware vSphere       | Saltstack    | Debian | OVS         | [docs](/docs/setup/vsphere/)                                |  Community ([@imkin](https://github.com/imkin))
Vmware Photon        | Saltstack    | Debian | OVS         | [docs](/docs/setup/photon-controller/)                      |  Community ([@alainroy](https://github.com/alainroy))
...
AWS                  | Juju         | Ubuntu | flannel     | [docs](/docs/setup/ubuntu/)                                |  [Commercial](http://www.ubuntu.com/cloud/kubernetes) and [Community](https://github.com/juju-solutions/bundle-canonical-kubernetes)  ( [@matt](https://github.com/mbruzek), [@chuck](https://github.com/chuckbutler) )
GCE                  | Juju         | Ubuntu | flannel     | [docs](/docs/setup/ubuntu/)                                |  [Commercial](http://www.ubuntu.com/cloud/kubernetes) and [Community](https://github.com/juju-solutions/bundle-canonical-kubernetes)  ( [@matt](https://github.com/mbruzek), [@chuck](https://github.com/chuckbutler) )
Bare Metal           | Juju         | Ubuntu | flannel     | [docs](/docs/setup/ubuntu/)                                |  [Commercial](http://www.ubuntu.com/cloud/kubernetes) and [Community](https://github.com/juju-solutions/bundle-canonical-kubernetes)  ( [@matt](https://github.com/mbruzek), [@chuck](https://github.com/chuckbutler) )
Rackspace            | Juju         | Ubuntu | flannel     | [docs](/docs/setup/ubuntu/)                                |  [Commercial](http://www.ubuntu.com/cloud/kubernetes) and [Community](https://github.com/juju-solutions/bundle-canonical-kubernetes)  ( [@matt](https://github.com/mbruzek), [@chuck](https://github.com/chuckbutler) )
Vmware vSphere       | Juju         | Ubuntu | flannel     | [docs](/docs/setup/ubuntu/)                                |  [Commercial](http://www.ubuntu.com/cloud/kubernetes) and [Community](https://github.com/juju-solutions/bundle-canonical-kubernetes)  ( [@matt](https://github.com/mbruzek), [@chuck](https://github.com/chuckbutler) )
AWS                  | Saltstack    | Debian | AWS         | [docs](/docs/setup/aws/)                                    |  Community ([@justinsb](https://github.com/justinsb))
AWS                  | kops         | Debian | AWS         | [docs](https://github.com/kubernetes/kops/)                                  |  Community ([@justinsb](https://github.com/justinsb))
Bare-metal           | custom       | Ubuntu | flannel     | [docs](/docs/setup/ubuntu/)                                 |  Community ([@resouer](https://github.com/resouer), [@WIZARD-CXY](https://github.com/WIZARD-CXY))
libvirt/KVM          | CoreOS       | CoreOS | libvirt/KVM | [docs](/docs/setup/libvirt-coreos/)                         |  Community ([@lhuard1A](https://github.com/lhuard1A))
oVirt                |              |        |             | [docs](/docs/setup/ovirt/)                                  |  Community ([@simon3z](https://github.com/simon3z))
OpenStack Heat       | Saltstack    | CentOS | Neutron + flannel hostgw | [docs](/docs/setup/openstack-heat/)            |  Community ([@FujitsuEnablingSoftwareTechnologyGmbH](https://github.com/FujitsuEnablingSoftwareTechnologyGmbH))
