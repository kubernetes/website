...
This may be done in any of the usual ways, for example using kubectl:
...
[Federated ReplicaSets](federated-services.md)) for this purpose, as
described above.
...
failures.  And in the event of entire cluster or availability zone
