...
[`kubeadm`](/docs/setup/kubeadm/) is the command line tool for easily provisioning a secure Kubernetes cluster on top of physical or cloud servers or virtual machines (currently in alpha).
...
[`minikube`](/docs/setup/minikube/) is a tool that makes it
