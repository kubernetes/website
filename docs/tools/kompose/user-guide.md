...
Currently `kompose` does not support some Docker Compose options, which are listed on the [conversion](https://github.com/kubernetes-incubator/kompose/blob/master/docs/conversion.md) document.
