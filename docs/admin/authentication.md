...
can dynamically created and managed.  There is a controller built into the
Controller Manager that will expire and delete tokens as they expire.
...
Token ID and the second component is the Token Secret.  The token is specified in an HTTP header as:
