...
a different zone. PersistentVolumeLabel is DEPRECATED in favor of PersistentVolumeLabelController in [cloud controller manager](/docs/tasks/administer-cluster/running-cloud-controller/).
