...
{% endcapture %}
{% capture whatsnext %}
* To learn more about Authentication, see **Authentication** in [Controlling Access to the Kubernetes API](../accessing-the-api/).
* To learn more about Admission Control, see [Using Admission Controllers](../admission-controllers/).
{% endcapture %}
