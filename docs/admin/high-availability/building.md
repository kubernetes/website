...
On each node, copy the [etcd.yaml](https://github.com/kubernetes/website/blob/release-1.10/docs/admin/high-availability/etcd.yaml) file into `/etc/kubernetes/manifests/etcd.yaml`
...
Once these files exist, copy the [kube-apiserver.yaml](https://github.com/kubernetes/website/blob/release-1.10/docs/admin/high-availability/kube-apiserver.yaml) into `/etc/kubernetes/manifests/` on each master node.
...
Next, set up the descriptions of the scheduler and controller manager pods on each node by copying [kube-scheduler.yaml](https://github.com/kubernetes/website/blob/release-1.10/docs/admin/high-availability/kube-scheduler.yaml) and [kube-controller-manager.yaml](https://github.com/kubernetes/website/blob/release-1.10/docs/admin/high-availability/kube-controller-manager.yaml) into the `/etc/kubernetes/manifests/` directory.
