...
<table style="width: 100%; table-layout: fixed;">
  ...
  <tbody>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">Limit to resources in the specified API group.</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">Use the cached list of resources if available.</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">help for api-resources</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">If false, non-namespaced resources will be returned, otherwise returning namespaced resources by default.</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">Output format. One of: wide|name.</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">If non-empty, sort nodes list using specified field. The field can be either 'name' or 'kind'.</td>
    </tr>

    <tr>
      <td colspan="2">--verbs stringSlice</td>
    </tr>
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">Limit to resources that support the specified verbs.</td>
    </tr>
