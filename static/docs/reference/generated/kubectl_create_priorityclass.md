...
<table style="width: 100%; table-layout: fixed;">
  ...
  <tbody>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">description is an arbitrary string that usually provides guidelines on when this priority class should be used.</td>
    </tr>
    ...
    <tr>
      <td colspan="2">--generator string&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Default: "priorityclass/v1"</td>
    </tr>
    <tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">global-default specifies whether this PriorityClass should be considered as the default priority.</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">help for priorityclass</td>
    </tr>
    ...
    <tr>
      <td colspan="2">--preemption-policy string</td>
    </tr>
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">preemption-policy is the policy for preempting pods with lower priority.</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">the value of this priority class.</td>
    </tr>
