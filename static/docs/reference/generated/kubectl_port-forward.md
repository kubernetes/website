...
<table style="width: 100%; table-layout: fixed;">
  ...
  <tbody>
    ...
    <tr>
      <td colspan="2">--address stringSlice&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Default: [localhost]</td>
    </tr>
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">Addresses to listen on (comma separated). Only accepts IP addresses or localhost as a value. When localhost is supplied, kubectl will try to bind on both 127.0.0.1 and ::1 and will fail if neither of these addresses are available to bind.</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">help for port-forward</td>
    </tr>
