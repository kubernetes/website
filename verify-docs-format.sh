...
for file in `find docs -name "*.md" -type f`; do 
  ...
  #    Title should start with "title:" and can have several spaces between
  #    non-space content. For example, "title:", " title:", or "title: " isn't valid, 
  #    but "title: abc" and "title:    def ghi" are both valid.
