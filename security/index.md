...
You may encrypt your email to this list using the GPG keys of the [Product Security Team members](https://github.com/kubernetes/kubernetes/tree/master/docs/devel/security-release-process.md#product-security-team). Encryption using GPG is NOT required to make a disclosure.
...
Each report is acknowledged and analyzed by Product Security Team members within 3 working days. This will set off the [Security Release Process](https://github.com/kubernetes/kubernetes/tree/master/docs/devel/security-release-process.md). 
