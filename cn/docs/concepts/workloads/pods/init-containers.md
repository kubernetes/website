...
指定容器为 Init 容器，需要在 PodSpec 中添加 `initContainers` 字段，以 [v1.Container](/docs/api-reference/{{page.version}}/#container-v1-core) 类型对象的 JSON 数组的形式，还有 app 的 `containers` 数组。
