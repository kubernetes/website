...
date: '2018-04-24T09:00:00.000-04:00'
author: mattfarina
---
...
Only 4 tools were in use by more than 10% of those who took the survey with Helm being in use by 64% of them. Many more tools were used by more than 1% of people including those we directly asked about and the space for people to fill in those we didn't ask about. There is a long tail to application management tooling.

## Want To See More?

As the Application Definition Working Group is working through the data we're putting observations into a [Google Slides Document](http://bit.ly/2qTkuhx). This is a living document that will continue to grow while we look over and discuss the data.
