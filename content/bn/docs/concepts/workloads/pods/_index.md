...
[init কন্টেইনার](/bn/docs/concepts/workloads/pods/init-containers/) যে চলমান
পড স্টার্টআপের সময়। ডিবাগ করার জন্য আপনি ইনজেকশনও দিতে পারেন
[ephemeral কন্টেইনার](/bn/docs/concepts/workloads/pods/ephemeral-containers/)
...
কুবারনেটিস ক্লাস্টারের পড প্রধানট দুটি উপায়ে ব্যবহৃত হয়:
...
কিভাবে পডগুলিব্যবহার করা হয় সে সম্পর্কে আরও তথ্যের জন্য [পডগুলির সাথে কাজ](#working-with-pods) দেখুন
ওয়ার্কলোড রিসোর্স সহ।

### পড পরিচালনার জন্য ওয়ার্কলোডের রিসোর্স

সাধারণত আপনাকে সরাসরি পড তৈরি করতে হবে না, এমনকি সিঙ্গেলটন পডও। পরিবর্তে, ওয়ার্কলোড রিসোর্সগুলি ব্যবহার করে সেগুলি তৈরি করুন যেমন {{< glossary_tooltip text="রিসোর্স"
...
কারণে পডগুলি তুলনামূলকভাবে অল্পক্ষণস্থায়ী, নিষ্পত্তিযোগ্য হিসাবে ডিজাইন করা হয়েছে। যখন
...
[DNS লেবেল](/bn/docs/concepts/overview/working-with-objects/names#dns-label-names)।
...
[DaemonSets](/bn/docs/concepts/workloads/controllers/daemonset/)।
...
## একাধিক পাত্র সহ পড {#how-pods-manage-multiple-containers}
