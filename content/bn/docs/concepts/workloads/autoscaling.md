...
প্রথম পদ্ধতিটিকে _হরিজন্টাল স্কেলিং_ বলা হয়, যেখানে দ্বিতীয়টিকে _ভার্টিকাল স্কেলিং_ বলা হয়।
...
কুবারনেটিস _ম্যানুয়াল স্কেলিং_ সমর্থন করে। হরিজন্টাল স্কেলিং kubectl CLI ব্যবহার করে করা যায়।
ভার্টিকাল স্কেলিং এর জন্য, আপনাকে আপনার ওয়ার্কলোডের রিসোর্স সংজ্ঞা _patch_ করতে হবে।
...
কুবারনেটিসে _অটোস্কেলিং_ ধারণাটি নির্দেশ করে স্বয়ংক্রিয়ভাবে একটি এমন অবজেক্ট আপডেট করার ক্ষমতা যা
...
ব্যবহার করে ক্লাস্টার আকার অনুসারে আপনার ওয়ার্কলোডগুলি ভার্টিকালি স্কেল করতে পারেন।
প্রকল্পটি **বর্তমানে বিটাতে** রয়েছে এবং GitHub-এ পাওয়া যেতে পারে।
...
[_কুবারনেটিস ইভেন্ট ড্রাইভেন অটোস্কেলার_ (**KEDA**)](https://keda.sh/) ব্যবহার করে।

KEDA একটি CNCF-স্নাতক প্রকল্প যা আপনাকে প্রক্রিয়া করার জন্য ইভেন্টের সংখ্যার উপর ভিত্তি করে আপনার ওয়ার্কলোডগুলি স্কেল করতে সক্ষম করে,
উদাহরণস্বরূপ একটি কিউতে বার্তার পরিমাণ। বিভিন্ন ইভেন্ট উৎসগুলির জন্য অ্যাডাপ্টারগুলির একটি বিস্তৃত পরিসর রয়েছে যা থেকে বেছে নেওয়া যায়।
...
[ক্রন স্কেলার](https://keda.sh/docs/latest/scalers/cron/) ব্যবহার করে অর্জন করা যেতে পারে। ক্রন স্কেলার আপনাকে
