...
এই টিউটোরিয়ালে দেখবো কিভাবে একটি অ্যাপ্লিকেশনকে মিনিকিউব ও কাটাকোডা ব্যবহার করে কুবারনেটিস ক্লাস্টারে চালানো যাবে।
...
আপনি ড্যাশবোর্ড থেকে কুবারনেটস সংস্থান তৈরি করতে পারেন যেমন স্থাপনা বা পরিষেবা।
...
কমান্ডটি শেষ হওয়ার পরে, ড্যাশবোর্ডটি কুবারনেটইস ক্লাস্টারে চলতে থাকে।
...
কুবারনেটিস *পডস*(/en/docs/concepts/workloads/pods/) নেটওয়ার্কিং উদ্দেশ্যে এক বা একাধিক পাত্রের একটি গ্রুপ একসাথে গোষ্ঠীবদ্ধ করে।
এই টিউটোরিয়ালের পডটিতে (pod) শুধুমাত্র একটি পাত্র রয়েছে। কুবারনেটিস
[*Deployment*](/en/docs/concepts/workloads/controllers/deployment/) হলো পডের
এটি স্বাস্থ্য পরীক্ষা করে এবং পডের ধারকটি বন্ধ হয়ে গেলে পুনরায় চালু করে। পড তৈরি এবং স্কেলিং পরিচালনা করার উপায় হিসাবে স্থাপনের সুপারিশ করা হয়।
