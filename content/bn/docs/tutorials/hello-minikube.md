...
3. শুধুমাত্র কাটাকোডা এনভারমেন্ট (Katacoda Environment): টার্মিনাল প্যনের একদম ওপরের **যোগ চিহ্নতে** টিপুন, এবং তারপর টিপুন **Select port to view on Host 1**.
...
2. একটি অ্যাডন এনেবেল করুন, উদাহরণস্বরূপ `metrics-server`:
