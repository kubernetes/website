...
[আনুমানিক 1 বছরের প্যাচ সাপোর্ট পায়(patch support)](/releases/patch-releases/#support-period)
...
কুবারনেটিস রিলিজ এর আসন্ন **{{< skew nextMinorVersion >}}** [সময়সূচী](https://github.com/kubernetes/sig-release/tree/master/releases/release-{{< skew nextMinorVersion >}}) চেক করুন!
