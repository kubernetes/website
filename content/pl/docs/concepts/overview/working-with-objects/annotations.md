...
<!-- overview -->
Możesz używać Kubernetesowych adnotacji do dołączania dodatkowych (takich które
nie są wykorzystywane do identyfikowania) metadanych do
...
metadane do obiektów Kubernetesa. Etykiety służą do wybierania
obiektów i wyszukiwania ich zbiorów na podstawie określonych warunków. Z
kolei adnotacje nie są używane do identyfikacji ani selekcji obiektów.
...
* Metadane wykorzystywane przez lekkie narzędzia do wdrażania zmian (rollout), takie jak zapis stanu konfiguracji lub punktów kontrolnych służących do śledzenia postępu wdrożenia.
...
Na przykład, oto manifest dla Pod, który posiada adnotację `imageregistry: https://hub.docker.com/` :
