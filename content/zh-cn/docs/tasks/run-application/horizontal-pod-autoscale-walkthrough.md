...
[Horizontal Pod Autoscaler 用户指南](/zh-cn/docs/tasks/run-application/horizontal-pod-autoscale/)。
...
更多详细信息，请参阅
[Horizontal Pod Autoscaler 用户指南](/zh-cn/docs/tasks/run-application/horizontal-pod-autoscale/#support-for-custom-metrics)。
...
CPU 用量为 100 毫核。
算法的详情请参阅[相关文档](/zh-cn/docs/tasks/run-application/horizontal-pod-autoscale/#algorithm-details)。
