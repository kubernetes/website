...
-->
* [Kubernetes 中调度 Windows 容器的指南](/zh-cn/docs/setup/production-environment/windows/user-guide-windows-containers/)
* [使用组托管服务帐户（GMSA）管理工作负载身份](/zh-cn/docs/setup/production-environment/windows/user-guide-windows-containers/#managing-workload-identity-with-group-managed-service-accounts)
