...
-->
你需要一个 Kubernetes 集群。
你还需要 `kubectl`，[安装](/zh-cn/docs/tasks/tools/#kubectl)并配置好与集群的通信。
{{< version-check >}}
...
- Learn more about kubelet configuration by checking the
  ...
  reference.
-->
- [使用配置文件设置 kubelet 参数](/zh-cn/docs/tasks/administer-cluster/kubelet-config-file)说明了配置 kubelet 的方法。
