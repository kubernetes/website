...
-->
本页展示了如何在您的 Kubernetes 集群中启用和配置 DNS 服务的自动扩缩功能。
...
在 kube-system {{< glossary_tooltip text="命名空间" term_id="namespace" >}}中列出集群中的 {{< glossary_tooltip text="Deployment" term_id="deployment" >}} ：
