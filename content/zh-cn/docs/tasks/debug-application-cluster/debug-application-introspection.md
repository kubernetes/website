...
-->
* [日志](/zh-cn/docs/concepts/cluster-administration/logging/)
* [监控](/zh-cn/docs/tasks/debug-application-cluster/resource-usage-monitoring/)
* [使用 `exec` 进入容器](/zh-cn/docs/tasks/debug-application-cluster/get-shell-running-container/)
* [使用代理连接容器](/zh-cn/docs/tasks/extend-kubernetes/http-proxy-access-api/)
* [使用端口转发连接容器](/zh-cn/docs/tasks/access-application-cluster/port-forward-access-application-cluster/)
* [使用 crictl 检查节点](/zh-cn/docs/tasks/debug-application-cluster/crictl/)
