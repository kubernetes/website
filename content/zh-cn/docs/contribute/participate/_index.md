...
[特别兴趣小组](https://github.com/kubernetes/community/blob/main/sig-list.md)中的一个，
负责编写、更新和维护 Kubernetes 的总体文档。
参见[社区 GitHub 仓库中 SIG Docs](https://github.com/kubernetes/community/tree/main/sig-docs)
以进一步了解该 SIG。
...
See [community-membership](https://github.com/kubernetes/community/blob/main/community-membership.md)
...
[社区成员身份](https://github.com/kubernetes/community/blob/main/community-membership.md)。
...
如需查询当前的主席名单，
请查阅[领导人员](https://github.com/kubernetes/community/tree/main/sig-docs#leadership)。
...
结合 OWNERS 文件及 Markdown 文件的前言信息，自动化系统可以给 PR
作者可以就应该向谁请求技术和文字评阅给出建议。
