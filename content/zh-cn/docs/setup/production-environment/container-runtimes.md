...
遵循此[迁移指南](/zh-cn/docs/tasks/administer-cluster/kubeadm/configure-cgroup-driver)。
...
-->
当使用 kubeadm 时，请手动配置
[kubelet 的 cgroup 驱动](/zh-cn/docs/setup/production-environment/tools/kubeadm/install-kubeadm/#configure-cgroup-driver-used-by-kubelet-on-control-plane-node).
