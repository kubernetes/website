...
* [审计](/zh-cn/docs/tasks/debug-application-cluster/audit/)
...
* [TLS 引导](/zh-cn/docs/reference/command-line-tools-reference/kubelet-tls-bootstrapping/)
* [Kubelet 认证/授权](/zh-cn/docs/reference/command-line-tools-reference/kubelet-authentication-authorization/)
