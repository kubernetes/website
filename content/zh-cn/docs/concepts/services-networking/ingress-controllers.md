...
* [OCI Native Ingress 控制器](https://github.com/oracle/oci-native-ingress-controller#readme)
  是适用于 Oracle Cloud Infrastructure 的 Ingress 控制器，允许您管理
  [OCI 负载均衡器](https://docs.oracle.com/en-us/iaas/Content/Balance/home.htm)
