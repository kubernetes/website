...
for more details.
-->
更多细节参考[安全腾空节点](/zh-cn/docs/tasks/administer-cluster/safely-drain-node/)。
...
- 如果节点仍然无法访问：对于不可达节点上的所有 Pod 触发
  [API-发起的逐出](/zh-cn/docs/concepts/scheduling-eviction/api-eviction/)。
...
[配置](/zh-cn/docs/reference/config-api/kubelet-config.v1beta1/#kubelet-config-k8s-io-v1beta1-KubeletConfiguration)
设置为 false。
