...
请查看 [kubelet TLS 启动引导](/zh-cn/docs/reference/command-line-tools-reference/kubelet-tls-bootstrapping/)
...
最后，应该启用
[kubelet 用户认证和/或鉴权](/zh-cn/docs/reference/command-line-tools-reference/kubelet-authentication-authorization/)
来保护 kubelet API。
