...
如果为集群配置了可选的[监控工具](/zh-cn/docs/tasks/debug-application-cluster/resource-usage-monitoring/)，
则可以直接从[指标 API](/zh-cn/docs/tasks/debug-application-cluster/resource-metrics-pipeline/#the-metrics-api) 
