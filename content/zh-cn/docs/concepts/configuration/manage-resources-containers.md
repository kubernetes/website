...
通过此特性，Kubernetes 允许你为 Pod 声明一个总体资源预算，
...
`extendedResourceName`，然后符合 DeviceClass 的设备可以从
Pod 的扩展资源请求中获取。阅读更多关于
[使用 DRA 进行扩展资源分配](/zh-cn/docs/concepts/scheduling-eviction/dynamic-resource-allocation/#extended-resource)。
