...
ReplicaSet 也可以作为
[水平的 Pod 缩放器 (HPA)](/zh-cn/docs/tasks/run-application/horizontal-pod-autoscale/)
...
[`Deployment`](/zh-cn/docs/concepts/workloads/controllers/deployment/) 是一个
...
使用[`Job`](/zh-cn/docs/concepts/workloads/controllers/job/) 代替ReplicaSet，
可以用于那些期望自行终止的 Pod。
...
* 了解 [Deployments](/zh-cn/docs/concepts/workloads/controllers/deployment/)。
* [使用 Deployment 运行一个无状态应用](/zh-cn/docs/tasks/run-application/run-stateless-application-deployment/)，它依赖于 ReplicaSet。
