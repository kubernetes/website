...
-->
这篇文档基于[使用 ConfigMap 来配置 Containers](/zh-cn/docs/tasks/configure-pod-container/configure-pod-configmap/) 这个任务，提供了一个使用 ConfigMap 来配置 Redis 的真实案例。
...
* 理解[使用ConfigMap来配置Containers](/zh-cn/docs/tasks/configure-pod-container/configure-pod-configmap/)。
