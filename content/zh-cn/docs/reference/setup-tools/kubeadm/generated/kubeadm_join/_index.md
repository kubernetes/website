...
<p>
<!--
Use this token for both discovery-token and tls-bootstrap-token when those values are not provided.</p>
-->
...
<p>
<!--
[EXPERIMENTAL] The path to the 'real' host root filesystem.</p>
-->
