...
[持久化卷](/zh-cn/docs/concepts/storage/persistent-volumes/)。
...
和 [LimitRange 例子](/zh-cn/docs/tasks/administer-cluster/manage-resources/memory-default-namespace/)
以了解更多细节。
...
-->
关于持久化卷申领的更多信息，请参见
[PersistentVolumeClaims](/zh-cn/docs/concepts/storage/persistent-volumes/#persistentvolumeclaims)。
...
[云管理控制器](/zh-cn/docs/tasks/administer-cluster/running-cloud-controller/)接管。
...
for more information.
-->
查看 [Pod 安全策略文档](/zh-cn/docs/concepts/security/pod-security-policy/)
了解更多细节。
...
-->
请查看
[resourceQuota 设计文档](https://git.k8s.io/community/contributors/design-proposals/admission_control_resource_quota.md)和 [Resource Quota 例子](/zh-cn/docs/concepts/policy/resource-quotas/)
了解更多细节。
...
并且通过 [Pod 开销](/zh-cn/docs/concepts/scheduling-eviction/pod-overhead/)
...
字段的 Pod，正如任务
[为 Pod 或 Container 配置安全上下文](/zh-cn/docs/tasks/configure-pod-container/security-context/)
中所展示的那样。
如果集群没有使用 [Pod 安全性准入](/zh-cn/docs/concepts/security/pod-security-admission/)、
...
PVC/PV 不会被删除。
有关更多详细信息，请参考
[保护使用中的存储对象](/zh-cn/docs/concepts/storage/persistent-volumes/#storage-object-in-use-protection)。
