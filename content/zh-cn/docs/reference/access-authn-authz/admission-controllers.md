...
-->
详情请参见
[EventRateLimit 配置文档（v1alpha1）](/zh-cn/docs/reference/config-api/apiserver-eventratelimit.v1alpha1/)。
...
-->
请查看
[limitRange 设计文档](/zh-cn/docs/reference/kubernetes-api/policy-resources/limit-range-v1/)
...
如果你通过 [Pod 开销](/zh-cn/docs/concepts/scheduling-eviction/pod-overhead/)
