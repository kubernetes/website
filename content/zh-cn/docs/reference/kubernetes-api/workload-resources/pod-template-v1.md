...
description: "PodTemplate 描述了一种模板，用来为预定义的 Pod 生成副本。"
title: "PodTemplate"
weight: 2
---
...
-->
PodTemplate 描述了一种模板，用来为预定义的 Pod 生成副本。
...
- **template** (<a href="{{< ref "../workload-resources/pod-template-v1#PodTemplateSpec" >}}">PodTemplateSpec</a>)
  ...
  -->
  template 定义将从这个 Pod 模板创建的 Pod。https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
...
-->
PodTemplateSpec 描述从模板创建的 Pod 所应具有的数据。
