...
* [kube-apiserver configuration (v1beta1)](/zh-cn/docs/reference/config-api/apiserver-config.v1beta1/)
  - `apiserver.k8s.io/v1beta1`
...
* [kube-apiserver configuration (v1)](/zh-cn/docs/reference/config-api/apiserver-config.v1/)
  - `apiserver.config.k8s.io/v1`
...
* [kube-apiserver 事件速率限制（v1alpha1）](/zh-cn/docs/reference/config-api/apiserver-eventratelimit.v1alpha1/)
  - `eventratelimit.admission.k8s.io/v1alpha1`
    - [Configuration](/zh-cn/docs/reference/config-api/apiserver-eventratelimit.v1alpha1/#eventratelimit-admission-k8s-io-v1alpha1-Configuration)
* [kubelet configuration (v1alpha1)](/zh-cn/docs/reference/config-api/kubelet-config.v1alpha1/)
  - `kubelet.config.k8s.io/v1alpha1`
...
* [kubelet configuration (v1beta1)](/zh-cn/docs/reference/config-api/kubelet-config.v1beta1/)
  - `kubelet.config.k8s.io/v1beta1`
...
* [kubelet configuration (v1)](/zh-cn/docs/reference/config-api/kubelet-config.v1/)
  - `kubelet.config.k8s.io/v1`
...
* [Client authentication API (v1beta1)](/zh-cn/docs/reference/config-api/client-authentication.v1beta1/)
  - `client.authentication.k8s.io/v1beta1`
...
* [Client authentication API (v1)](/zh-cn/docs/reference/config-api/client-authentication.v1/)
  - `client.authentication.k8s.io/v1`
     - [ExecCredential](/zh-cn/docs/reference/config-api/client-authentication.v1/#client-authentication-k8s-io-v1-ExecCredential)
...
* [WebhookAdmission 配置（v1）](/zh-cn/docs/reference/config-api/apiserver-webhookadmission.v1/)
  - `apiserver.config.k8s.io/v1`
    - [WebhookAdmission](/zh-cn/docs/reference/config-api/apiserver-webhookadmission.v1/#apiserver-config-k8s-io-v1-WebhookAdmission)
* [ImagePolicy API（v1alpha1）](/zh-cn/docs/reference/config-api/imagepolicy.v1alpha1/)
  - `imagepolicy.k8s.io/v1alpha1`
    - [ImageReview](/zh-cn/docs/reference/config-api/imagepolicy.v1alpha1/#imagepolicy-k8s-io-v1alpha1-ImageReview)
