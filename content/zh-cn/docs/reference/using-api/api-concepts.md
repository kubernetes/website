...
所有内置准入控制插件都支持试运行。
此外，准入 Webhook 还可以设置[配置对象](/zh-cn/docs/reference/generated/kubernetes-api/{{< param "version" >}}/#webhook-v1beta1-admissionregistration-k8s-io)
...
{{< note >}}
当你 **list** 资源并收到集合响应时，
响应包括集合的[元数据](/zh-cn/docs/reference/generated/kubernetes-api/v1.21/#listmeta-v1-meta)
以及该集合中每个项目的[对象元数据](/zh-cn/docs/reference/generated/kubernetes-api/v1.21/#listmeta-v1-meta)。
