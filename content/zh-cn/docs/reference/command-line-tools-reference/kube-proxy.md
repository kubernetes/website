...
BtreeWatchCache=true|false (BETA - 默认值=true)<br/>
...
DRAResourceClaimDeviceStatus=true|false (ALPHA - 默认值=false)<br/>
...
InPlacePodVerticalScalingAllocatedStatus=true|false (ALPHA - 默认值=false)<br/>
...
KubeletFineGrainedAuthz=true|false (ALPHA - 默认值=false)<br/>
...
PodLifecycleSleepActionAllowZero=true|false (ALPHA - 默认值=false)<br/>
...
RelaxedDNSSearchValidation=true|false (ALPHA - 默认值=false)<br/>
...
RemoteRequestHeaderUID=true|false (ALPHA - 默认值=false)<br/>
...
SELinuxChangePolicy=true|false (ALPHA - 默认值=false)<br/>
SELinuxMount=true|false (ALPHA - 默认值=false)<br/>
SELinuxMountReadWriteOncePod=true|false (BETA - 默认值=true)<br/>
SchedulerAsyncPreemption=true|false (ALPHA - 默认值=false)<br/>
