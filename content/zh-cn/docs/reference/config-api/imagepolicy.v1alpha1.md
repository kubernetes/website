...
More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata</p>
  -->
  <code>metadata</code> 是一个标准的对象元数据。更多信息：
...
-->
<code>image</code> 的格式可以是 <code>image:tag</code> 或 <code>image@SHA:012345679abcdef</code>。
</p>
</td>
</tr>
</tbody>
...
appropriate prefix).
-->
<code>auditAnnotations</code> 会被通过 <code>AddAnnotation</code>
