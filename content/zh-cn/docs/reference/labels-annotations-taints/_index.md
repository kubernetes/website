...
此注解记录了绑定调度插件的结果，用于 https://sigs.k8s.io/kube-scheduler-simulator。
...
此注解记录了过滤调度插件的结果，用于 https://sigs.k8s.io/kube-scheduler-simulator。
...
此注解记录了调度器从评分调度插件计算出的最终分数，用于 https://sigs.k8s.io/kube-scheduler-simulator。
...
此注解记录了许可调度插件的结果，用于 https://sigs.k8s.io/kube-scheduler-simulator。
...
此注解记录了许可调度插件返回的超时时间，用于 https://sigs.k8s.io/kube-scheduler-simulator。
...
此注解记录了后过滤调度插件的结果，用于 https://sigs.k8s.io/kube-scheduler-simulator。
...
此注解记录了预绑定调度插件的结果，用于 https://sigs.k8s.io/kube-scheduler-simulator。
...
此注解记录了预过滤调度插件的预过滤结果，用于 https://sigs.k8s.io/kube-scheduler-simulator。
...
此注解记录了预过滤调度插件的结果，用于 https://sigs.k8s.io/kube-scheduler-simulator。
...
此注解记录了预留调度插件的结果，用于 https://sigs.k8s.io/kube-scheduler-simulator。
...
此注解记录了评分调度插件的结果，用于 https://sigs.k8s.io/kube-scheduler-simulator。
