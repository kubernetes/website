...
此注解自 Kubernetes v1.19 起已被弃用，将在 v1.25 中失效。
教程[使用 seccomp 限制容器的系统调用](/zh-cn/docs/tutorials/clusters/seccomp/)将引导你完成将
...
- [`pod-security.kubernetes.io/enforce-policy`](/zh-cn/zh/docs/reference/labels-annotations-taints/audit-annotations/#pod-security-kubernetes-io-enforce-policy)
