...
-->
securityContext 字段定义 {{< glossary_tooltip text="Pod" term_id="pod" >}}
或{{< glossary_tooltip text="容器" term_id="container" >}}的特权和访问控制设置。
...
-->
`PodSpec.securityContext` 字段配置会应用到一个 Pod 中的所有容器。
