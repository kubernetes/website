...
-->
K8s 社区中持续活跃的{{< glossary_tooltip text="贡献者" term_id="contributor" >}}。
...
-->
可以将 Issue 和 PR 指派给这些成员，他们也可以通过 GitHub Teams
加入不同的{{< glossary_tooltip text="特别兴趣小组 (SIG)" term_id="sig" >}}。
针对成员所提交的 PR，系统自动运行提交前测试。成员应该是持续活跃的社区贡献者。
