...
-->
关于 <code>cluster-info</code> 的帮助信息。
</p>
</td>
</tr>
...
-->
设置针对 <code>notReady:NoExecute</code> 的容忍度的 tolerationSeconds，
...
-->
要记录的性能分析信息。
可选值为（none|cpu|heap|goroutine|threadcreate|block|mutex|trace）。
</p>
</td>
</tr>
...
* [kubectl cluster-info dump](kubectl_cluster-info_dump/) - 转储相关信息以便进行调试和诊断
