...
* [kubectl create service clusterip](../kubectl_create_service_clusterip/) - 创建 ClusterIP Service
* [kubectl create service externalname](../kubectl_create_service_externalname/) - 创建 ExternalName Service
* [kubectl create service loadbalancer](../kubectl_create_service_loadbalancer/) - 创建 LoadBalancer Service
* [kubectl create service nodeport](../kubectl_create_service_nodeport/) - 创建 NodePort Service
