...
* [kubectl create clusterrole](kubectl_create_clusterrole/) - 创建集群角色
* [kubectl create clusterrolebinding](kubectl_create_clusterrolebinding/) - 为特定集群角色创建集群角色绑定
* [kubectl create configmap](kubectl_create_configmap/) - 使用本地文件、目录或文字值创建 ConfigMap
* [kubectl create cronjob](kubectl_create_cronjob/) - 用指定的名称创建定时 Job
* [kubectl create deployment](kubectl_create_deployment/) - 用指定的名称创建 Deployment
* [kubectl create ingress](kubectl_create_ingress/) - 用指定的名称创建 Ingress
* [kubectl create job](kubectl_create_job/) - 用指定的名称创建 Job
* [kubectl create namespace](kubectl_create_namespace/) - 用指定的名称创建命名空间
* [kubectl create poddisruptionbudget](kubectl_create_poddisruptionbudget/) - 用指定的名称创建 Pod 干扰预算
* [kubectl create priorityclass](kubectl_create_priorityclass/) - 用指定的名称创建优先级类
* [kubectl create quota](kubectl_create_quota/) - 用指定的名称创建配额
* [kubectl create role](kubectl_create_role/) - 创建具有单一规则的角色
* [kubectl create rolebinding](kubectl_create_rolebinding/) - 为特定角色或集群角色创建角色绑定
* [kubectl create secret](kubectl_create_secret/) - 使用指定的子命令创建 Secret
* [kubectl create service](kubectl_create_service/) - 使用指定的子命令创建 Service
* [kubectl create serviceaccount](kubectl_create_serviceaccount/) - 用指定的名称创建服务账户
* [kubectl create token](kubectl_create_token/) - 请求服务账户令牌
