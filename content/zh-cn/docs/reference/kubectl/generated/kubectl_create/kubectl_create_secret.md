...
* [kubectl create secret docker-registry](../kubectl_create_secret_docker-registry/) - 创建 Docker 仓库所用的 Secret
* [kubectl create secret generic](../kubectl_create_secret_generic/) - 基于本地文件、目录或文字值创建 Secret
* [kubectl create secret tls](../kubectl_create_secret_tls/) - 创建 TLS Secret
