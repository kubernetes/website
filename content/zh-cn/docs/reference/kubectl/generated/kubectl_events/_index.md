...
```shell
kubectl events [(-o|--output=)json|kyaml|yaml|name|go-template|go-template-file|template|templatefile|jsonpath|jsonpath-as-json|jsonpath-file] [--for TYPE/NAME] [--watch] [--types=Normal,Warning]
```
...
-->
* [kubectl](../kubectl/) - kubectl 控制 Kubernetes 集群管理
