...
“debug” 针对按资源和名称标识的集群对象为常用的调试任务提供自动化操作。
如果不指定资源，则默认使用 Pod。
...
<tr>
<td colspan="2">--profile string&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--Default: "general"-->默认值："general"</td>
</tr>
<tr>
<td></td>
<td style="line-height: 130%; word-wrap: break-word;">
...
-->
可选项包括 "general"、"baseline"、"restricted"、"netadmin" 或 "sysadmin"。
默认值："general"
</p>
</td>
</tr>
...
-->
当与 <code>--copy-to</code> 一起使用时，提供一个 name=image 对的列表以更改容器镜像，类似于
<code>kubectl set image</code> 的工作方式。
</p>
</td>
</tr>
...
-->
--version, --version=raw 打印版本信息并退出；--version=vX.Y.Z...
设置报告的版本。
</p>
</td>
</tr>
