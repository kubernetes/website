...
no_list: true
description: >-
  调整 Deployment、ReplicaSet 或 Replication 控制器副本数
---
<!--
title: kubectl scale
content_type: tool-reference
...
如果指定了 `--current-replicas` 或 `--resource-version`，则在尝试扩缩容之前这些参数会被验证，
...
<tr>
<td colspan="2">--current-replicas int&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--Default:-->默认值：-1</td>
</tr>
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;">
<p>
