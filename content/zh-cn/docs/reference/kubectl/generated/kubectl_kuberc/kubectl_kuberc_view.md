...
-->
```shell
# 以 YAML 格式查看 kuberc 配置（默认）
kubectl kuberc view
  
# 以 JSON 格式查看 kuberc 配置
...
-->
如果为 true，则在模板中缺少字段或映射键时忽略模板中的所有错误。
...
-->
当 -o=go-template 或 -o=go-template-file 时要使用的模板字符串或模板文件路径。
