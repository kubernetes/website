...
有关更多示例，请参看 kubectl [参考文档](/zh-cn/docs/reference/kubectl/overview/#custom-columns)。
...
-->
* 参阅 [kubectl 概述](/zh-cn/docs/reference/kubectl/overview/)，进一步了解[JsonPath](/zh-cn/docs/reference/kubectl/jsonpath)。
