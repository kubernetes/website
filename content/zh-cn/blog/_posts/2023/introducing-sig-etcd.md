...
When the need arises, [new SIGs can be created](https://github.com/kubernetes/community/blob/main/sig-wg-lifecycle.md),
and that was precisely what happened recently.
-->
特殊兴趣小组（SIG）是 Kubernetes 项目的基本组成部分，很大一部分的 Kubernetes 社区活动都在其中进行。
当有需要时，可以创建[新的 SIG](https://github.com/kubernetes/community/blob/main/sig-wg-lifecycle.md)，
而这正是最近发生的事情。

<!--
[SIG etcd](https://github.com/kubernetes/community/blob/main/sig-etcd/README.md)
...
[PRR](https://github.com/kubernetes/community/blob/main/sig-architecture/production-readiness.md),
...
[Charter](https://github.com/kubernetes/community/blob/main/sig-etcd/charter.md)
and [Vision](https://github.com/kubernetes/community/blob/main/sig-etcd/vision.md).
...
最近创建的 SIG 已经在努力实现其[章程](https://github.com/kubernetes/community/blob/main/sig-etcd/charter.md)
...
[visit our page](https://github.com/kubernetes/community/blob/main/sig-etcd/README.md),
...
感兴趣的人[访问我们的页面](https://github.com/kubernetes/community/blob/main/sig-etcd/README.md)、
