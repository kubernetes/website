...
[SIG Architecture：API 治理](https://github.com/kubernetes/community/blob/main/sig-architecture/README.md#architecture-and-api-governance-1)。**
...
-->
**JL**：我们有[指南和约定](https://github.com/kubernetes/community/blob/main/contributors/devel/sig-architecture/api-conventions.md)，
...
-->
有时候受限于带宽，团队会在没有得到
[API Review](https://github.com/kubernetes/community/blob/main/sig-architecture/api-review-process.md)
