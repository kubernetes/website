...
<!--
## Get involved
The simplest way to get involved with Kubernetes is to join one of the many [Special Interest Groups](https://github.com/kubernetes/community/blob/main/sig-list.md) (SIGs) that align with your interests. 
...
参与 Kubernetes 最简单的方式就是加入与你兴趣相关的[特别兴趣小组（SIG）](https://github.com/kubernetes/community/blob/main/sig-list.md)。
