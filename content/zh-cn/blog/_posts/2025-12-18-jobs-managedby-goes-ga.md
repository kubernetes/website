---
layout: blog
title: "Kubernetes v1.35：Job Managed By 功能正式发布（GA）"
...
-->
如果你计划实现一个外部控制器，请注意：你的控制器需要符合[Job API](/zh-cn/docs/reference/kubernetes-api/workload-resources/job-v1/) 
的定义。
...
-->
这项工作由 Kubernetes 的[Batch Working Group](https://github.com/kubernetes/community/tree/master/wg-batch)赞助，
并与[SIG Apps](https://github.com/kubernetes/community/tree/master/sig-apps)紧密协作，
同时也得到了[SIG Scheduling](https://github.com/kubernetes/community/tree/master/sig-scheduling)社区的强力支持与投入。
