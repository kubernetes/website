...
See the list of [stable Kubernetes metrics here](https://github.com/kubernetes/kubernetes/blob/v1.21.0/test/instrumentation/testdata/stable-metrics-list.yaml)
