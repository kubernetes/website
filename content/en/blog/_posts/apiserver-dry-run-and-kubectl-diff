...
automation through CI/CD pipelines. The Apply working-group[1] is working on
fixing some of the gaps, and is happy to announce that Kubernetes
...
- Specify in the `sideEffects`[3] field of the
  `admissionregistration.k8s.io/v1beta1.Webhook` object to indicate that the object doesn't
...
[1]: https://groups.google.com/forum/#!forum/kubernetes-wg-apply
[2]: https://kubernetes.io/docs/reference/using-api/api-concepts/#dry-run
[3]: https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.13/#webhook-v1beta1-admissionregistration
