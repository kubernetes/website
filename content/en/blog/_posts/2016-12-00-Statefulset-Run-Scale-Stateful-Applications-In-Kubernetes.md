...
```
$  kubectl apply -f [https://kubernetes.io/docs/tutorials/stateful-application/zookeeper/](https://raw.githubusercontent.com/kubernetes/kubernetes.github.io/master/docs/tutorials/stateful-application/zookeeper.yaml)
