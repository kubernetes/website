---
layout: blog
title: "User preferences (kuberc) are available for testing in kubectl 1.34"
date: 2025-XX-XX
slug:
slug: kubectl-kuberc-beta
Author: >
  [Maciej Szulik](https://github.com/soltysh) (Defense Unicorns, Inc.)
---

Have you ever wished you could enable [interactive delete](https://github.com/kubernetes/enhancements/issues/3895),
...
Look no further. [SIG-CLI](https://github.com/kubernetes/community/tree/master/sig-cli/)
has been working hard to add [user preferences to kubectl](https://github.com/kubernetes/enhancements/issues/3104),
...
and the [actual proposal](https://github.com/kubernetes/enhancements/blob/master/keps/sig-cli/3104-introduce-kuberc/README.md).
...
or open an issue against [kubectl repository](https://github.com/kubernetes/kubectl/).
You can also join us at our [community meetings](https://github.com/kubernetes/community/tree/master/sig-cli/#meetings),
