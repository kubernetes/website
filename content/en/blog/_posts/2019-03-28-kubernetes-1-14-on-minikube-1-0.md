...
{{<figure width="600" link="https://unsplash.com/photos/UGKfiS5CcZI" caption=Source: [Unsplash](https://unsplash.com/photos/UGKfiS5CcZI)">}}
...
{{<figure width="600" src="/content/en/docs/tutorials/kubernetes-basics/public/images/module_01_cluster.svg" caption="Minikube architecture (source: kubernetes.io)">}}
