...
- `registry.k8s.io/etcd:3.3.15` (updated after publication, previously used registry "k8s.gcr.io")
- `registry.k8s.io/pause:3.1` (updated after publication, previously used registry "k8s.gcr.io")
