...
For many years, in order to enrich the ecology of the open source community, Inspur has been working on adapting Kubernetes to MIPS architecture. With the continuous iterative optimization and the performance improvement of MIPS CPU, we have made some breakthrough progresses on mips64el platform.
