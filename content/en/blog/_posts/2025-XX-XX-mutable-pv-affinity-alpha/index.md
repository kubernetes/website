...
The PersistentVolume [NodeAffinity](https://kubernetes.io/docs/concepts/storage/persistent-volumes/#node-affinity) API
...
We now making it mutable in Kubernetes v1.35 (alpha), Open a door to more flexible online volume management.
...
They just stay there for years, unchanged.
