...
Kubernetes 1.25 brings cgroup v2 to GA, letting the kubelet use the latest
...
memory QoS and relies on cgroup v2 primitives to enable it. New resource
...
to set cgroup limits. When using cgroup v2, it's strongly recommended that both
