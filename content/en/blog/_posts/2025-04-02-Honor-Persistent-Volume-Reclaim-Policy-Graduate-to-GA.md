---
layout: blog
title: 'Kubernetes 1.33: Prevent PersistentVolume Leaks When Deleting out of Order graduates to GA'
date: 2025-04-02
...
We are thrilled to announce that the feature to prevent
...
Kubernetes 1.33! This improvement, initially introduced as a beta
feature in Kubernetes 1.31, ensures that your storage resources are properly
...
With the graduation to GA in Kubernetes 1.33, this issue is now resolved. Kubernetes
now reliably honors the configured reclaim policy, even when PVs are deleted
