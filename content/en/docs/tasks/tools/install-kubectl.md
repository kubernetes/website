...
You must use a kubectl version that is the same, or later, as the version of your cluster. It is always recommended to use the latest version of kubectl to avoid any unforeseen issues.
{{% /capture %}}
