...
If you didn't install through homebrew you now need to ensure that the kubectl completion script gets sourced in all your shell sessions. There are multiple ways in which you can do this:
