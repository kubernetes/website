...
[kubefed guide](/docs/tasks/federation/set-up-cluster-federation-kubefed/#adding-a-cluster-to-a-federation).
...
[kubefed guide](/docs/tasks/federation/set-up-cluster-federation-kubefed/#removing-a-cluster-from-a-federation).
...
The full clusters API reference is currently in `federation/v1beta1` (deprecated).
