...
[Kube-apiserver](https://kubernetes.io/docs/reference/command-line-tools-reference/kube-apiserver/) performs auditing. Each request on each stage
...
You can pass a file with the policy to [Kube-apiserver](https://kubernetes.io/docs/reference/command-line-tools-reference/kube-apiserver/) 
...
[Kube-apiserver](https://kubernetes.io/docs/reference/command-line-tools-reference/kube-apiserver/)  out of the box provides two backends:
...
log audit backend using the following [Kube-apiserver](https://kubernetes.io/docs/reference/command-line-tools-reference/kube-apiserver/)  flags:
...
same API as [Kube-apiserver](https://kubernetes.io/docs/reference/command-line-tools-reference/kube-apiserver/)  exposes. You can configure webhook
...
1. create a [kubeconfig file](https://kubernetes.io/docs/tasks/access-application-cluster/configure-access-multiple-clusters/) for kube-apiserver webhook audit backend
