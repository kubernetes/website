...
extract the encryption keys. This was a stepping stone in development to the `kms` provider, introduced in 1.10, and {{< feature-state feature-state state="beta" >}} since 1.12. Envelope encryption
