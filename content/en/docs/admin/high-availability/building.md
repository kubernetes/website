...
you should install the [kubelet binary](https://storage.googleapis.com/kubernetes-release/release/v0.19.3/bin/linux/amd64/kubelet) and [default-kubelet](https://github.com/kubernetes/website/tree/master/content/en/docs/admin/high-availability/default-kubelet)
scripts.

If you are using monit, you should also install the monit daemon (`apt-get install monit`) and the [monit-kubelet](https://github.com/kubernetes/website/tree/master/content/en/docs/admin/high-availability/monit-kubelet) and
[monit-docker](https://github.com/kubernetes/website/tree/master/content/en/docs/admin/high-availability/monit-docker) configs.
...
On each node, copy the [etcd.yaml](https://github.com/kubernetes/website/tree/master/content/en/docs/admin/high-availability/etcd.yaml) file into `/etc/kubernetes/manifests/etcd.yaml`
...
Once these files exist, copy the [kube-apiserver.yaml](https://github.com/kubernetes/website/tree/master/content/en/docs/admin/high-availability/kube-apiserver.yaml) into `/etc/kubernetes/manifests/` on each master node.
...
Next, set up the descriptions of the scheduler and controller manager pods on each node by copying [kube-scheduler.yaml](https://github.com/kubernetes/website/tree/master/content/en/docs/admin/high-availability/kube-scheduler.yaml) and [kube-controller-manager.yaml](https://github.com/kubernetes/website/tree/master/content/en/docs/admin/high-availability/kube-controller-manager.yaml) into the `/etc/kubernetes/manifests/` directory.
