...
you can add labels to particular nodes to exclude them from the list of backend servers.
The following command can be used to exclude a node from the list of backend servers in a backend set-
