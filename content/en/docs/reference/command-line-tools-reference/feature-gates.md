...
{{< feature-gate-list exclude="stable deprecated" >}}
Gates for features in Alpha or Beta states
{{< /feature-gate-list >}}

### Feature gates for graduated or deprecated features

{{< feature-gate-list exclude="unstable" >}}
Gates for graduated or deprecated features
{{< /feature-gate-list >}}
