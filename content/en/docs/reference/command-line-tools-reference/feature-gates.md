...
|---------|---------|-------|-------|-------|
| `AdmissionWebhookMatchConditions` | `false` | 1.27 | |
...
- `AdmissionWebhookMatchConditions`: Enable [match conditions](/docs/reference/access-authn-authz/extensible-admission-controllers/#maching-requests-matchconditions) on mutating & validating admission webhooks.
