...
<table style="width: 100%; table-layout: fixed;">
  ...
  <tbody>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">Topology Manager Policy to use. Possible values: `preferred`, `strict`. (Default `preferred`)</td>
    </tr>
