...
Services that have cluster virtual IP addresses use an
[allocation strategy](/docs/concepts/services-networking/cluster-ip-allocation/)
that divides the `ClusterIP` range into two bands, based on
...
You can see [examples](/docs/concepts/services-networking/cluster-ip-allocation/#allocation-examples)
of different IP address bands and allocation strategies in
