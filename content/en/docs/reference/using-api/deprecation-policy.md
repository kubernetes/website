...
Starting with Kubernetes v1.19, making an API request to a deprecated REST API endpoint:
...
3. sets an `apiserver_requested_deprecated_apis` gauge metric to `1` in the `kube-apiserver`
   ...
   return information about requests made to deprecated APIs which will be removed in v1.22:
