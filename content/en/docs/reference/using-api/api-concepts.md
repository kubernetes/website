...
`Content-Type`; if none of the media types you request are support, the API server returns
...
1. List all of the pods on a cluster, expecting a response in JSON format.
