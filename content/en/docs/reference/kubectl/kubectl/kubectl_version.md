...
<table style="width: 100%; table-layout: fixed;">
  ...
  <tbody>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">Client version only (no server required).</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">One of 'yaml' or 'json'.</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">Print just the version number.</td>
    </tr>
