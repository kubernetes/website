...
<table style="width: 100%; table-layout: fixed;">
  ...
  <tbody>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">If true, select all resources in the namespace of the specified resource types</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">The names of containers in the selected pod templates to change - may use wildcards</td>
    </tr>
    ...
    <tr>
      <td colspan="2">-e, --env stringArray</td>
    </tr>
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">Specify a key-value pair for an environment variable to set into each container.</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">Filename, directory, or URL to files the resource to update the env</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">The name of a resource from which to inject environment variables</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">help for env</td>
    </tr>

    <tr>
      <td colspan="2">--keys stringSlice</td>
    </tr>
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">Comma-separated list of keys to import from specified resource</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">If true, display the environment and any changes in the standard format. this flag will removed when we have kubectl view env.</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">If true, set env will NOT contact api-server but run locally.</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">If true, allow environment to be overwritten, otherwise reject updates that overwrite existing environment.</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">Prefix to append to variable names</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">If true, show secret or configmap references when listing variables</td>
    </tr>
