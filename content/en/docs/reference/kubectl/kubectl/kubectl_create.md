...
<table style="width: 100%; table-layout: fixed;">
  ...
  <tbody>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">Edit the API resource before creating</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">Filename, directory, or URL to files to use to create the resource</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">Raw URI to POST to the server.  Uses the transport specified by the kubeconfig file.</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">Only relevant if --edit=true. Defaults to the line ending native to your platform.</td>
    </tr>
