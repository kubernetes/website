...
{{< note >}}
For Kubernetes v1.22.0 through to v1.22.16, kubeadm used images from `k8s.gcr.io` by default. See [registry.k8s.io: faster, cheaper and Generally Available](https://k8s.io/blog/2022/11/28/registry-k8s-io-faster-cheaper-ga/).
{{< /note >}}
