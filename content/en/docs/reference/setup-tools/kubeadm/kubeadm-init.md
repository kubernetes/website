...
{{< note >}}
For Kubernetes v1.23.0 through to v1.23.14, kubeadm used images from `k8s.gcr.io` by default. See [registry.k8s.io: faster, cheaper and Generally Available](/blog/2022/11/28/registry-k8s-io-faster-cheaper-ga/).
{{< /note >}}
