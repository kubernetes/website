...
In common Linux you can install kubeadm by package manager, or use binary file for others: [Installing kubeadm](/docs/setup/production-environment/tools/kubeadm/install-kubeadm)
