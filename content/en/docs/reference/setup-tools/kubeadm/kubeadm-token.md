...
{{% capture whatsnext %}}
* [kubeadm join](/docs/reference/setup-tools/kubeadm/kubeadm-join/) to bootstrap a Kubernetes {{< glossary_tooltip text="node" term_id="node" >}} and join it to the cluster
{{% /capture %}}
