...
1. The etcd image will be pulled from `registry.k8s.io` by default. See
...
||||||| parent of 548e0efb6c (Reformat kubeadm implementation details)
...
>>>>>>> 548e0efb6c (Reformat kubeadm implementation details)
