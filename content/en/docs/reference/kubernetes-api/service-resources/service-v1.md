...
- **ports** ([]ServicePort)
  ...
  *Map: unique values on keys `port, protocol` will be kept during a merge*
  ...
  The list of ports that are exposed by this service. More info: https://kubernetes.io/docs/reference/networking/ports-and-protocols
...
- **sessionAffinity** (string)
  ...
  Supports "ClientIP" and "None". Used to maintain session affinity. Enable client IP based session affinity. Must be ClientIP or None. Defaults to None. More info: https://kubernetes.io/docs/concepts/services-networking/service/#virtual-ip-addressing-mechanism
