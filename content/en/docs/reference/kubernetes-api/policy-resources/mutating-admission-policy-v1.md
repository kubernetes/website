...
- **items** ([]<a href="{{< ref "../policy-resources/mutating-admission-policy-binding-v1#MutatingAdmissionPolicy" >}}">MutatingAdmissionPolicy</a>), required
...
- **body**: <a href="{{< ref "../policy-resources/mutating-admission-policy-binding-v1#MutatingAdmissionPolicy" >}}">MutatingAdmissionPolicy</a>, required
