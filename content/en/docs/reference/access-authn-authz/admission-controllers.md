...
feature_base: "Admission controllers"
...
### AlwaysAdmit {#alwaysadmit} {{< feature-state feature_name="AlwaysAdmit" for_k8s_version="v1.13" state="deprecated" >}}
...
### AlwaysDeny {#alwaysdeny} {{< feature-state feature_name="AlwaysDeny" for_k8s_version="v1.13" state="deprecated" >}}
...
### DenyExecOnPrivileged {#denyexeconprivileged} {{< feature-state feature_name="DenyExecOnPrivileged" for_k8s_version="v1.13" state="deprecated" >}}
...
### DenyEscalatingExec {#denyescalatingexec} {{< feature-state feature_name="DenyEscalatingExec" for_k8s_version="v1.13" state="deprecated" >}}
...
### EventRateLimit {#eventratelimit} {{< feature-state feature_name="EventRateLimit" for_k8s_version="v1.13" state="alpha" >}}
...
### Initializers {#initializers} {{< feature-state feature_name="initializers" for_k8s_version="v1.13" state="alpha" >}}
...
### MutatingAdmissionWebhook {#mutatingadmissionwebhook} {{< feature-state feature_name="MutatingAdmissionWebhook" for_k8s_version="v1.13" state="beta" >}}
...
### PersistentVolumeLabel {#persistentvolumelabel} {{< feature-state feature_name="PersistentVolumeLabel" for_k8s_version="v1.13" state="deprecated" >}}
...
### ValidatingAdmissionWebhook {#validatingadmissionwebhook} {{< feature-state feature_name="ValidatingAdmissionWebhook" for_k8s_version="v1.13" state="beta" >}}
