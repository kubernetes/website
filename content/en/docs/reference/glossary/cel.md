...
short_description: >
  An expression language that's designed to be safe for executing user code, and
  is built for speed and portability.

tags:
- extension
- fundamental
---
 Common Expression Language (CEL) is a general-purpose expression language
 that's designed to be fast, portable, and safe to execute.
