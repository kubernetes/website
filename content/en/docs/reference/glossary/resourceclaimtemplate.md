...
date: 2025-05-26
full_link: /docs/reference/kubernetes-api/workload-resources/resource-claim-template-v1beta1/
short_description: >
...
- core
---
 A ResourceClaimTemplate defines a template that Kubernetes uses to create
