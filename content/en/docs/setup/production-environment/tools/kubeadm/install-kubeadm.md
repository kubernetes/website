...
<<<<<<< HEAD:content/en/docs/setup/production-environment/tools/independent/install-kubeadm.md
see the [Using kubeadm to Create a Cluster](/docs/setup/production-environment/tools/independent/create-cluster-kubeadm/) page.
=======
see the [Using kubeadm to Create a Cluster](/docs/setup/production-environment/tools/kubeadm/create-cluster-kubeadm/) page.
>>>>>>> restructure the left nav pane for setup:content/en/docs/setup/production-environment/tools/kubeadm/install-kubeadm.md
...
For more information on version skews, see Kubernetes [version and version-skew policy](/docs/setup/release/version-skew-policy/)
...
* [Using kubeadm to Create a Cluster](/docs/setup/production-environment/tools/independent/create-cluster-kubeadm/)
=======
