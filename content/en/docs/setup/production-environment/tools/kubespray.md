...
* **Firewalls are not managed by kubespray**. You'll need to implement your own rules as needed. You should disable your firewall in order to avoid any issues during deployment
