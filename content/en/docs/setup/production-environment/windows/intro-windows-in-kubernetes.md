...
On Windows nodes the community-managed [csi-proxy](https://github.com/kubernetes-csi/csi-proxy)
is used.

Please refer to the following [installation steps](https://github.com/kubernetes-csi/csi-proxy#installation)
to start using csi-proxy.
