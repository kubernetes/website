...
to use and contribute to: **[AKS-Engine](https://github.com/Azure/aks-engine)**.
...
AKS Engine provides convenient tooling to quickly bootstrap Kubernetes clusters on Azure. The input to AKS-Engine is similar to the ARM template syntax used to deploy a cluster directly with the Azure Kubernetes Service.
...
You can get started quickly by following the **[AKS-Engine Kubernetes Walkthrough](https://github.com/Azure/aks-engine/blob/master/docs/tutorials/quickstart.md)**.
