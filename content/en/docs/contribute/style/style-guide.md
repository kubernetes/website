...
[following page styles](/docs/contribute/style/page-styles/) and [creating a documentation pull request](/docs/contribute/new-content/open-a-pr).
...
If the information is version specific, the Kubernetes version needs to be defined in the `prerequisites` section of the [Task page](/docs/contribute/style/page-styles/#task) or the [Tutorial page](/docs/contribute/style/page-styles/#tutorial). Once the page is saved, the `prerequisites` section is shown as **Before you begin**.
...
* Learn about [content page styles](/docs/contribute/style/page-styles/).
