...
When you open the a **draft** pull request, you open it against _main_ as a base branch
and not against the `dev-{{< skew nextMinorVersion >}}` branch. This is different from
the [process](/docs/contribute/new-content/new-features/#open-a-placeholder-pr) for

You should also leave a comment on the related [kubernetes/enhancements](https://github.com/kubernetes/enhancements)
issue with a link to the PR to notify the comms people managing this release. Your comment
helps release comms see that the change needs announcing and that your SIG has opted in.
...
You follow almost the normal [article submission](/docs/contribute/blog/article-submission/)
...
may assign a member of release comms to help guide what you're doing.
...
announcement should have LGTM (“looks good to me”) and approved labels, along with the
