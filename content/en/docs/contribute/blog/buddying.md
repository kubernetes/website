...
with any of their co-authors, with you as their writing buddy, and ideally with a nominated
person from the blog team.

As a writing buddy, you then read the draft text and either directly make suggestions or provide
other feedback. They are very commonly also **your** writing buddy, so they will provide the
...
Once there is a pull request open against the appropriate Git repository, and you are happy
that it should merge, add a comment to the pull request: `/lgtm` ("looks good to me").

The Prow bot records this and moves things forward. You can use that command and have your
opinion go on record whether or not you are formally a member of the Kubernetes project.
