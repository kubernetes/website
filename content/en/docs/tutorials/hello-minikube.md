...
The `dashboard` command creates a temporary proxy to make the dashboard accessible from outside
the Kubernetes virtual network.
...
Kubernetes virtual network, you have to expose the Pod as a Kubernetes
...
2. View the Service you created:
   ...
   access the Service. On minikube, the `LoadBalancer` type makes the Service accessible through the
