...
Note: The `cri-o` installer also provides the `crictl` command to manage and inspect
Pods, containers, and container images. The `crictl` command is out of the scope
of this tutorial.
...
See [Ports and Protocols](/docs/reference/networking/ports-and-protocols/).
