...
{{< figure src="/images/docs/components-of-kubernetes-3d.jpg" alt="Components of Kubernetes" caption="The components of a Kubernetes cluster" class="diagram-large" >}}
