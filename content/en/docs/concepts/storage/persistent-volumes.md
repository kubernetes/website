...
Kubelet will fail the violating pods if the volume is not attached yet.
If the pod is already running, it may continue to run. But Kubernetes does not support this configuration and you should terminate the violating pod soon.
