...
{{< note >}}
Flexvolume is deprecated starting v1.23. Out-of-tree CSI driver is the recommended way to write volume drivers in Kubernetes. Maintainers of Flexvolume drivers should implement a CSI Driver and move users of Flexvolume to CSI. Users of Flexvolume should move their workloads to CSI Driver.
{{< /note >}}
