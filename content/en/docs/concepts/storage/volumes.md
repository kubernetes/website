...
Volumes mount at the [specified paths](#using-subpath) within the image.
...
The following volume types are deprecated.

- [`azureFile`](/docs/reference/storage/#azurefile)
- [`cephfs`](/docs/reference/storage/#cephfs)
- [`flexVolume`](/docs/reference/storage/#flexvolume)
- [`gcePersistentDisk`](/docs/reference/storage/#flexvolume)
- [`gitRepo`](/docs/reference/storage/#gitrepo)
- [`portworxVolume`](/docs/reference/storage/#portworxvolume)
- [`rbd`](/docs/reference/storage/#rbd)
- [`vsphereVolume`](/docs/reference/storage/#vspherevolume)

The following volume types have been removed in Kubernetes v1.28.

- [`awsElasticBlockStore`](/docs/reference/storage/#awselasticblockstore)
- [`azureDisk`](/docs/reference/storage/#azuredisk)
- [`cinder`](/docs/reference/storage/#cinder)
- [`glusterfs`](/docs/reference/storage/#glusterfs)
...
and also FlexVolume (which is deprecated).
These plugins enable storage vendors to create custom storage plugins
