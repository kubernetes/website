...
Nodes can be scored based on their available storage capacity. This only applies
when not using static provisioning
([dynamic provisioning](/docs/concepts/storage/dynamic-provisioning/) only), and
