...
`DRAExtendedResource` [feature gate](/docs/reference/command-line-tools-reference/feature-gates/) in
the kube-apiserver, kube-scheduler, kube-controller-manager, and kubelet.
