...
device and that are used by the logical devices advertised through DRA.
...
the referenced counter sets must have sufficient quantity of the counters referenced by the device.
