...
Pods with scheduling gates have mutable scheduling directives, with certain constraints. 
...
Only updates to node selector and node affinitities that further constrain the node selection are allowed.
