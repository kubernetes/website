...
2. Soft Constraints (Scoring):
   ...
   - Existing Pods' `podAffinity.requiredDuringSchedulingIgnoredDuringExecution`:
     - These are treated as soft constraints, and nodes are scored based on how well they satisfy the affinity requirements of existing Pods, promoting optimal placement without enforcing strict rules.
