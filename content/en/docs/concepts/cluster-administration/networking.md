...
[AD-DC](http://www.h3c.com/en/Solution/Technology_Solution/InterConnect/)
is an open, flexible network solution using modern technologies such as SDN,
NFV, and AI on the basis of traditional networks. AD-DC solution based on SDN
has been widely applied in the industries of Internet, finance, government,
ISPs, enterprises, etc. It provides a reliable and nimble network infrastructure
for digital transformation of the society.

AD-DC supports integration with Kubernetes and VM/BM orchestration platforms
such as OpenStack, Red Hat Enterprise Virtualization (RHEV), VMware vCenter.
The detailed documentation can be found [here](http://www.h3c.com/en/Support/Resource_Center/HK/SDN/H3C_SeerEngine-DC/H3C_SeerEngine-DC/).
