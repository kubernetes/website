...
* The [ngrok-operator](https://github.com/ngrok/ngrok-operator) is the official operator for [ngrok](https://ngrok.com/) that supports both Ingress and Gateway API for adding secure public access to your k8s services.
