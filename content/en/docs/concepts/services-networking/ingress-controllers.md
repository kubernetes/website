...
* [Alibaba Cloud ALB Ingress](https://www.alibabacloud.com/help/en/ack/ack-managed-and-ack-dedicated/user-guide/alb-ingress-management-1) is an ingress controller that configures the [Alibaba Cloud Application Load Balancer](https://www.alibabacloud.com/help/en/slb/application-load-balancer/product-overview/what-is-alb), which is also the commercial version of [Alibaba Load Balancer Controller](https://github.com/alibaba/alibaba-load-balancer-controller).
