...
* The [NGINX Ingress Controller for Kubernetes](https://github.com/nginx/kubernetes-ingress) is
  the official [NGINX](https://docs.nginx.com/nginx-ingress-controller/) Ingress Controller based on NGINX Open Source.
