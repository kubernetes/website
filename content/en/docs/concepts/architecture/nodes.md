...
interface: [node controller](/docs/reference/controllers/node/), [kubelet](https://kubernetes.io/docs/reference/command-line-tools-reference/kubelet/),
and [kubectl](/docs/reference/kubectl/).
...
{{% /capture %}}
{{% capture whatsnext %}}
* Read about [master-node communication](/docs/concepts/architecture/master-node-communication/)
* Read the [node controller](/docs/reference/controllers/node/) reference documentation
{{% /capture %}}
