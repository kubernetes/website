...
It is important to note the difference between a Node and a Node object. A node is a 
physical or virtual machine that runs applications or workloads, while
...
There are two main ways to have Node objects added to the {{< glossary_tooltip text="API server" term_id="kube-apiserver" >}}:
