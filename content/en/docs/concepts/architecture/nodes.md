...
The [components](content/en/docs/concepts/overview/components.md#node-components) on a node include the
...
* Learn about the [components](content/en/docs/concepts/overview/components.md#node-components) that make up a node.
