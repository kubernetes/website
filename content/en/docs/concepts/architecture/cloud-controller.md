...
The original plan to support volumes using CCM was to use [Flex](https://kubernetes.io/docs/concepts/storage/volumes/#flexVolume) volumes to support pluggable volumes. However, a competing effort known as [CSI](https://kubernetes.io/docs/concepts/storage/volumes/#csi) is being planned to replace Flex.
