...
Job was previously suspended and is now running. If such a Job condition does
not exist, the Job has never been stopped.
...
Events:
  Type    Reason            Age   From            Message
  ----    ------            ----  ----            -------
  Normal  SuccessfulCreate  12m   job-controller  Created pod: myjob-rc5fm
  Normal  SuccessfulCreate  12m   job-controller  Created pod: myjob-cgswm
  Normal  SuccessfulCreate  12m   job-controller  Created pod: myjob-9vtjs
  Normal  SuccessfulCreate  11m   job-controller  Created pod: myjob-4v5gk
  Normal  SuccessfulCreate  11m   job-controller  Created pod: myjob-hlrpl
  Normal  SuccessfulCreate  11m   job-controller  Created pod: myjob-gmszl
  Normal  SuccessfulDelete  11m   job-controller  Deleted pod: myjob-gmszl
  Normal  SuccessfulDelete  11m   job-controller  Deleted pod: myjob-hlrpl
  Normal  SuccessfulDelete  11m   job-controller  Deleted pod: myjob-4v5gk
  Normal  Suspended         11m   job-controller  Job suspended
  Normal  SuccessfulCreate  3s    job-controller  Created pod: myjob-jvb44
  Normal  SuccessfulCreate  3s    job-controller  Created pod: myjob-vg7x9
  Normal  SuccessfulCreate  3s    job-controller  Created pod: myjob-tjbgv
  Normal  Resumed           3s    job-controller  Job resumed
```

The last 8 events, including the "Suspended" and "Resumed" events, are directly
a result of toggling the `.spec.suspend` field twice. In the time between these
two events, we see that no Pods were created, but Pod creation restarted as soon
as the Job was resumed.

Also note how the Job status does not count the three deleted Pods as failures,
but the first three events from the Pods that completed are counted towards the
Job's completions count (`.status.succeeded` field).
