...
{{< note >}}
A Pod Preset is capable of modifying the `.spec.containers` field and, 
since Kubernetes version 1.14.0, the `initContainers` field in a
Pod spec when appropriate.
{{< /note >}}
