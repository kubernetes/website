...
上查看 {{< skew currentVersionAddMinor 0 >}} 的變更日誌。

或者，可以在以下位置在線搜索和篩選發行版本說明：[relnotes.k8s.io](https://relnotes.k8s.io)。
在 [relnotes.k8s.io](https://relnotes.k8s.io/?releaseVersions={{< skew currentVersionAddMinor 0 >}}.0)
上查看 {{< skew currentVersionAddMinor 0 >}} 的篩選後的版本說明。
