你需要有一個帶有默認 [StorageClass](/zh-cn/docs/concepts/storage/storage-classes/)的
[動態 PersistentVolume 供應程序](/zh-cn/docs/concepts/storage/dynamic-provisioning/)，
或者自己[靜態的提供 PersistentVolume](/zh-cn/docs/concepts/storage/persistent-volumes/#provisioning)
來滿足這裏使用的 [PersistentVolumeClaim](/zh-cn/docs/concepts/storage/persistent-volumes/#persistentvolumeclaims)。
