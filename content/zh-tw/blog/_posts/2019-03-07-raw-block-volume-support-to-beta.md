---
layout: blog
title: Raw Block Volume 支持進入 Beta
date: 2019-03-07
...
在此處查看有關 snapshot 功能的其他文檔：[Raw Block Volume 支持](/docs/concepts/storage/persistent-volumes/#raw-block-volume-support)
...
--->
特別感謝所有爲 Kubernetes 增加 block volume 支持的貢獻者，包括：
