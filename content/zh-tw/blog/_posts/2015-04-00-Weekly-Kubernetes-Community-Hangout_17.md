---
title: " Kubernetes 社區每週聚會筆記- 2015年4月17日 "
date: 2015-04-17
...
* 客戶端版本化
    ...
    * 儘管沒有人反映頻繁修改 `types.go` 有多痛苦，但我們很爲此擔心。

    * 結構化類型在客戶端中很有用。版本化的結構就可以了。

    * 如果從 json/yaml (kubectl) 開始，則不應轉換爲結構化類型。使用 swagger。
...
* Security context
    ...
    * 管理員可以限制誰可以運行特權容器或需要特定的 unix uid
...
* 討論用戶的上游，等等進入Kubernetes，至少是可選的
* 1.0 路線圖

    * 重點是性能，穩定性，集羣升級

    * TJ 一直在對[roadmap.md][4]進行一些編輯，但尚未發佈PR
* Kubernetes UI
