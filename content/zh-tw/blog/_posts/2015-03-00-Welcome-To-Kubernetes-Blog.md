...
-->
歡迎來到新的 Kubernetes 博客。關注此博客，瞭解 Kubernetes 開源項目。我們計劃時不時的發佈發佈說明，操作方法文章，活動，甚至一些非常有趣的話題。
...
-->
如果您正在使用 Kubernetes 或爲該項目做出貢獻並想要發帖子，[請告訴我](mailto:kitm@google.com)。

<!--
To start things off, here's a roundup of recent Kubernetes posts from other sites:
-->
首先，以下是 Kubernetes 最近在其他網站上發佈的文章摘要：
