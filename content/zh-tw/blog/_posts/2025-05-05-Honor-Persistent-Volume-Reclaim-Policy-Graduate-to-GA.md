---
layout: blog
title: 'Kubernetes v1.33：防止無序刪除時 PersistentVolume 泄漏特性進階到 GA'
...
-->
通常，如果卷需要被刪除，則預期是刪除綁定的 PV-PVC 對的 PVC。但是，
刪除 PVC 之前並沒有限制不能刪除 PV。
...
* [KEP-2644](https://github.com/kubernetes/enhancements/tree/master/keps/sig-storage/2644-honor-pv-reclaim-policy)
* [卷泄漏問題](https://github.com/kubernetes-csi/external-provisioner/issues/546)
* [Beta 版發佈博客](/zh-cn/blog/2024/08/16/kubernetes-1-31-prevent-persistentvolume-leaks-when-deleting-out-of-order/)
...
Kubernetes Slack 頻道
[SIG Storage 交流渠道](https://github.com/kubernetes/community/blob/master/sig-storage/README.md#contact)是接觸
SIG Storage 和遷移工作組團隊的絕佳方式。

特別感謝以下人員的深入審查、細緻考慮和寶貴貢獻：
