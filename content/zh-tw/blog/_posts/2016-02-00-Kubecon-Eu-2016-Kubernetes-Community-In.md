---
title: " KubeCon EU 2016：倫敦 Kubernetes 社區 "
date: 2016-02-24
...
-->
快來加入我們在倫敦，與 Kubernetes 社區的數百人一起出去，體驗各種深入的技術專家講座和用例。
...
* “Kubernetes 硬件黑客：通過旋鈕、推杆和滑塊探索 Kubernetes API” 演講者 Ian Lewis 和 Brian Dorsey，谷歌開發佈道師* [http://sched.co/6Bl3](http://sched.co/6Bl3)

* “rktnetes: 容器運行時和 Kubernetes 的新功能” 演講者 Jonathan Boulle, CoreOS 的主程 -* [http://sched.co/6BY7](http://sched.co/6BY7)

* “Kubernetes 文檔：貢獻、修復問題、收集獎金” 作者：John Mulhausen，首席技術作家，谷歌 -* [http://sched.co/6BUP](http://sched.co/6BUP)&nbsp;
...
* “容器調度的實用指南” 作者：Mandy Waite，開發者倡導者，谷歌 -* [http://sched.co/6BZa](http://sched.co/6BZa)
...
* “[使用 NGINX 爲 Kubernetes 創建一個高級負載均衡解決方案](https://kubeconeurope2016.sched.org/event/6Bc9/creating-an-advanced-load-balancing-solution-for-kubernetes-with-nginx?iframe=yes&w=i:0;&sidebar=yes&bg=no#?iframe=yes&w=i:100;&sidebar=yes&bg=no)” 作者：Andrew Hutchings, NGINX 技術產品經理 -* http://sched.co/6Bc9
* 還有更多 http://kubeconeurope2016.sched.org/

<!--
Get your KubeCon EU [tickets here](https://ti.to/kubecon/kubecon-eu-2016).
-->
[在這裏](https://ti.to/kubecon/kubecon-eu-2016)獲取您的 KubeCon EU 門票。
...
_KubeCon 是由 KubeAcademy、LLC 組織的，這是一個由社區驅動的開發者團體，專注於開發人員的教育和 kubernetes 的推廣
-* Sarah Novotny, 谷歌的 Kubernetes 社區經理
