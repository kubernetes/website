---
layout: blog
title: "免費的 Katacoda Kubernetes 教程即將關閉"
date: 2023-02-14
...
-->
**作者**：Natali Vlatko，Kubernetes SIG Docs 聯合主席
...
-->
Katacoda 的關閉會影響 25 個英文教程頁面、對應的多語言頁面以及 Katacoda Scenario倉庫：
...
我們建議你立即更新指向 Katacoda 學習平臺的所有鏈接、指南或文檔，以反映這一變化。
雖然我們還沒有找到替代這個學習平臺的解決方案，但 Kubernetes 網站本身就包含了大量有用的文檔可助你繼續學習和成長。
你可以在 https://k8s.io/docs/tutorials/ 找到所有可用的 Kubernetes 文檔教程。
...
-->
如果你對 Katacoda 關閉或後續從 Kubernetes 教程頁面移除相關鏈接有任何疑問，
請在 [general issue tracking the shutdown](https://github.com/kubernetes/website/issues/33936)
上發表評論，或加入 Kubernetes Slack 的 #sig-docs 頻道。
