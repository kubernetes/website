...
-->
Kubernetes 允許開發人員根據當前的流量和負載自動調整集羣大小和 pod 副本的數量。這些調整減少了未使用節點的數量，節省了資金和資源。
在這次演講中，谷歌的 Marcin Wielgus 將帶領您瞭解 Kubernetes 中 pod 和 node 自動調焦的當前狀態：它是如何工作的，以及如何使用它，包括在生產應用程序中部署的最佳實踐。
...
-->
喜歡這個演講嗎？ 12 月 6 日至 8 日，在 Austin 參加 KubeCon 關於擴展和自動化您的 Kubernetes 集羣的更令人興奮的會議。[現在註冊](https://www.eventbrite.com/e/kubecon-cloudnativecon-north-america-registration-37824050754?_ga=2.9666039.317115486.1510003873-1623727562.1496428006)。
...
-->
一定要查看由 Ron Lipke， Gannet/USA Today Network, 平臺即服務高級開發人員，在[公共雲中自動化和測試產品就緒的 Kubernetes 集羣](http://sched.co/CU64)。
