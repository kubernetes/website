...
-->
**更新**：我們已收到 Salesforce 的通知，我們的 Slack 工作區在 6 月 20 日**不會被降級**。
請等待更多細節更新，目前**無需緊急備份**私有頻道或私信。
...
-->
在過去十年中，Slack 一直通過免費定製企業賬戶支持我們的項目。
他們已告知我們無法繼續提供這種支持，特別是因爲我們的 Slack 是平臺上最大和最活躍的社區之一。
因此，在我們決定實施其他選項的同時，他們將把我們的賬戶降級爲標準免費版 Slack。
...
-->
CNCF 項目工作人員建議我們的社區考慮遷移到 Discord。
由於在拓展 Slack 功能極限的過程中存在一些問題，他們已經探索過 Kubernetes Discord 會是什麼樣子。
Discord 將允許我們實現新的工具和集成，以幫助社區，例如 GitHub 組成員身份同步。
指導委員會將討論並決定我們的未來平臺。
...
-->
請查看我們的[常見問題解答](https://github.com/kubernetes/community/blob/master/communication/slack-migration-faq.md)，
並關注 [kubernetes-dev 郵件列表](https://groups.google.com/a/kubernetes.io/g/dev/)和
[#announcements 頻道](https://kubernetes.slack.com/archives/C9T0QMNG4)以獲取更多新聞。
如果你對我們的 Slack 狀態有具體反饋，請加入
[GitHub 上的討論](https://github.com/kubernetes/community/issues/8490)。
