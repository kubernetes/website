...
-->
**作者和採訪者：** [Anubhav Vardhan](https://github.com/anubha-v-ardhan)、
...
-->
在這篇文章中，我們將向你介紹來自印度地區的五位優秀貢獻者，他們一直在以各種方式積極地爲上游 Kubernetes 項目做貢獻，同時也是衆多社區倡議的領導者和維護者。
...
-->
Arsh 目前在 Okteto 公司中擔任開發者體驗工程師職務。作爲一名新的貢獻者，他意識到一對一的指導機會讓他在開始上游項目中受益匪淺。
...
-->
他目前是 Kubernetes 1.23 版本團隊的 CI Signal 經理。他還致力於爲 SIG Testing 和 SIG Docs 項目提供貢獻，並且在 SIG Architecture 項目中負責 [證書管理器](https://github.com/cert-manager/infrastructure) 工具的開發工作。
...
-->
> 我鼓勵大家以可持續的方式爲社區做貢獻。
> 我的意思是，一個人很容易在早期的時候非常有熱情，並且承擔了很多超出個人實際能力的事情。
> 這通常會導致後期的倦怠。迭代地處理事情會讓大家對社區的貢獻變得可持續。
...
-->
Kunal Kushwaha 是 Kubernetes 營銷委員會的核心成員。他同時也是 [CNCF 學生計劃](https://community.cncf.io/cloud-native-students/) 的創始人之一。他還在 1.22 版本週期中擔任通信經理一職。
...
-->
在他的第一年結束時，Kunal 開始爲 [fabric8io kubernetes-client](https://github.com/fabric8io/kubernetes-client) 項目做貢獻。然後，他被推選從事同一項目，此項目是 Google Summer of Code 的一部分。Kunal 在 Google Summer of Code、Google Code-in 等項目中指導過很多人。
...
-->
作爲一名開源愛好者，他堅信，社區的多元化參與是非常有益的，因爲他引入了新的觀念和觀點，並尊重自己的夥伴。它曾參與過各種開源項目，他在這些社區中的參與對他作爲開發者的發展有很大幫助。
...
> organisation._
-->
> 我相信，如果你發現自己在一個瞭解不多的項目當中，那是件好事，
> 因爲現在你可以一邊貢獻一邊學習，社區也會幫助你。
> 它幫助我獲得了很多技能，認識了來自世界各地的人，也幫助了他們。
> 你可以在這個過程中學習，自己不一定必須是專家。
> 請重視非代碼貢獻，因爲作爲初學者這是一項技能，你可以爲組織帶來新的視角。
...
-->
Madhav Jivarajani 在 VMware 上游 Kubernetes 穩定性團隊工作。他於 2021 年 1 月開始爲 Kubernetes 項目做貢獻，此後在 SIG Architecture、SIG API Machinery 和 SIG ContribEx（貢獻者經驗）等項目的幾個工作領域做出了重大貢獻。
...
-->
除了在技術方面的貢獻，Madhav 還監督許多旨在幫助新貢獻者的項目。
他每兩週組織一次的 “KEP 閱讀俱樂部” 會議，幫助新人瞭解添加新功能、
摒棄舊功能以及對上游項目進行其他關鍵更改的過程。他還致力於開發
[Katacoda 場景](https://github.com/kubernetes-sigs/contributor-katacoda)，
以幫助新的貢獻者在爲 k/k 做貢獻的過程更加熟練。目前除了每週與社區成員會面外，
他還組織了幾個[新貢獻者講習班（NCW）](https://www.youtube.com/watch?v=FgsXbHBRYIc)。
...
-->
> 一開始我對 Kubernetes 瞭解並不多。我加入社區是因爲社區超級友好。
> 但讓我留下來的不僅僅是人，還有項目本身。我在社區中不會感到不知所措，
> 這是因爲我能夠在感興趣的和正在討論的主題中獲得儘可能多的背景和知識。
> 因此，我將繼續深入探討 Kubernetes 及其設計。
> 我是一個系統迷，kubernetes 對我來說絕對是一個金礦。
...
-->
Rajas Kakodkar 目前在 VMware 擔任技術人員。自 2019 年以來，他一直多方面地從事上游 kubernetes 項目。
...
-->
他現在是 Testing 特別興趣小組的關鍵貢獻者。他還活躍在 SIG Network 社區。最近，Rajas 爲 [NetworkPolicy++](https://docs.google.com/document/d/1AtWQy2fNa4qXRag9cCp5_HsefD7bxKe3ea2RPn8jnSs/) 和 [`kpng`](https://github.com/kubernetes-sigs/kpng) 子項目做出了重大貢獻。
...
-->
他遇到的第一個挑戰是，他所處的時區與上游項目的日常會議時間不同。不過，社區論壇上的異步交互逐漸解決了這個問題。
...
-->
> 我喜歡爲 kubernetes 做出貢獻，不僅因爲我可以從事尖端技術工作，
> 更重要的是，我可以和優秀的人一起工作，並幫助解決現實問題。
...
-->
Rajula Vineet Reddy，CERN 的初級工程師，是 SIG ContribEx 項目下營銷委員會的成員。在 Kubernetes 1.22 和 1.23 版本週期中，他還擔任 SIG Release 的版本經理。
...
-->
在他的一位教授的幫助下，他開始將 kubernetes 項目作爲大學項目的一部分。慢慢地，他花費了大量的時間閱讀項目的文檔、Slack 討論、GitHub issues 和博客，這有助於他更好地掌握 kubernetes 項目，並激發了他對上游項目做貢獻的興趣。他的主要貢獻之一是他在SIG ContribEx上游營銷子項目中協助實現了自動化。
...
-->
Rajas 說，參與項目會議和跟蹤各種項目角色對於瞭解社區至關重要。
...
-->
> 我發現社區非常有幫助，而且總是“你得到的回報和你貢獻的一樣多”。
> 你參與得越多，你就越會了解、學習和貢獻新東西。
>
> “挺身而出”的第一步是艱難的。但在那之後一切都會順利的。勇敢地參與進來吧。
...
-->
如果你對我們下一步應該採訪誰有任何意見/建議，請在 #sig-contribex 中告知我們。我們很高興有其他人幫助我們接觸社區中更優秀的人。我們將不勝感激。

<!--
We'll see you all in the next one. Everyone, till then, have a happy contributing! 👋
-->
我們下期見。最後，祝大家都能快樂地爲社區做貢獻！👋
