---
layout: blog
title: "Kubernetes 1.24 版本中存儲容量跟蹤特性進入 GA 階段"
date: 2022-05-06
...
-->
在 Kubernetes v1.24 版本中，[存儲容量](/zh-cn/docs/concepts/storage/storage-capacity/)跟蹤已經成爲一項正式發佈的功能。
...
此問題早在存儲容量跟蹤功能之前就存在，雖然苛刻的附加條件使這種情況不太可能發生，
...
已製備但尚未被使用的卷不能包含任何有價值的數據，因此可以在其他地方釋放並且再次被製備。
