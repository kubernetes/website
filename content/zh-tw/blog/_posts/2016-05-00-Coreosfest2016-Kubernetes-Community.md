---
title: " CoreOS Fest 2016: CoreOS 和 Kubernetes 在柏林（和舊金山）社區見面會 "
date: 2016-05-03
...
-->
[CoreOS Fest 2016](https://coreos.com/fest/) 將彙集容器和開源分佈式系統社區，其中包括 Kubernetes 領域的許多思想領袖。
這是第二次年度 CoreOS 社區會議，於5月9日至10日在柏林首次舉行。
CoreOS 相信 Kubernetes 是提供 GIFEE（適用於所有人的 Google 的基礎架構）服務的合適的容器編排組件。
...
實際上， Google 的高級工程師， Kubernetes 的創建者之一 Tim Hockin 將以專門介紹 Kubernetes 更新的主題演講拉開序幕。
...
-->
_-- Sarah Novotny, Kubernetes 社區管理者_
