...
-->
[2025 指導委員會選舉](https://github.com/kubernetes/community/tree/master/elections/steering/2025)現已結束。
Kubernetes 指導委員會由 7 個席位組成，其中 4 個席位在 2025 年進行了選舉。
新當選的委員會成員將任職 2 年，所有成員均由 Kubernetes 社區選舉產生。

指導委員會負責監督整個 Kubernetes 項目的治理。權力越大責任越大，
你可以通過他們的[章程](https://github.com/kubernetes/steering/blob/master/charter.md)瞭解指導委員會的角色。

感謝每位參與投票的人；你的參與有助於支持社區的持續健康和成功。
...
祝賀當選的委員會成員，其兩年任期立即開始（按 GitHub 名稱字母順序列出）：

* **Kat Cosgrove ([@katcosgrove](https://github.com/katcosgrove)), Minimus**
* **Paco Xu 徐俊傑 ([@pacoxu](https://github.com/pacoxu)), DaoCloud**
...
-->
Maciej Szulik 和徐俊傑（Paco Xu）是迴歸的指導委員會成員。
...
這個管理機構與所有 Kubernetes 一樣，向所有人開放。
你可以關注指導委員會[會議記錄](https://github.com/orgs/kubernetes/projects/40)，
並通過提交 Issue 或針對其 [repo](https://github.com/kubernetes/steering) 創建 PR 來參與。
他們在[太平洋時間每月第一個週三上午 8:00](https://github.com/kubernetes/steering) 舉行開放的會議。
你還可以通過其公共郵件列表 steering@kubernetes.io 與他們聯繫。

你可以通過在
[YouTube 播放列表](https://www.youtube.com/playlist?list=PL69nYSiGNLP1yP1B_nd9-drjoxp0Q14qM)上觀看過去的會議來了解指導委員會會議的全部內容。
