...
weight: 75
description: >-
   kube-state-metrics，一個生成和公開叢集層面指標的插件代理。
---
<!--
...
-->
## 示例：使用來自 kube-state-metrics 的指標查詢叢集狀態   {#example-kube-state-metrics-query-1}

通過 kube-state-metrics 生成的系列指標有助於進一步洞察叢集，因爲這些指標可用於查詢。
...
kube-state-metrics 生成的指標還允許在叢集中出現問題時發出警報。
