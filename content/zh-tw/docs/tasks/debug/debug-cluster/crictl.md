---
title: 使用 crictl 對 Kubernetes 節點進行調試
content_type: task
weight: 30
---
<!--
...
-->
`crictl` 需要帶有 CRI 運行時的 Linux 操作系統。
...
-->
如果你不設置端點，`crictl` 將嘗試連接到已知端點的列表，這可能會影響性能。
{{</note>}}
...
-->
要進一步瞭解 `crictl`，參閱
[`crictl` 文檔](https://github.com/kubernetes-sigs/cri-tools/blob/master/docs/crictl.md)。
...
-->
### 在正在運行的容器上執行命令    {#execute-a-command-in-a-running-container}
