...
short_description: >
  securityContext 字段定義 Pod 或容器的特權和訪問控制設置，包括運行時 UID 和 GID。
...
securityContext 字段定義 {{< glossary_tooltip text="Pod" term_id="pod" >}} 或
{{< glossary_tooltip text="容器" term_id="container" >}}的特權和訪問控制設置。
