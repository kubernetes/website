...
將運行在一個或一組 {{< glossary_tooltip text="Pod" term_id="pod" >}} 上的網絡應用程序公開爲網絡服務的方法。
...
Kubernetes Service 要麼使用 IP 網絡（IPv4、IPv6 或兩者），要麼引用位於域名系統 (DNS) 中的外部名稱。
