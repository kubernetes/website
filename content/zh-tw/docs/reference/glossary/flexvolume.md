...
short_description: >
  FlexVolume 是一個已棄用的接口，用於創建樹外卷插件。
  {{< glossary_tooltip text="容器存儲接口（CSI）" term_id="csi" >}}
  是一個更新的接口，它解決了 FlexVolume 的一些問題。
...
* [更多關於 FlexVolume 的信息](https://github.com/kubernetes/community/blob/master/contributors/devel/sig-storage/flexvolume.md)
* [存儲供應商的卷插件 FAQ](https://github.com/kubernetes/community/blob/master/sig-storage/volume-plugin-faq.md)
