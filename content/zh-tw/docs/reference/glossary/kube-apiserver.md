...
-->
API 服務器是 Kubernetes {{< glossary_tooltip text="控制平面" term_id="control-plane" >}}的組件，
該組件負責公開了 Kubernetes API，負責處理接受請求的工作。
API 服務器是 Kubernetes 控制平面的前端。
...
-->
Kubernetes API 服務器的主要實現是 [kube-apiserver](/zh-cn/docs/reference/command-line-tools-reference/kube-apiserver/)。
