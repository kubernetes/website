...
short_description: >
  共同管理大範疇 Kubernetes 開源項目中某組件或方面的一組社區成員。
...
共同管理大範疇 Kubernetes 開源項目中某組件或方面的一組{{< glossary_tooltip text="社區成員" term_id="member" >}}。 
...
SIG 中的成員對推進某個領域（如體系結構、API 機制構件或者文檔）具有相同的興趣。
