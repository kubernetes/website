...
-->
使得 kubelet 能夠對 Pod 標記
[PodHasNetwork](/zh-cn/docs/concepts/workloads/pods/pod-lifecycle/#pod-has-network) 狀況。
此特性在 1.28 中重命名爲 `PodReadyToStartContainersCondition`。
