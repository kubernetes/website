...
-->
當 Service 的 `type` 爲 `LoadBalancer` 時，可設置該 Service 的 `ipMode`。
更多細節請參閱[指定負載均衡器狀態的 IPMode](/zh-cn/docs/concepts/services-networking/service/#load-balancer-ip-mode)。
