...
-->
啓用對
[DRA 擴展資源分配](/zh-cn/docs/concepts/configuration/manage-resources-containers/#extended-resources-allocation-by-dra)特性的支持。  
這使得在 DeviceClass 中可以指定擴展的資源名稱。

需要先啓用 `DynamicResourceAllocation` 特性門控，此特性門控纔會生效。
