...
-->
更多資訊請查閱[命令列工具](/zh-cn/docs/reference/kubectl/)（`kubectl`）。
...
<tbody>
    ...
    <tr>
      ...
      -->
      表示 `notReady` 狀態的容忍度秒數：預設情況下，`NoExecute` 被添加到尚未具有此容忍度的每個 Pod 中。
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      -->
      表示 `unreachable` 狀態的容忍度秒數：預設情況下，`NoExecute` 被添加到尚未具有此容忍度的每個 Pod 中。
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      -->
      當日誌機制運行到指定檔案的指定行（file:N）時，打印調用堆棧資訊
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      -->
      定義日誌檔案的最大尺寸。單位爲兆字節。如果值設置爲 0，則表示日誌檔案大小不受限制。
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      -->
      設置爲 true 則表示跳過在日誌消息中出現 header 前綴資訊
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      -->
      設置爲 true 則表示在打開日誌檔案時跳過 header 資訊
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      -->
      以逗號分隔的 pattern=N 設置列表，用於過濾檔案的日誌記錄
      </td>
    </tr>
  </tbody>
</table>
...
-->
kubectl 的設定 ("kubeconfig") 檔案的路徑。預設值："$HOME/.kube/config"
</td>
</tr>
...
-->
切換對 `kubectl explain` 的調用是否使用可用的新 OpenAPIv3 資料源。OpenAPIV3 自 Kubernetes 1.24 起預設被啓用。
</td>
</tr>
...
-->
當設置爲 true 時，kuberc 檔案會被納入考慮，用於定義使用者特定偏好設置。
</td>
</tr>
...
* [kubectl apply](/docs/reference/kubectl/generated/kubectl_apply/) - 基於檔案名或標準輸入，將新的設定應用到資源上
...
-->
* [kubectl auth](/docs/reference/kubectl/generated/kubectl_auth/) - 檢查授權資訊
...
* [kubectl cluster-info](/docs/reference/kubectl/generated/kubectl_cluster-info/) - 顯示叢集資訊
* [kubectl completion](/docs/reference/kubectl/generated/kubectl_completion/) - 根據已經給出的 Shell（bash 或 zsh），
  輸出 Shell 補全後的代碼
* [kubectl config](/docs/reference/kubectl/generated/kubectl_config/) - 修改 kubeconfig 設定檔案
<!--
...
* [kubectl cp](/docs/reference/kubectl/generated/kubectl_cp/) - 將檔案和目錄拷入/拷出容器
* [kubectl create](/docs/reference/kubectl/generated/kubectl_create/) - 通過檔案或標準輸入來創建資源
* [kubectl debug](/docs/reference/kubectl/generated/kubectl_debug/) - 創建用於排查工作負載和節點故障的調試會話
* [kubectl delete](/docs/reference/kubectl/generated/kubectl_delete/) - 通過檔案名、標準輸入、資源和名字刪除資源，
  或者通過資源和標籤選擇算符來刪除資源
<!--
...
-->
* [kubectl describe](/docs/reference/kubectl/generated/kubectl_describe/) - 顯示某個資源或某組資源的詳細資訊
...
-->
* [kubectl get](/docs/reference/kubectl/generated/kubectl_get/) - 顯示一個或者多個資源資訊
...
* [kubectl replace](/docs/reference/kubectl/generated/kubectl_replace/) - 基於檔案名或標準輸入替換資源
...
* [kubectl top](/docs/reference/kubectl/generated/kubectl_top/) - 顯示資源（CPU/內存/儲存）使用率
* [kubectl uncordon](/docs/reference/kubectl/generated/kubectl_uncordon/) - 標記節點爲可調度的
* [kubectl version](/docs/reference/kubectl/generated/kubectl_version/) - 打印客戶端和伺服器的版本資訊
