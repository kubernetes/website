...
此命令描述與每個被支持的 API 資源關聯的字段。
這些字段通過一個簡單的 JSONPath 標識符進行識別：
...
-->
有關每個字段的信息是以 OpenAPI 格式從伺服器中檢索而來的。
...
<tr>
<td colspan="2">-o, --output string&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--Default:-->默認值："plaintext"</td>
</tr>
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;">
<p>
...
-->
* [kubectl](../kubectl/) - kubectl 控制 Kubernetes 叢集控制器
