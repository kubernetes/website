...
所有 Kubernetes 對象都支持以註解（Annotation）的形式爲對象存儲額外的數據。
註解是一些鍵/值對，可以比標籤的數據量更大，可以包含諸如結構化 JSON 這類任意字符串值。
各種工具和系統擴展可以使用註解來存儲自己的數據。

嘗試設置已存在的註解的操作將會失敗，除非設置了 --overwrite 選項。
如果 --resource-version 被指定且與服務器上當前資源版本不匹配，命令將會失敗。
...
<tr>
<td colspan="2">--field-manager string&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--Default: "kubectl-annotate"-->默認值："kubectl-annotate"</td>
</tr>
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;"><p>
<!--
