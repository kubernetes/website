...
-->
使用 'kustomization.yaml' 文件構建一組 KRM 資源。
DIR 參數必須是包含 'kustomization.yaml' 的目錄的路徑，
或相對於 git 倉庫根目錄而言路徑後綴相同的 Git 存儲庫 URL。
如果省略 DIR，則認定爲 '.'（當前目錄）。
...
```
  ...
  # 使用一些共享的配置目錄來執行 build 操作
  kubectl kustomize /home/config/production
  
  # 基於 Github 倉庫來執行 build 操作
...
-->
使用命令執行者所擁有的 uid 和 gid 在容器中執行此操作。
</p>
</td>
</tr>
...
<tr>
<td colspan="2">--helm-command string&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--Default: "helm"-->默認："helm"</td>
</tr>
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;">
<p>
...
-->
啓用 Helm Chart Inflator 生成器的調試輸出。
</p>
</td>
</tr>
...
<tr>
<td colspan="2">--load-restrictor string&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--Default: "LoadRestrictionsRootOnly"-->默認："LoadRestrictionsRootOnly"</td>
</tr>
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;">
<p>
...
-->
如果設置爲 'LoadRestrictionsNone'，本地 kustomization
可能會從其根目錄之外加載文件，但這會破壞了 kustomization 的可重定位能力。
</p>
</td>
</tr>
...
<tr>
<td colspan="2">--network-name string&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--Default: "bridge"-->默認："bridge"</td>
</tr>
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;">
<p>
