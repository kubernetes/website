...
-->
使用 'kustomization.yaml' 檔案構建一組 KRM 資源。
DIR 參數必須是包含 'kustomization.yaml' 的目錄的路徑，
或相對於 git 倉庫根目錄而言路徑後綴相同的 Git 儲存庫 URL。
如果省略 DIR，則認定爲 '.'（當前目錄）。
...
<tr>
<td colspan="2">--helm-command string&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--Default: "helm"-->預設："helm"</td>
</tr>
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;">
<p>
...
<tr>
<td colspan="2">--load-restrictor string&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--Default: "LoadRestrictionsRootOnly"-->預設："LoadRestrictionsRootOnly"</td>
</tr>
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;">
<p>
...
可能會從其根目錄之外加載檔案，但這會破壞了 kustomization 的可重定位能力。
</p>
</td>
</tr>
...
<tr>
<td colspan="2">--network-name string&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--Default: "bridge"-->預設："bridge"</td>
</tr>
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;">
<p>
