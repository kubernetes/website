...
-->
根據所給類別/名稱或檔案來查看最新的 last-applied-configuration 註解。

預設輸出將以 YAML 格式打印到標準輸出。你可以使用 -o 選項來更改輸出格式。
...
-->
```shell
# 根據所給類別/名稱以 YAML 格式查看 last-applied-configuration 註解
kubectl apply view-last-applied deployment/nginx
  
# 根據所給文件以 JSON 格式查看 last-applied-configuration 註解
kubectl apply view-last-applied -f deploy.yaml -o json
```
...
<tr>
<td colspan="2">-o, --output string&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--Default:-->預設值："yaml"</td>
</tr>
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;">
<p>
