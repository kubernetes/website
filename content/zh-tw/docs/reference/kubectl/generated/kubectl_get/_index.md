...
-->
檔案名、目錄或檔案 URL 列表，用於標識要從伺服器獲取的資源。
</p></td>
</tr>
...
-->
向伺服器發送請求所用的原始 URI。使用 kubeconfig 檔案中指定的傳輸方式。
</p></td>
</tr>
...
<tr>
<td colspan="2">--server-print&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--Default:-->預設值：true</td>
</tr>
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;">
<p>
...
-->
當 -o=go-template、-o=go-template-file 時所使用的模板字符串或模板檔案路徑。
