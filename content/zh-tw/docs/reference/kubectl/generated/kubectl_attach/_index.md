...
-->
```shell
# 從運行的 Pod mypod 獲取輸出；使用 'kubectl.kubernetes.io/default-container' 註解來選擇要掛接的容器，
# 否則將選擇 Pod 中的第一個容器
kubectl attach mypod

# 從 Pod mypod 獲取 ruby-container 的輸出
kubectl attach mypod -c ruby-container
...
# 獲取名爲 nginx 的 ReplicaSet 中第一個 Pod 的輸出
kubectl attach rs/nginx
```
...
<tr>
<td colspan="2">--pod-running-timeout duration&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--Default: 1m0s-->默認值：1m0s</td>
</tr>
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;">
<p>
