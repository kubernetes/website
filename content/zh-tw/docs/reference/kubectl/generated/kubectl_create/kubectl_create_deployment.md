...
-->
```shell
# 創建一個名爲 my-dep 的 Deployment，它將運行 busybox 鏡像
kubectl create deployment my-dep --image=busybox

# 創建一個帶有命令的 Deployment
kubectl create deployment my-dep --image=busybox -- date

# 創建一個名爲 my-dep 的 Deployment，它將運行 nginx 鏡像並有 3 個副本
kubectl create deployment my-dep --image=nginx --replicas=3

# 創建一個名爲 my-dep 的 Deployment，它將運行 busybox 鏡像並公開端口 5701
kubectl create deployment my-dep --image=busybox --port=5701

# 創建一個名爲 my-dep 的 Deployment，它將運行多個容器
kubectl create deployment my-dep --image=busybox:latest --image=ubuntu:latest --image=nginx
```
...
-->
要運行的映像檔名稱。Deployment 可以爲多容器 Pod 設置多個映像檔。
</p></td>
</tr>
...
<tr>
<td colspan="2">--port int32&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--Default:-->預設值：-1</td>
</tr>
<tr>
...
-->
指定 Deployment 公開的 containerPort。
</p></td>
</tr>

<tr>
<td colspan="2">-r, --replicas int32&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--Default:-->預設值：1</td>
</tr>
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;"><p>
<!--
