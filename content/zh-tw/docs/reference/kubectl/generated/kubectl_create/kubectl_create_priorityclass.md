...
```
-->
創建帶有指定名稱、取值、globalDefault 設置及描述的優先級類對象。
...
-->
```shell
# 創建一個名爲 high-priority 的優先級類
kubectl create priorityclass high-priority --value=1000 --description="high priority"
  
# 創建一個名爲 default-priority 的優先級類，並將其視爲全局默認優先級
kubectl create priorityclass default-priority --value=1000 --global-default=true --description="default priority"
  
# 創建一個名爲 high-priority 的優先級類，它不能搶佔低優先級的 Pod
kubectl create priorityclass high-priority --value=1000 --description="high priority" --preemption-policy="Never"
```
...
-->
global-default 指定優先級類是否應被視爲默認優先級。
</p></td>
</tr>
...
<tr>
<td colspan="2">--preemption-policy string&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--Default:-->默認值："PreemptLowerPriority"</td>
</tr>
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;">
<p>
...
-->
preemption-policy 是用於搶佔低優先級 Pod 的策略。
</p></td>
</tr>
