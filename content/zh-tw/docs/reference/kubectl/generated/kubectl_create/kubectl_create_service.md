...
* [kubectl create service clusterip](../kubectl_create_service_clusterip/) - 創建 ClusterIP Service
* [kubectl create service externalname](../kubectl_create_service_externalname/) - 創建 ExternalName Service
* [kubectl create service loadbalancer](../kubectl_create_service_loadbalancer/) - 創建 LoadBalancer Service
* [kubectl create service nodeport](../kubectl_create_service_nodeport/) - 創建 NodePort Service
