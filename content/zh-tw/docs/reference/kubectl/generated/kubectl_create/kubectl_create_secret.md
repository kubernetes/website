...
* [kubectl create secret docker-registry](../kubectl_create_secret_docker-registry/) - 創建 Docker 倉庫所用的 Secret
* [kubectl create secret generic](../kubectl_create_secret_generic/) - 基於本地文件、目錄或文字值創建 Secret
* [kubectl create secret tls](../kubectl_create_secret_tls/) - 創建 TLS Secret
