...
-->
用於向服務器發送 POST 請求的原始 URI。使用 kubeconfig 文件中指定的傳輸方式。
</p></td>
</tr>
...
* [kubectl create clusterrole](kubectl_create_clusterrole/) - 創建集羣角色
* [kubectl create clusterrolebinding](kubectl_create_clusterrolebinding/) - 爲特定集羣角色創建集羣角色綁定
...
* [kubectl create rolebinding](kubectl_create_rolebinding/) - 爲特定角色或集羣角色創建角色綁定
