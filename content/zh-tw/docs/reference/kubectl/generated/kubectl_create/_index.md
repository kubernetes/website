...
<tr>
<td colspan="2">--field-manager string&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--Default:-->默認值："kubectl-create"</td>
</tr>
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;"><p>
<!--
...
-->
用於向伺服器發送 POST 請求的原始 URI。使用 kubeconfig 文件中指定的傳輸方式。
</p></td>
</tr>
...
* [kubectl create configmap](kubectl_create_configmap/) - 使用本地文件、目錄或文字值創建 ConfigMap
