...
-->
```shell
# 使用 pod.json 中的數據創建一個 Pod
kubectl create -f ./pod.json

# 基於傳入到標準輸入的 JSON 創建一個 Pod
cat pod.json | kubectl create -f -

# 以 JSON 編輯 registry.yaml 中的數據，然後使用已編輯的數據來創建資源
kubectl create -f registry.yaml --edit -o json
```
...
<tr>
<td colspan="2">--field-manager string&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--Default:-->預設值："kubectl-create"</td>
</tr>
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;"><p>
<!--
...
-->
用於向伺服器發送 POST 請求的原始 URI。使用 kubeconfig 檔案中指定的傳輸方式。
</p></td>
</tr>
...
-->
如果爲 true，當前對象的設定將被保存在其註解中。否則，註解將保持不變。
此標誌在你希望後續對該對象執行 kubectl apply 時很有用。
</p></td>
</tr>
...
-->
僅在 --edit=true 時相關。預設爲你所用平臺原生的行結尾格式。
</p></td>
</tr>
...
* [kubectl create clusterrole](kubectl_create_clusterrole/) - 創建叢集角色
* [kubectl create clusterrolebinding](kubectl_create_clusterrolebinding/) - 爲特定叢集角色創建叢集角色綁定
* [kubectl create configmap](kubectl_create_configmap/) - 使用本地檔案、目錄或文字值創建 ConfigMap
* [kubectl create cronjob](kubectl_create_cronjob/) - 用指定的名稱創建定時 Job
* [kubectl create deployment](kubectl_create_deployment/) - 用指定的名稱創建 Deployment
* [kubectl create ingress](kubectl_create_ingress/) - 用指定的名稱創建 Ingress
* [kubectl create job](kubectl_create_job/) - 用指定的名稱創建 Job
* [kubectl create namespace](kubectl_create_namespace/) - 用指定的名稱創建命名空間
* [kubectl create poddisruptionbudget](kubectl_create_poddisruptionbudget/) - 用指定的名稱創建 Pod 干擾預算
* [kubectl create priorityclass](kubectl_create_priorityclass/) - 用指定的名稱創建優先級類
* [kubectl create quota](kubectl_create_quota/) - 用指定的名稱創建配額
* [kubectl create role](kubectl_create_role/) - 創建具有單一規則的角色
* [kubectl create rolebinding](kubectl_create_rolebinding/) - 爲特定角色或叢集角色創建角色綁定
* [kubectl create secret](kubectl_create_secret/) - 使用指定的子命令創建 Secret
* [kubectl create service](kubectl_create_service/) - 使用指定的子命令創建 Service
* [kubectl create serviceaccount](kubectl_create_serviceaccount/) - 用指定的名稱創建服務賬戶
* [kubectl create token](kubectl_create_token/) - 請求服務賬戶令牌
