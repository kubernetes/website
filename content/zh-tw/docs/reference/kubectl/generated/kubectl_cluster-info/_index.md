...
-->
顯示控制平面和帶有標籤 kubernetes.io/cluster-service=true 的 Service 的地址。
要進一步調試和診斷叢集問題，請使用 "kubectl cluster-info dump"。
...
* [kubectl cluster-info dump](kubectl_cluster-info_dump/) - 轉儲相關資訊以便進行調試和診斷
