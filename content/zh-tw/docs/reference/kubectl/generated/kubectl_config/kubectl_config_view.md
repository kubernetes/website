...
-->
顯示合併的 kubeconfig 設定或指定的 kubeconfig 文件。
...
-->
將生成的 kubeconfig 文件扁平化爲自包含的輸出（對於創建可移植的 kubeconfig 文件很有用）。
</p></td>
</tr>
...
<tr>
<td colspan="2">--merge tristate[=true]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--Default: true-->默認值：true</td>
</tr>
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;">
<p>
...
<tr>
<td colspan="2">-o, --output string&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--Default: "yaml"-->默認值："yaml"</td>
</tr>
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;">
<p>
