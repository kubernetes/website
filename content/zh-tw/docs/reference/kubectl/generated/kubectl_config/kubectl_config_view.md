...
- 可以使用 `--output jsonpath={...}` 通過 jsonpath 表達式提取特定值。
...
```shell
  ...
  # 顯示合併的 kubeconfig 設置、原始證書數據和公開的密鑰
...
-->
將生成的 kubeconfig 檔案扁平化爲自包含的輸出（對於創建可移植的 kubeconfig 檔案很有用）。
</p></td>
</tr>
...
<tr>
<td colspan="2">--merge tristate[=true]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--Default: true-->預設值：true</td>
</tr>
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;">
<p>
...
<tr>
<td colspan="2">-o, --output string&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--Default: "yaml"-->預設值："yaml"</td>
</tr>
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;">
<p>
