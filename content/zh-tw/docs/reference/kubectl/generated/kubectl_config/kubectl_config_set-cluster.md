...
-->
設置 kubeconfig 中的集羣條目的 insecure-skip-tls-verify 字段。
</p></td>
</tr>
...
-->
kubeconfig 中的集羣條目的 tls-server-name 字段。
</p></td>
</tr>
