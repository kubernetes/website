...
* [kubectl auth can-i](kubectl_auth_can-i/) - 檢查是否允許執行操作
* [kubectl auth reconcile](kubectl_auth_reconcile/) - 協調 RBAC 角色、角色綁定、叢集角色和叢集角色綁定對象的規則
* [kubectl auth whoami](kubectl_auth_whoami/) - 實驗特性：檢查自己的主體屬性
