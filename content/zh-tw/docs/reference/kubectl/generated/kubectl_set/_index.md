...
* [kubectl set env](kubectl_set_env/) - 更新 Pod 模板上的環境變量
* [kubectl set image](kubectl_set_image/) - 更新 Pod 模板上的映像檔
* [kubectl set resources](kubectl_set_resources/) - 使用 Pod 模板更新對象的資源請求/限制
* [kubectl set selector](kubectl_set_selector/) - 設置資源上的選擇器
* [kubectl set serviceaccount](kubectl_set_serviceaccount/) - 更新資源的服務賬號
* [kubectl set subject](kubectl_set_subject/) - 更新角色綁定或叢集角色綁定中的使用者、組或服務賬號
