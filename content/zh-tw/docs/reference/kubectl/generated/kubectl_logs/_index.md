...
<tr>
<td colspan="2">--max-log-requests int&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--Default:-->預設值：5</td>
</tr>
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;"><p>
<!--
...
-->
指定使用選擇算符時要遵循的最大併發日誌數。預設值爲 5。
</p></td>
</tr>

<tr>
<td colspan="2">--pod-running-timeout duration&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--Default:-->預設值：20s</td>
</tr>
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;"><p>
<!--
...
預設返回所有日誌。只能使用 since-time 和 since 之一。
</p></td>
</tr>
...
-->
僅返回特定日期（RFC3339）之後的日誌。預設返回所有日誌。
只能使用 since-time 和 since 之一。
</p></td>
</tr>

<tr>
<td colspan="2">--tail int&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--Default:-->預設值：-1</td>
</tr>
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;"><p>
<!--
...
-->
要顯示的最近日誌檔案的行數。不帶選擇算符時預設爲 -1 將顯示所有日誌行。
否則如果提供了選擇算符，則爲 10。
</p></td>
</tr>
