...
* [kubectl rollout history](kubectl_rollout_history/) - 查看上線歷史記錄
* [kubectl rollout pause](kubectl_rollout_pause/) - 將提供的資源標記爲已暫停
* [kubectl rollout restart](kubectl_rollout_restart/) - 重新啓動資源
* [kubectl rollout resume](kubectl_rollout_resume/) - 恢復已暫停的資源
* [kubectl rollout status](kubectl_rollout_status/) - 顯示上線狀態
* [kubectl rollout undo](kubectl_rollout_undo/) - 撤消上一次上線
