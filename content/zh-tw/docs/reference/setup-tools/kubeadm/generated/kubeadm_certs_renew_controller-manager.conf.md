...
-->
續訂 kubeconfig 檔案中嵌入的證書，以供控制器管理器（Controller Manager）使用。
...
-->
預設情況下，續訂會嘗試使用 kubeadm 管理的本地 PKI 中的證書頒發機構；作為替代方案，
可以使用 K8s 證書 API 進行證書續訂；亦或者，作為最後一種選擇，生成 CSR 請求。
...
-->
<p>controller-manager.conf 操作的幫助命令</p>
</td>
</tr>
