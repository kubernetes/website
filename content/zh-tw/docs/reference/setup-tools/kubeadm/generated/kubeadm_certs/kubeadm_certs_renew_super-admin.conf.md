...
-->
續期後，爲了使更改生效，需要重啓控制平面組件，並且如果該檔案在其他地方使用，
最終需要重新分發續期後的證書。
