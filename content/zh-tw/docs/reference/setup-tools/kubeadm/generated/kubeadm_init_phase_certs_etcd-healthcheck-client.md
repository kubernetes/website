...
-->
生成用於 etcd 健康檢查的活躍性探針的證書，並將其儲存到 etcd/healthcheck-client.crt 和 etcd/healthcheck-client.key 檔案中。
...
-->
<p>etcd-healthcheck-client 操作的幫助命令</p>
</td>
</tr>
