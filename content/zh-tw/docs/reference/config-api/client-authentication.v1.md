...
-->
<p>ExecCredentialStatus 中包含傳輸組件要使用的憑據。</p>
<p>字段 token 和 clientKeyData 都是敏感字段。此資料只能在
客戶端與 exec 插件進程之間使用內存來傳遞。exec 插件本身至少
應通過檔案訪問許可來實施保護。</p>
