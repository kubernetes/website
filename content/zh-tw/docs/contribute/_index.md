...
-->
爲 Kubernetes 做出貢獻的方法有很多。你可以致力於新特性的設計，
爲已有代碼撰寫文檔，或[撰寫博客文章](/zh-cn/docs/contribute/blog/)。
除此之外，你還可以實現這些新特性或修復 Bug。
你可以幫助他人加入貢獻者社區，或支持現有的貢獻者。
...
如果你希望協助維護官方 Kubernetes 博客，
請閱讀[參與 Kubernetes 博客貢獻](/zh-cn/docs/contribute/blog/)。
...
你也可以閱讀
{{< glossary_tooltip text="CNCF" term_id="cncf" >}}
[頁面](https://contribute.cncf.io/contributors/projects/#kubernetes)
，瞭解如何爲 Kubernetes 做貢獻。
