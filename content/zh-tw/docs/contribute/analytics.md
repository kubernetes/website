...
-->
此頁面包含有關 kubernetes.io 分析儀表板的信息。
...
此儀表板使用 [Google Looker Studio](https://lookerstudio.google.com/overview) 構建，並顯示自 2022 年 8 月以來使用 Google Analytics 4 在 kubernetes.io 上收集的信息。
