...
-->
[查看儀表板](https://lookerstudio.google.com/u/0/reporting/fe615dc5-59b0-4db5-8504-ef9eacb663a9/page/4VDGB/)。

此儀表板使用 [Google Looker Studio](https://lookerstudio.google.com/overview) 構建，並顯示自 2022 年 8 月以來使用 Google Analytics 4 在 kubernetes.io 上收集的資訊。
...
-->
### 使用儀表板 {#using-the-dashboard}

預設情況下，儀表板顯示過去 30 天收集的所有分析。
使用日期選擇器查看來自不同日期範圍的資料。
其他過濾選項允許你根據使用者位置、用於訪問站點的設備、所用文檔的翻譯等查看資料。
