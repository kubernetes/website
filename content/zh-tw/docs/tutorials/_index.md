...
在閱讀每個教學之前，建議您將[詞彙表](/docs/reference/glossary/)頁面加入書籤，以便日後參考。
...
* [Kubernetes 基礎](/docs/tutorials/kubernetes-basics/)是一個深入的互動式教學，幫助您了解 Kubernetes 系統並實際嘗試一些基本的 Kubernetes 功能。
...
* [範例：使用持久卷部署 WordPress 與 MySQL](/docs/tutorials/stateful-application/mysql-wordpress-persistent-volume/)
...
* [使用 DRA 安裝驅動程式並配置裝置](/docs/tutorials/cluster-management/install-use-dra/)
