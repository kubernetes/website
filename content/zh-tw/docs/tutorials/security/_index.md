...
-->
對於運行 Kubernetes 集羣的大多數組織和人員來說，安全是一個重要問題。
你可以在 Kubernetes 文檔的其他地方找到基本的[安全檢查清單](/zh-cn/docs/concepts/security/security-checklist/)。

要了解如何部署和管理 Kubernetes 的安全的方方面面，你可以按照本部分中的教程進行操作。
