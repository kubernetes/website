...
-->
本教程介紹 Kubernetes 集羣編排系統的基礎知識。每個模塊包含關於
Kubernetes 主要特性和概念的一些背景信息，還包括一個在線教程供你學習。
...
通過使用現代的 Web 服務，用戶希望應用能夠 24/7 全天候可用，開發人員希望每天可以多次部署應用的更新版本。
容器化可以幫助打包軟件以達成這些目標，使應用能夠以簡單快速的方式被髮布和更新，而不會出現中斷。
Kubernetes 幫助你確保這些容器化應用在你想要的時間和地點運行，並幫助應用找到它們需要的資源和工具。
Kubernetes 是一個可用於生產環境的開源平臺，基於 Google 在容器集羣方面積累的經驗，
設計上融合了來自社區的最佳實踐。
...
-->
* [使用 Minikube 創建一個集羣](/zh-cn/docs/tutorials/kubernetes-basics/create-cluster/)的教程
