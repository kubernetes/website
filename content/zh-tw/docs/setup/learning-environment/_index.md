...
## 設定本機 Kubernetes 環境   {#setting-up-local-kubernetes-environments}
...
## 使用線上練習環境   {#using-online-playgrounds}
...
## 使用接近正式環境的叢集來練習   {#practicing-with-production-like-clusters}
...
- 了解 [Kubernetes 組件](/zh-tw/docs/concepts/overview/components/)
