...
-->
本頁面提供關於強制實施 [Pod 安全標準](/zh-tw/docs/concepts/security/pod-security-standards)
的最佳實務概述。
...
-->
[Pod 安全准入控制器](/zh-tw/docs/reference/access-authn-authz/admission-controllers/#podsecurity)
...
我們提供了一個[範例](/zh-tw/docs/tasks/configure-pod-container/enforce-standards-namespace-labels/#applying-to-all-namespaces)，
