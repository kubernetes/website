...
Цей сценарій дозволяє розгорнути Kubernetes на "голому" залізі за пʼять хвилин і отримати `kubeconfig` для доступу до нього. Однак попереду ще багато невирішених питань.
