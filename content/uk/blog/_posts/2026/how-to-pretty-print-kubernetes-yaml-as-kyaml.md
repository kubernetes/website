...
### Варіант 2: yamlfmt {#option-2-yamlfmt}
...
Він також доступний як [pre-commit хук](https://github.com/google/yamlfmt/blob/main/docs/pre-commit.md) та як [Docker-образ](https://github.com/google/yamlfmt) для CI-конвеєрів.
