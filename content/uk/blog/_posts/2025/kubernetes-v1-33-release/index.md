...
Цю роботу було виконано в рамках проєкту [KEP-3633: Introduce MatchLabelKeys to Pod Affinity and Pod Anti Affinity](https://kep.k8s.io/3633) під керівництвом SIG Scheduling.
...
Ця робота була виконана в рамках проєкту [KEP-2644: Always Honor PersistentVolume Reclaim Policy](https://kep.k8s.io/2644) під керівництвом SIG Storage.
...
Цю роботу було виконано у рамках проєкту [KEP-4265: add ProcMount option](https://kep.k8s.io/4265) під керівництвом SIG Node.
...
Ця робота була виконана у рамках проєкту [KEP-5073: Declarative Validation Of Kubernetes Native Types With validation-gen](https://kep.k8s.io/5073) під керівництвом SIG API Machinery.
...
[Check out DevStats](https://k8s.devstats.cncf.io/d/11/companies-contributing-in-repository-groups?orgId=1&var-period=m&var-repogroup_name=All), щоб дізнатися більше про загальну швидкість проєкту та спільноти Kubernetes.
