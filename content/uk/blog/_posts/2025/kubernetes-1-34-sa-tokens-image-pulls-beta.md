...
Якщо ви зацікавлені в участі в розробці цієї функції, поділіться відгуками або візьміть участь в інших поточних проєктах SIG Auth, будь ласка, звʼяжіться з нами в каналі [#sig-auth](https://kubernetes.slack.com/archives/C0EN96KUY) на Kubernetes Slack.
