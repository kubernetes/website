...
Більше інформації можна знайти в [офіційній документації](/docs/concepts/resource-management/dynamic-resource-allocation/dra-features/#partitionable-devices).
...
Більше інформації про [Споживчу ємність](/docs/concepts/resource-management/dynamic-resource-allocation/dra-features/#consumable-capacity) та [Умови привʼязки](/docs/concepts/resource-management/dynamic-resource-allocation/dra-features/#device-binding-conditions) можна знайти в офіційній документації.
