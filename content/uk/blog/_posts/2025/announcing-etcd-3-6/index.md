...
{{< figure src="figure-1.png" alt="Схема використання памʼяті" >}}
...
**Основні висновки**: користувачі повинні спочатку оновитися до etcd v3.5.20 (або вищої версії виправлення) перед оновленням до etcd v3.6.0; інакше оновлення може зазнати невдачі.
