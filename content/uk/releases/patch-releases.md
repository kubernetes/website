---
title: Випуски виправлення
type: docs
weight: 30
---

Розклад та контактна інформація команди випусків виправлення Kubernetes.
...
Типова періодичність випусків виправлення — щомісяця. Зазвичай вона трохи швидша (1-2 тижні) для перших випусків виправлення після 1.X мінорного випуску. Критичні виправлення можуть призвести до негайного випуску поза звичайною періодичністю. Ми також намагаємося не робити випуски під час основних святкових періодів.

## Контакти {#contact}

Дивіться сторінку [Менеджери Випусків][release-managers] для отримання повних контактних даних команди випусків виправлення.
...
Cherry pick PR, які не відповідають критеріям злиття, будуть перенесені та додані для наступного випуску виправлення.

## Період підтримки {#support-period}

Відповідно до [KEP річної підтримки][yearly-support], спільнота Kubernetes підтримуватиме активні серії випусків виправлення протягом приблизно чотирнадцяти (14) місяців.
...
- Серія випусків виправлення перейде в режим обслуговування
...
Наприкінці двомісячного періоду обслуговування серія випусків виправлення вважатиметься завершеною (EOL) і cherry picks до відповідної гілки будуть закриті незабаром після цього.
