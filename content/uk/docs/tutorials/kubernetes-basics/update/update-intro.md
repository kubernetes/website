...
Під час поступового оновлення така поведінка дозволяє застосункам залишатись доступними спрямовуючи трафік тільки до подів, що обробляють запити. Поступові оновлення дозволяють виконувати наступні дії:

* Поширення застосунку з одного середовища в інше (за допомогою оновлень образів контейнерів)
* Відкат до попередніх версій
* Безперервна інтеграція та постійна доставка застосунків без перерви в роботі
...
Спочатку перевірте, чи Service працює, бо ви могли його видалити на попередньому кроці, виконайте `describe services/kubernetes-bootcamp`. Якщо його немає, створіть його знову:
