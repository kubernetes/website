---
title: Запуск автономного Kubelet
...
Якщо вам потрібно діагностувати проблему, повʼязану з роботою цього посібника, ви можете зазирнути в наступні теки для моніторингу та усунення несправностей:
