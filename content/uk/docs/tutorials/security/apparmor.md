...
До версії Kubernetes v1.30, AppArmor вказувався через анотації. Використовуйте потрібну версію документації для перегляду документації з цим застарілим API.
{{< /alert >}}

Профілі AppArmor можна вказати на рівні Podʼа або на рівні контейнера. Профіль AppArmor контейнера має перевагу перед профілем Podʼа.
