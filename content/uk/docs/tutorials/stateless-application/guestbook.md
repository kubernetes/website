...
* Спробуйте [Розгортання канаркового релізу](/docs/tutorials/stateless-application/canary-deployment/), щоб дізнатися, як безпечно тестувати нові версії застосунків у виробничому середовищі.
