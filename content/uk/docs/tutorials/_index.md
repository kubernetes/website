...
* [Запуск автономного Kubelet](/docs/tutorials/cluster-management/kubelet-standalone/)
...
* [Ознайомтеся з політиками Validating та Mutating Admission](/docs/tutorials/cluster-management/admission-policies/)
