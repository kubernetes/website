...
8. Встановлює DNS сервер (CoreDNS) та компоненти надбудови kube-proxy через API server. Зверніть увагу, що хоча DNS сервер розгорнутий, він не буде запланований до встановлення CNI.
