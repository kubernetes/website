...
* [Цикл синхронізації kubelet](/docs/reference/node/kubelet-sync-loop/)

* [checkpoint API](/docs/reference/node/kubelet-checkpoint-api/) kubelet

* [Pod Info gRPC API](/docs/reference/node/kubelet-pod-info-grpc-api/) у kubelet
...
* [Що відбувається після перезапуску вузла](/docs/reference/node/what-happens-on-restart/)
