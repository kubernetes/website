...
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;"><p>Елемент allowlist у формі field=value (можна вказувати кілька разів)</p></td>
</tr>
...
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;"><p>Політика втулка для використання з exec credential plugins, повинна бути однією з 'AllowAll', 'DenyAll' або 'Allowlist'</p></td>
</tr>
...
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;"><p>Розділ для модифікації: 'defaults', 'aliases' або 'credentialplugin'</p></td>
</tr>
