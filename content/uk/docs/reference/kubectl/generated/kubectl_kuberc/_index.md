...
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;"><p>довідка для kuberc</p></td>
</tr>
...
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;"><p>Якщо true, сертифікат сервера не буде перевірятися на дійсність. Це зробить ваші HTTPS-зʼєднання незахищеними</p></td>
</tr>
...
* [kubectl kuberc set](kubectl_kuberc_set/) — Встановити значення в конфігурації kuberc
* [kubectl kuberc view](kubectl_kuberc_view/) — Показати поточну конфігурацію kuberc
