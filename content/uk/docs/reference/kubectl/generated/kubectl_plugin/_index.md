...
Найпростіший спосіб знайти та встановити втулки — за допомогою субпроєкту kubernetes krew. Щоб встановити krew, відвідайте [krew.sigs.k8s.io](https://krew.sigs.k8s.io/docs/user-guide/setup/install/).
...
<table style="width: 100%; table-layout: fixed;">
    ...
    <tbody>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Довідка plugin</p></td>
        </tr>
    </tbody>
</table>
...
* [kubectl plugin list](kubectl_plugin_list/) — список усіх виконуваних файлів втулків видимих у PATH користувача
