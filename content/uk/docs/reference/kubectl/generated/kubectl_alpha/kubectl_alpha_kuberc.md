...
* [kubectl alpha](../) — Команди для функцій в alpha
* [kubectl alpha kuberc set](../kubectl_alpha_kuberc_set/) — Встановити значення в конфігурації kuberc
* [kubectl alpha kuberc view](../kubectl_alpha_kuberc_view/) — Показати поточну конфігурацію kuberc
