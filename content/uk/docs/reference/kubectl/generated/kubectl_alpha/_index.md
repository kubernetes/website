...
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;"><p>довідка для alpha</p></td>
</tr>
...
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;"><p>Імʼя користувача, яке потрібно використовувати для виконання операції. Користувач може бути звичайним користувачем або службовим обліковим обліковим записом в просторі імен.</p></td>
</tr>
...
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;"><p>Група, яку потрібно використовувати для виконання операції, цей прапорець можна повторювати для зазначення кількох груп.</p></td>
</tr>
...
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;"><p>UID для виконання операції від імені іншого користувача</p></td>
</tr>
...
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;"><p>Додаткові параметри користувача, які слід використовувати для проведення операції. Цей прапорець можна повторювати, щоб вказати кілька значень для одного і того ж ключа.</p></td>
</tr>
...
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;"><p>Записи в драйвері зберігання будуть буферизовані протягом цього часу і зафіксовані в бекендах, що не є памʼяттю, як одна транзакція.</p></td>
</tr>
...
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;"><p>Токен на предʼявника для автентифікації в API сервері</p></td>
</tr>
...
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;"><p>Назва користувача kubeconfig для використання</p></td>
</tr>
...
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;"><p>Імʼя користувача для базової автентифікації в API сервері
</tr>
...
* [kubectl](../kubectl/) — kubectl керує менеджером кластера Kubernetes
* [kubectl alpha kuberc](kubectl_alpha_kuberc/) — Керує файлами конфігурації kuberc
