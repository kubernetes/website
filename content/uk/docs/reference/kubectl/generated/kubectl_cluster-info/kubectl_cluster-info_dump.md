...
<table style="width: 100%; table-layout: fixed;">
    ...
    <tbody>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Довідка dump</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Список просторів імен для дампа через кому.</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Куди виводити файли.  Якщо порожньо або '-' використовує stdout, інакше створює ієрархію тек у цій теці</p></td>
        </tr>
        <tr>
...
* [kubectl cluster-info](../) — Показ інформації про кластер
