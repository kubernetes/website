...
<table style="width: 100%; table-layout: fixed;">
    ...
    <tbody>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Відредагувати ресурс API перед створенням</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Імʼя файлу, теки або URL до файлів, що використовуються для створення ресурсу</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Необроблений URI для POST на сервер.  Використовує транспорт, вказаний у файлі kubeconfig.</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Має значення лише якщо --edit=true. Стандартно використовується закінчення рядка, притаманне вашій платформі.</p></td>
        </tr>
    </tbody>
</table>
...
* [kubectl create clusterrole](kubectl_create_clusterrole/) — Створити кластерну роль
* [kubectl create clusterrolebinding](kubectl_create_clusterrolebinding/) — Створити кластерне привʼязування ролі для певної кластерної ролі
* [kubectl create configmap](kubectl_create_configmap/) — Створити ConfigMap з локального файлу, теки або літерального значення
* [kubectl create cronjob](kubectl_create_cronjob/) — Створити cron job з вказаним імʼям
* [kubectl create deployment](kubectl_create_deployment/) — Створити deployment з вказаним імʼям
* [kubectl create ingress](kubectl_create_ingress/) — Створити ingress з вказаним імʼям
* [kubectl create job](kubectl_create_job/) — Створити job з вказаним імʼям
* [kubectl create namespace](kubectl_create_namespace/) — Створити namespace з вказаним імʼям
* [kubectl create poddisruptionbudget](kubectl_create_poddisruptionbudget/) — Створити PodDisruptionBudget з вказаним імʼям
* [kubectl create priorityclass](kubectl_create_priorityclass/) — Створити клас пріоритету з вказаним імʼям
* [kubectl create quota](kubectl_create_quota/) — Створити квоту з вказаним імʼям
* [kubectl create role](kubectl_create_role/) — Створити роль з одним правилом
* [kubectl create rolebinding](kubectl_create_rolebinding/) — Створити привʼязування ролі для певної ролі або кластерної ролі
* [kubectl create secret](kubectl_create_secret/) — Створити секрет за допомогою вказаної субкоманди
* [kubectl create service](kubectl_create_service/) — Створити сервіс за допомогою вказаної субкоманди
* [kubectl create serviceaccount](kubectl_create_serviceaccount/) — Створити службовий обліковий запис з вказаним імʼям
* [kubectl create token](kubectl_create_token/) — Запит на отримання токена службового облікового запису
