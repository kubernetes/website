...
<table style="width: 100%; table-layout: fixed;">
    ...
    <tbody>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Email для реєстру Docker</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Пароль для автентифікації в реєстрі Docker</p></td>
        </tr>
        <tr>
            <td colspan="2">--docker-server string&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Типово: "https://index.docker.io/v1/"</td>
        </tr>
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Розташування сервера реєстру Docker</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Імʼя користувача для автентифікації в реєстрі Docker</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Довідка docker-registry</p></td>
        </tr>
        <tr>
