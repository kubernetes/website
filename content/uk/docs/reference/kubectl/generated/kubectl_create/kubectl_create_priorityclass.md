...
# Створити клас пріоритету з назвою high-priority, який не може витісняти Podʼи з нижчим пріоритетом
...
<table style="width: 100%; table-layout: fixed;">
    ...
    <tbody>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>description — довільний рядок, який зазвичай містить вказівки щодо того, коли слід використовувати цей клас пріоритету.</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>global-default вказує, чи слід вважати цей PriorityClass стандартним пріоритетом.</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Довідка priorityclass</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2">--preemption-policy string&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Типово: "PreemptLowerPriority"</td>
        </tr>
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>preemption-policy — це політика витіснення Podʼів з нижчим пріоритетом.</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>значення цього класу пріоритету.</p></td>
        </tr>
    </tbody>
</table>
