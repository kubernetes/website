...
<table style="width: 100%; table-layout: fixed;">
    ...
    <tbody>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Довідка deployment</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Назви образів для запуску. Deployment може містити кілька образів для багатоконтейнерних pod.</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2">--port int32&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Типово: -1</td>
        </tr>
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Порт containerPort, який цей deployment експонує.</p></td>
        </tr>
        <tr>
            <td colspan="2">-r, --replicas int32&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Типово: 1</td>
        </tr>
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Кількість реплік для створення. Стандартно дорівнює 1.</p></td>
        </tr>
        <tr>
