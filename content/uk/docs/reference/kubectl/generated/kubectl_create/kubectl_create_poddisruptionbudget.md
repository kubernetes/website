...
<table style="width: 100%; table-layout: fixed;">
    ...
    <tbody>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Довідка poddisruptionbudget</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Максимальна кількість або відсоток недоступних Podʼів, яких вимагає цей бюджет.</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Мінімальна кількість або відсоток доступних Podʼів, яких вимагає цей бюджет.</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Селектор мітки, який буде використано для цього бюджету. Підтримуються лише вимоги до селектора на основі рівності.</p></td>
        </tr>
        <tr>
...
<table style="width: 100%; table-layout: fixed;">
    ...
    <tbody>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Додаткові дані користувача для імперсонації під час операції; цей прапорець можна вказувати кілька разів для визначення кількох значень для одного ключа.</p></td>
        </tr>
        <tr>
