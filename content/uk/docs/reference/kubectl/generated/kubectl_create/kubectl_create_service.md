...
* [kubectl create service clusterip](../kubectl_create_service_clusterip/) — Створення сервісу ClusterIP
* [kubectl create service externalname](../kubectl_create_service_externalname/) — Створення сервісу ExternalName
* [kubectl create service loadbalancer](../kubectl_create_service_loadbalancer/) — Створення сервісу LoadBalancer
* [kubectl create service nodeport](../kubectl_create_service_nodeport/) - Створення сервісу NodePort
