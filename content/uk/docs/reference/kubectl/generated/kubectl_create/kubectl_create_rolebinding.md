...
<table style="width: 100%; table-layout: fixed;">
    ...
    <tbody>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>ClusterRole на яку повинна посилатися привʼязка ClusterRoleBinding</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Групи для привʼязки до кластерної ролі. Прапорець можна повторити, щоб додати кілька груп.</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Довідка rolebinding</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td><td style="line-height: 130%; word-wrap: break-word;"><p>Роль, на яку має посилатися ця RoleBinding</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Службові облікові записи для привʼязки до кластерної ролі, у форматі &lt;простір імен&gt;:&lt;імʼя&gt;. Прапорець можна повторювати для додавання декількох службових облікових записів.</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Імена користувачів для привʼязки до кластерної ролі. Прапорець можна повторити, щоб додати кількох користувачів.</p></td>
        </tr>
        <tr>
