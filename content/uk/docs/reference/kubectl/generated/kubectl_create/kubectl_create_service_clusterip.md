...
<table style="width: 100%; table-layout: fixed;">
    ...
    <tbody>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Призначте власний ClusterIP або встановіть значення "None" для сервісу "headless" (без балансування навантаження).</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Довідка clusterip</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Пари портів можна вказати у вигляді '&lt;порт&gt;:&lt;цільовий порт&gt;'.</p></td>
        </tr>
        <tr>
