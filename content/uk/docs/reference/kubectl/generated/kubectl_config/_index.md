...
<table style="width: 100%; table-layout: fixed;">
    ...
    <tbody>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Довідник config</p></td>
        </tr>
        <tr>
...
* [kubectl config current-context](kubectl_config_current-context/) — Показати поточний контекст
* [kubectl config delete-cluster](kubectl_config_delete-cluster/) — Видалити вказаний кластер з kubeconfig
* [kubectl config delete-context](kubectl_config_delete-context/) — Видалити вказаний контекст з kubeconfig
* [kubectl config delete-user](kubectl_config_delete-user/) — Видалити вказаного користувача з kubeconfig
* [kubectl config get-clusters](kubectl_config_get-clusters/) — Показати кластери, визначені в kubeconfig
* [kubectl config get-contexts](kubectl_config_get-contexts/) — Показати опис одного або кількох контекстів
* [kubectl config get-users](kubectl_config_get-users/) — Показати користувачів, визначених у kubeconfig
* [kubectl config rename-context](kubectl_config_rename-context/) — Перейменувати контекст у файлі kubeconfig
* [kubectl config set](kubectl_config_set/) — Встановити окреме значення у файлі kubeconfig
* [kubectl config set-cluster](kubectl_config_set-cluster/) — Встановити запис кластера в kubeconfig
* [kubectl config set-context](kubectl_config_set-context/) — Встановити запис контексту в kubeconfig
* [kubectl config set-credentials](kubectl_config_set-credentials/) — Встановити запис користувача в kubeconfig
* [kubectl config unset](kubectl_config_unset/) — Видалити окреме значення з файлу kubeconfig
* [kubectl config use-context](kubectl_config_use-context/) — Встановити поточний контекст у файлі kubeconfig
* [kubectl config view](kubectl_config_view/) — Показати обʼєднані налаштування kubeconfig або вказаний файл kubeconfig
