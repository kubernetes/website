...
<table style="width: 100%; table-layout: fixed;">
    ...
    <tbody>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Довідка certificate</p></td>
        </tr>
    </tbody>
</table>
...
* [kubectl certificate approve](kubectl_certificate_approve/) — Схвалення запиту на підписання сертифіката
* [kubectl certificate deny](kubectl_certificate_deny/) — Відхилення запиту на підписання сертифіката
