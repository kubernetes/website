...
<table style="width: 100%; table-layout: fixed;">
    ...
    <tbody>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Умова для очікування: [create|delete|condition=condition-name[=condition-value]|jsonpath='{JSONPath expression}'=[JSONPath value]]. Стандартне значення condition-value дорівнює true.  Значення умови порівнюються після простого згортання регістру Unicode, що є більш загальною формою нечутливості до регістру. Підтримується кілька умов, які об'єднуються за допомогою логічного AND у послідовному порядку. Якщо передано --for=create, воно завжди очікується першим.</p></td>
        </tr>
        <tr>
