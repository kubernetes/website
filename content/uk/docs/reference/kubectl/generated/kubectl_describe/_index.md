...
<table style="width: 100%; table-layout: fixed;">
    ...
    <tbody>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Імʼя файлу, теки або URL до файлів, що ідентифікують ресурс для отриманні інформації</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Довідка describe</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2">--show-events&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Типово: true</td>
        </tr>
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Якщо true, показувати події, повʼязані з описаним обʼєктом. Типово: true для одного обʼєкта, false для кількох обʼєктів та префіксного співпадіння.</p></td>
        </tr>
    </tbody>
</table>
