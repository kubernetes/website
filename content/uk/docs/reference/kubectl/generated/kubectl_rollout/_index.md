...
<table style="width: 100%; table-layout: fixed;">
    ...
    <tbody>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Довідка rollout</p></td>
        </tr>
    </tbody>
</table>
...
* [kubectl rollout history](kubectl_rollout_history/) — Переглянути історію розгортання
* [kubectl rollout pause](kubectl_rollout_pause/) — Позначити наданий ресурс як призупинений
* [kubectl rollout restart](kubectl_rollout_restart/) — Перезапустити ресурс
* [kubectl rollout resume](kubectl_rollout_resume/) — Відновити призупинений ресурс
* [kubectl rollout status](kubectl_rollout_status/) — Показувати статус розгортання
* [kubectl rollout undo](kubectl_rollout_undo/) — Відмінити попереднє розгортання
