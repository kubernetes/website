...
# Отримати поля ресурсу до певної рекурсивної глибини
...
<table style="width: 100%; table-layout: fixed;">
    ...
    <tbody>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Максимальна глибина рекурсії під час виведення вкладених полів за допомогою --recursive. 0 означає відсутність обмеження. Вимагає --recursive, якщо значення більше 0.</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td style="line-height: 130%; word-wrap: break-word;"><p>Виводить поля полів. Використовуйте --max-depth, щоб обмежити глибину рекурсії.</p></td>
        </tr>
    </tbody>
</table>
