...
Kubernetes реалізує всі мітки та анотації в просторах імен `kubernetes.io` та `k8s.io`.
...
Унікальне імʼя, що ідентифікує екземпляр застосунку.
Для призначення неунікального імені використовуйте [app.kubernetes.io/name](#app-kubernetes-io-name).
...
Назва більшої системи, до якої належить застосунок.
