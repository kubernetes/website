...
{{< caution >}}
Дивіться [Невідповідне вимкнення вузла](/docs/concepts/architecture/nodes/#non-graceful-node-shutdown) для отримання додаткових відомостей про те, коли і як використовувати це позначення.
{{< /caution >}}
