...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>action є дією, що була виконана або не вдалася щодо відповідного обʼєкта. Поле є машинозчитуваним. Це поле не може бути порожнім для нових подій і може містити максимум 128 символів.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>deprecatedCount є застарілим полем, що забезпечує зворотну сумісність з типом події core.v1.</td>
    </tr>
    <tr>
      <td><code>deprecatedFirstTimestamp</code><br/><em><a href="{{< ref "../definitions/time-v1-meta#Time" >}}">Time</a></em></td>
      <td>deprecatedFirstTimestamp є застарілим полем, що забезпечує зворотну сумісність з типом події core.v1.</td>
    </tr>
    <tr>
      <td><code>deprecatedLastTimestamp</code><br/><em><a href="{{< ref "../definitions/time-v1-meta#Time" >}}">Time</a></em></td>
      <td>deprecatedLastTimestamp є застарілим полем, що забезпечує зворотну сумісність з типом події core.v1.</td>
    </tr>
    <tr>
      <td><code>deprecatedSource</code><br/><em><a href="{{< ref "../definitions/event-source-v1#EventSource" >}}">EventSource</a></em></td>
      <td>deprecatedSource є застарілим полем, що забезпечує зворотну сумісність з типом події core.v1.</td>
    </tr>
    <tr>
      <td><code>eventTime</code>&nbsp;<strong>*</strong><br/><em><a href="{{< ref "../definitions/micro-time-v1-meta#MicroTime" >}}">MicroTime</a></em></td>
      <td>eventTime є часом, коли ця подія була вперше зафіксована. Це поле є обовʼязковим.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>note є описом стану цієї операції, зрозумілим для людини. Максимальна довжина note становить 1 кБ, але бібліотеки повинні бути готові обробляти значення до 64 кБ.</td>
    </tr>
    <tr>
      <td><code>reason</code><br/><em>string</em></td>
      <td>reason є причиною, чому була виконана дія. Поле зрозуміле для людини. Це поле не може бути порожнім для нових подій і може містити максимум 128 символів.</td>
    </tr>
    <tr>
      <td><code>regarding</code><br/><em><a href="{{< ref "../definitions/object-reference-v1#ObjectReference" >}}">ObjectReference</a></em></td>
      <td>regarding містить обʼєкт, якого стосується ця подія. У більшості випадків це обʼєкт, який реалізує контролер, наприклад, ReplicaSetController реалізує ReplicaSets, і ця подія виникає через зміни в обʼєкті ReplicaSet.</td>
    </tr>
    <tr>
      <td><code>related</code><br/><em><a href="{{< ref "../definitions/object-reference-v1#ObjectReference" >}}">ObjectReference</a></em></td>
      <td>related є необовʼязковим вторинним обʼєктом для більш складних дій. Наприклад, коли обʼєкт regarding викликає створення або видалення повʼязаного обʼєкта.</td>
    </tr>
    <tr>
      <td><code>reportingController</code><br/><em>string</em></td>
      <td>reportingController є назвою контролера, який створив цю подію, наприклад, <code>kubernetes.io/kubelet</code>. Це поле не може бути порожнім для нових подій.</td>
    </tr>
    <tr>
      <td><code>reportingInstance</code><br/><em>string</em></td>
      <td>reportingInstance є ідентифікатором екземпляра контролера, наприклад, <code>kubelet-xyzf</code>. Це поле не може бути порожнім для нових подій і може містити максимум 128 символів.</td>
    </tr>
    <tr>
      <td><code>series</code><br/><em><a href="{{< ref "#EventSeries" >}}">EventSeries</a></em></td>
      <td>series містить дані про серію подій, яку представляє ця подія, або nil, якщо це одиночна подія.</td>
    </tr>
    <tr>
      <td><code>type</code><br/><em>string</em></td>
      <td>type визначає тип цієї події (Normal, Warning), нові типи можуть бути додані в майбутньому. Це поле машинозчитуване. Воно не може бути порожнім для нових подій.</td>
    </tr>
  </tbody>
</table>
...
EventList є списком обʼєктів Event.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>metadata — стандартні метадані списку. Детальніше: <a href="https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata">https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata</a></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>count визначає кількість випадків у цій серії до часу останнього сигналу.</td>
    </tr>
    <tr>
      <td><code>lastObservedTime</code>&nbsp;<strong>*</strong><br/><em><a href="{{< ref "../definitions/micro-time-v1-meta#MicroTime" >}}">MicroTime</a></em></td>
      <td>lastObservedTime визначає час, коли остання подія з серії була зафіксована перед останнім сигналом.</td>
    </tr>
  </tbody>
</table>
