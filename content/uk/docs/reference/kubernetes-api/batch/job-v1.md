...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Кількість Podʼів, які завершуються (у фазі Pending або Running і мають deletionTimestamp). Це поле знаходиться на рівні бета. Контролер Job заповнює поле, коли ввімкнено функціональну можливість JobPodReplacementPolicy (стандартно увімкнено).</td>
    </tr>
    <tr>
