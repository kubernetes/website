...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Data є серіалізованим представленням стану.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Revision вказує на ревізію стану, представленого полем Data.</td>
    </tr>
  </tbody>
</table>
...
ControllerRevisionList є ресурсом, що містить список обʼєктів ControllerRevision.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Items є списком обʼєктів ControllerRevision</td>
    </tr>
    <tr>
      <td><code>kind</code><br/><em>string</em></td>
      <td>Kind визначає тип REST-ресурсу, який представляє цей обʼєкт. Сервери можуть визначати це з точки доступу, до якої клієнт надсилає запити. Не може бути оновлено. У CamelCase. Детальніше: <a href="https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds">https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</a></td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><em>string</em></td>
      <td>Назва ControllerRevision</td>
    </tr>
    <tr>
      <td><code>namespace</code></td>
      <td><em>string</em></td>
...
<table>
  ...
  <tbody>
    <tr>
      <td><code>namespace</code></td>
      <td><em>string</em></td>
      <td>Назва простору імен та область авторизації, наприклад для команд і проєктів</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>namespace</code></td>
      <td><em>string</em></td>
      <td>назва обʼєкта та область автентифікації, наприклад для команд і проєктів</td>
    </tr>
  </tbody>
</table>
