...
description: "ReplicaSet забезпечує, що в будь-який момент часу працює вказана кількість реплік Pod."
title: "ReplicaSet"
weight: 40
...
ReplicaSet забезпечує, що в будь-який момент часу працює вказана кількість реплік Pod.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Якщо Labels у ReplicaSet порожні, вони зазвичай будуть такими ж, як у Pod(ів), якими керує ReplicaSet. Стандартні метадані обʼєкта. Детальніше: <a href="https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata">https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata</a></td>
    </tr>
    <tr>
      <td><code>spec</code><br/><em><a href="{{< ref "#ReplicaSetSpec" >}}">ReplicaSetSpec</a></em></td>
      <td>Spec визначає специфікацію бажаної поведінки ReplicaSet. Детальніше: <a href="https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status">https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status</a></td>
    </tr>
    <tr>
      <td><code>status</code><br/><em><a href="{{< ref "#ReplicaSetStatus" >}}">ReplicaSetStatus</a></em></td>
      <td>Статус визначає останній спостережуваний стан ReplicaSet. Ці дані можуть бути застарілими на деякий проміжок часу. Заповнюється системою. Тільки для читання. Детальніше: <a href="https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status">https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status</a></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Replicas це загальна кількість бажаних подів. Це вказівник, щоб відрізнити явний нуль від невказаного значення. ЗСтандартно — 1. Детальніше: <a href="/uk/docs/concepts/workloads/controllers/replicaset">https://kubernetes.io/docs/concepts/workloads/controllers/replicaset</a></td>
    </tr>
    <tr>
      ...
      <td>Selector це запит до міток подів, які повинні відповідати кількості реплік. Ключі та значення міток, які повинні відповідати, щоб керуватися цим ReplicaSet. Повинно відповідати міткам шаблону пода. Детальніше: <a href="https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors">https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors</a></td>
    </tr>
    <tr>
      <td><code>template</code><br/><em><a href="{{< ref "../core/pod-template-v1#PodTemplateSpec" >}}">PodTemplateSpec</a></em></td>
      <td>Template це обʼєкт, який описує под, який буде створений, якщо виявиться недостатня кількість реплік. Детальніше: <a href="/uk/docs/concepts/workloads/controllers/replicaset/#pod-template">https://kubernetes.io/docs/concepts/workloads/controllers/replicaset/#pod-template</a></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Представляє останні доступні спостереження за поточним станом ReplicaSet.</td>
    </tr>
    <tr>
      <td><code>fullyLabeledReplicas</code><br/><em>integer</em></td>
      <td>Кількість подів, які не перебувають в стані завершення роботи і мають мітки, що відповідають міткам шаблону пода цього ReplicaSet.</td>
    </tr>
    <tr>
      <td><code>observedGeneration</code><br/><em>integer</em></td>
      <td>ObservedGeneration відображає покоління найбільш недавно спостережуваного ReplicaSet.</td>
    </tr>
    <tr>
      <td><code>readyReplicas</code><br/><em>integer</em></td>
      <td>Кількість подів, які не перебувають в стані завершення роботи і мають стан Ready, на які націлено цей ReplicaSet.</td>
    </tr>
    <tr>
      <td><code>replicas</code>&nbsp;<strong>*</strong><br/><em>integer</em></td>
      <td>Replicas це найбільш недавно спостережувана кількість подів, які не перебувають в стані завершення роботи. Детальніше: <a href="https://kubernetes.io/docs/concepts/workloads/controllers/replicaset">https://kubernetes.io/docs/concepts/workloads/controllers/replicaset</a></td>
    </tr>
    <tr>
      <td><code>terminatingReplicas</code><br/><em>integer</em></td>
      <td>Кількість подів, які перебувають у стані завершення роботи для цього ReplicaSet. Поди, що завершуються, мають ненульовий .metadata.deletionTimestamp і ще не досягли стану Failed або Succeeded .status.phase. Це бета-поле і вимагає увімкнення функції DeploymentReplicaSetTerminatingReplicas (стандартно увімкнено).</td>
    </tr>
  </tbody>
</table>
...
ReplicaSetList це колекція ReplicaSet.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Список ReplicaSet. Детальніше: <a href="/uk/docs/concepts/workloads/controllers/replicaset">https://kubernetes.io/docs/concepts/workloads/controllers/replicaset</a></td>
    </tr>
    <tr>
      <td><code>kind</code><br/><em>string</em></td>
      <td>Kind визначає тип REST-ресурсу, який представляє цей обʼєкт. Сервери можуть визначати це з точки доступу, до якої клієнт надсилає запити. Не може бути оновлено. У CamelCase. Детальніше: <a href="https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds">https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</a></td>
...
ReplicaSetCondition описує стан ReplicaSet в певний момент часу.
