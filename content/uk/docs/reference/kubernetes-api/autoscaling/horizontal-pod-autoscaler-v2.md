...
Допуск застосовується до значень метрик і запобігає занадто швидкому масштабуванню при невеликих коливаннях метрик.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>observedGeneration</code><br/><em>integer</em></td>
      <td>observedGeneration представляє .metadata.generation, на основі якого було встановлено стан. Наприклад, якщо .metadata.generation наразі дорівнює 12, а .status.conditions[x].observedGeneration дорівнює 9, то стан є застарілим відносно поточного стану екземпляра.</td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>type</code>&nbsp;<strong>*</strong><br/><em>string</em></td>
      <td>type є типом джерела метрики. Воно повинно бути одним із "ContainerResource", "External", "Object", "Pods" або "Resource", кожне з яких відповідає відповідному полю в обʼєкті.</td>
    </tr>
  </tbody>
</table>
