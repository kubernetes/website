...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>preemptionPolicy є Політикою випередження подів з нижчим пріоритетом. Одне з значень: Never, PreemptLowerPriority. Стандартно використовується PreemptLowerPriority, якщо не вказано.
      <br/><br/>
