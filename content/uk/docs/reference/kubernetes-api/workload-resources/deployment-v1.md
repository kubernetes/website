...
- **strategy** (DeploymentStrategy)
  ...
  *DeploymentStrategy описує, як замінити наявні Podʼи новими.*
  ...
  - **strategy.type** (string)
    ...
    - `"Recreate"` Вбиває всі наявні Podʼи перед створенням нових.
    - `"RollingUpdate"` Замінює старі ReplicaSet новими за допомогою поступового оновлення, тобто поступово зменшує масштаб старих ReplicaSet і збільшує масштаб нових.
