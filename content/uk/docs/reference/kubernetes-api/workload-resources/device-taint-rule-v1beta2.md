...
- **spec** (<a href="{{< ref "../workload-resources/device-taint-rule-v1beta2#DeviceTaintRuleSpec" >}}">DeviceTaintRuleSpec</a>), обовʼязково
...
- **items** ([]<a href="{{< ref "../workload-resources/device-taint-rule-v1beta2#DeviceTaintRule" >}}">DeviceTaintRule</a>), обовʼязково
...
- **body**: <a href="{{< ref "../workload-resources/device-taint-rule-v1beta2#DeviceTaintRule" >}}">DeviceTaintRule</a>, обовʼязково
