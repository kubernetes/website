...
- **topologySpreadConstraints** ([]TopologySpreadConstraint)
  ...
  *TopologySpreadConstraint визначає, як розподіляти відповідні Podʼи серед заданої топології.*
  ...
  - **topologySpreadConstraints.nodeAffinityPolicy** (string)
    ...
    Якщо це значення дорівнює null, поведінка еквівалентна полю Honor.
...
- **resources** (ResourceRequirements)
  ...
  Resources - це загальна кількість ресурсів процесора і памʼяті, необхідних для всіх контейнерів у podʼі. Підтримується вказівка запитів і лімітів тільки для імен ресурсів "cpu" і "memory". Вимоги до ресурсів не підтримуються.
  ...
  *ResourceRequirements описує вимоги до обчислювальних ресурсів.*
  ...
  - **resources.claims** ([]ResourceClaim)
    ...
    *Map: унікальні значення ключа name будуть збережені під час злиття*
    ...
    Це альфа-поле і вимагає увімкнення функціональної можливості DynamicResourceAllocation.
...
- **envFrom** ([]EnvFromSource)
  ...
  *EnvFromSource представляє джерело набору ConfigMaps або Secrets*
  ...
  - **envFrom.prefix** (string)
    ...
    Необовʼязковий текст для вставлення перед кожною змінною. Повинен бути C_IDENTIFIER.
...
- **conditions** ([]PodCondition)
  ...
  *PodCondition містить деталі поточного стану цього Podʼа.*
  ...
  - **conditions.observedGeneration** (int64)
    ...
    Якщо встановлено, це поле представляє .metadata.generation, на основі якого було встановлено стан podʼа. Це альфа-поле. Увімкніть PodObservedGenerationTracking, щоб мати змогу використовувати це поле.
...
- **observedGeneration** (int64)
  ...
  Якщо встановлено, це поле представляє .metadata.generation, на основі якого було визначено статус pod. Це альфа-поле. Увімкніть PodObservedGenerationTracking, щоб мати змогу використовувати це поле.
