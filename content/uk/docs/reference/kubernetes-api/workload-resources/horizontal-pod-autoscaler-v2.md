...
- **behavior** (HorizontalPodAutoscalerBehavior)
  ...
  *HorizontalPodAutoscalerBehavior налаштовує поведінку масштабування цільового ресурсу як в напрямку збільшення, так і в напрямку зменшення (поля scaleUp та scaleDown відповідно).*
  ...
  - **behavior.scaleDown** (HPAScalingRules)
    ...
    *Допуск застосовується до значень метрики і запобігає надто швидкому масштабуванню при невеликих змінах метрики. (Зауважте, що встановлення допуску вимагає увімкнення функціональної можливості альфа-версії HPAConfigurableTolerance).*
    ...
    - **behavior.scaleDown.tolerance** (<a href="{{< ref "../common-definitions/quantity#Quantity" >}}">Quantity</a>)
      ...
      Це альфа-поле і вимагає ввімкнення функціональної можливості HPAConfigurableTolerance.
