...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Останнє покоління, спостережене під час оновлення цього статусу PDB. DisruptionsAllowed та інша інформація про статус дійсні лише якщо observedGeneration дорівнює поколінню об'єкта PDB.</td>
    </tr>
  </tbody>
</table>
