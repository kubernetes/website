...
- **hostPath** (HostPathVolumeSource)
  ...
  *Представляє шлях хосту зіставлений з Pod. Томи hostPath не підтримують управління власністю або перевизначення міток SELinux.*
  ...
  - **hostPath.type** (string)
    ...
    - `"DirectoryOrCreate"` Якщо нічого не існує за вказаним шляхом, буде створена порожня тека з правами доступу 0755, з тією ж групою та власником, що й у Kubelet.
    - `"File"` Файл повинен існувати за вказаним шляхом
    - `"FileOrCreate"` Якщо нічого не існує за вказаним шляхом, буде створено порожній файл з правами доступу 0644, з тією ж групою та власником, що й у Kubelet.
...
- **image** (ImageVolumeSource)
  ...
  *ImageVolumeSource представляє ресурс тома image.*
  ...
  - **image.pullPolicy** (string)
    ...
    Можливі значення enum:
    - `"Always"` означає, що kubelet завжди намагається завантажити останній образ. Контейнер завершиться невдачею, якщо завантаження не вдасться.
    - `"IfNotPresent"` означає, що kubelet завантажує образ, якщо він відсутній на диску. Контейнер завершиться невдачею, якщо образ відсутній і завантаження не вдасться.
    - `"Never"` означає, що kubelet ніколи не завантажує образ, а використовує лише локальний образ. Контейнер завершиться невдачею, якщо образ відсутній.
...
- **portworxVolume** (PortworxVolumeSource)
  ...
  portworxVolume представляє том Portworx, приєднаний та змонтований на хост-машині kubelets. Застаріло: PortworxVolume застарілв. Всі операції для внутрішнього типу portworxVolume перенаправляються на CSI-драйвер pxd.portworx.com.
