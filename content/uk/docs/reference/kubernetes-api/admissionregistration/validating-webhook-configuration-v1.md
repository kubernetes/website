...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>name є імʼям вебхуку допуску. Імʼя повинно бути повністю кваліфікованим, наприклад, imagepolicy.kubernetes.io, де "imagepolicy" є імʼям вебхуку, а kubernetes.io є імʼям організації. Обовʼязково.</td>
    </tr>
    <tr>
