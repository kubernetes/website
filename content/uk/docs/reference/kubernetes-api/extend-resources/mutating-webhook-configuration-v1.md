...
- **webhooks** ([]MutatingWebhook)
  ...
  *MutatingWebhook описує вебхук допуску та ресурси й операції, до яких він застосовується.*
    ...
    - **webhooks.clientConfig.service** (ServiceReference)
      ...
      *ServiceReference містить посилання на Service.legacy.k8s.io.*
      ...
      - **webhooks.clientConfig.service.port** (int32)
        ...
        port — це порт на сервісі, який є хостом вебхуку. Типово 443 для зворотної сумісності. `port` має бути дійсним номером порту (1-65535, включно).
  ...
  - **webhooks.name** (string), обовʼязково
    ...
    name — імʼя вебхуку допуску. Імʼя має бути повністю кваліфікованим, наприклад, `imagepolicy.kubernetes.io`, де "imagepolicy" є назвою вебхука, а kubernetes.io — назвою організації. Обовʼязково.
  ...
  - **webhooks.sideEffects** (string), обовʼязково
    ...
    - `"NoneOnDryRun"` означає, що виклик вебхука може мати побічні ефекти, але якщо запит, що перевіряється, має атрибут dry-run, побічні ефекти будуть придушені.
    - `"Some"` означає, що виклик вебхука може мати побічні ефекти. Якщо запит з атрибутом dry-run викликав би цей вебхук, запит замість цього зазнає невдачі.
    - `"Unknown"` означає, що про побічні ефекти виклику вебхука нічого не відомо. Якщо запит з атрибутом dry-run викликав би цей вебхук, запит замість цього зазнає невдачі.
  ...
  - **webhooks.matchPolicy** (string)
    ...
    - `"Exact"` означає, що запити повинні надсилатися до вебхука лише в тому випадку, якщо вони точно відповідають зазначеному правилу.
  ...
  - **webhooks.reinvocationPolicy** (string)
    ...
    Можливі значення enum:
    - `"IfNeeded"` означає, що мутація може бути викликана щонайменше один додатковий раз у рамках оцінки допуску, якщо обʼєкт, який допускається, змінюється іншими плагінами допуску після початкового виклику мутації.
    - `"Never"` означає, що мутація не повинна викликатися більше одного разу в рамках однієї оцінки допуску.
...
- **metadata** (<a href="{{< ref "../common-definitions/list-meta#ListMeta" >}}">ListMeta</a>)
  ...
  metadata — стандартні метадані списку. Більше інформації: <https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds>
