...
- **webhooks** ([]ValidatingWebhook)
  ...
  *ValidatingWebhook описує вебхук допуску та ресурси й операції, до яких він застосовується.*
  ...
  - **webhooks.name** (string), обовʼязково
    ...
    name — це імʼя вебхука допуску. Імʼя повинно бути повністю кваліфікованим, наприклад, `imagepolicy.kubernetes.io`, де "imagepolicy" — це імʼя вебхука, а kubernetes.io — це імʼя організації. Обовʼязково.
  ...
  - **webhooks.matchPolicy** (string)
    ...
    - `"Exact"` означає, що запити повинні надсилатися до вебхука тільки в тому випадку, якщо вони точно відповідають зазначеному правилу.
