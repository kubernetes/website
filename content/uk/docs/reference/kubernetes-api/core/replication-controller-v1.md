...
description: "ReplicationController представляє конфігурацію контролера реплікації."
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Якщо Labels ReplicationController порожні, вони за звичай будуть такими ж, як у Pod(ів), якими керує контролер реплікації. Стандартні метадані обʼєкта. Детальніше: <a href="https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata">https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata</a></td>
    </tr>
    <tr>
      <td><code>spec</code><br/><em><a href="{{< ref "#ReplicationControllerSpec" >}}">ReplicationControllerSpec</a></em></td>
      <td>Spec визначає специфікацію бажаної поведінки контролера реплікації. Детальніше: <a href="https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status">https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status</a></td>
    </tr>
    <tr>
      <td><code>status</code><br/><em><a href="{{< ref "#ReplicationControllerStatus" >}}">ReplicationControllerStatus</a></em></td>
      <td>Status визначає останній спостережуваний стан контролера реплікації. Ці дані можуть бути застарілими на деякий проміжок часу. Заповнюється системою. Тільки для читання. Детальніше: <a href="https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status">https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status</a></td>
    </tr>
  </tbody>
</table>
...
ReplicationControllerStatus представляє поточний стан контролера реплікації.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Кількість доступних реплік (готових принаймні протягом minReadySeconds) для цього контролера реплікації.</td>
    </tr>
    <tr>
      <td><code>conditions</code><br/><em><a href="{{< ref "#ReplicationControllerCondition" >}}">ReplicationControllerCondition array</a></em><br/><em>patch strategy: злиття за ключем <code>type</code></em></td>
      <td>Представляє останні доступні спостереження за поточним станом контролера реплікації.</td>
    </tr>
    <tr>
      <td><code>fullyLabeledReplicas</code><br/><em>integer</em></td>
      <td>Кількість подів, які мають мітки, що відповідають міткам шаблону пода контролера реплікації.</td>
    </tr>
    <tr>
      <td><code>observedGeneration</code><br/><em>integer</em></td>
      <td>ObservedGeneration відображає покоління найбільш недавно спостережуваного контролера реплікації.</td>
    </tr>
    <tr>
      <td><code>readyReplicas</code><br/><em>integer</em></td>
      <td>Кількість готових реплік для цього контролера реплікації.</td>
    </tr>
    <tr>
      <td><code>replicas</code>&nbsp;<strong>*</strong><br/><em>integer</em></td>
      <td>Replicas є кількістю найбільш недавно спостережуваних реплік. Детальніше: <a href="/uk/docs/concepts/workloads/controllers/replicationcontroller#what-is-a-replicationcontroller">https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller#what-is-a-replicationcontroller</a></td>
    </tr>
  </tbody>
</table>
...
ReplicationControllerList є колекцією контролерів реплікації.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Список контролерів реплікації. Детальніше: <a href="/uk/docs/concepts/workloads/controllers/replicationcontroller">https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller</a></td>
    </tr>
    <tr>
      <td><code>kind</code><br/><em>string</em></td>
      <td>Kind визначає тип REST-ресурсу, який представляє цей обʼєкт. Сервери можуть визначати це з точки доступу, до якої клієнт надсилає запити. Не може бути оновлено. У CamelCase. Детальніше: <a href="https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds">https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</a></td>
...
ReplicationControllerCondition описує стан контролера реплікації в певний момент часу.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Зрозуміле для людини повідомлення, що вказує деталі переходу.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Тип стану контролера реплікації.</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><em>string</em></td>
      <td>Назва ReplicationController</td>
    </tr>
    <tr>
      <td><code>namespace</code></td>
      <td><em>string</em></td>
