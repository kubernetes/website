...
description: "ComponentStatus (та ComponentStatusList) містить інформацію про стан кластера. Застаріло: цей API застарів у v1.19+"
...
ComponentStatus (та ComponentStatusList) містить інформацію про стан кластера. Застаріло: цей API застарів у v1.19+
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Список станів компонента, які спостерігаються</td>
    </tr>
    <tr>
...
Стан усіх станів для компонента у вигляді списку обʼєктів ComponentStatus. Застаріло: цей API застарів у v1.19+
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Список обʼєктів ComponentStatus.</td>
    </tr>
    <tr>
      <td><code>kind</code><br/><em>string</em></td>
      <td>Kind визначає тип REST-ресурсу, який представляє цей обʼєкт. Сервери можуть визначати це з точки доступу, до якої клієнт надсилає запити. Не може бути оновлено. У CamelCase. Детальніше: <a href="https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds">https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</a></td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Код помилки стану для компонента. Наприклад, код помилки перевірки стану.</td>
    </tr>
    <tr>
      <td><code>message</code><br/><em>string</em></td>
      <td>Повідомлення про стан компонента. Наприклад, інформація про перевірку стану.</td>
    </tr>
    <tr>
      <td><code>status</code>&nbsp;<strong>*</strong><br/><em>string</em></td>
      <td>Стан стану для компонента. Дійсні значення для "Healthy": "True", "False" або "Unknown".</td>
    </tr>
    <tr>
      <td><code>type</code>&nbsp;<strong>*</strong><br/><em>string</em></td>
      <td>Тип стану для компонента. Дійсне значення: "Healthy"</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><em>string</em></td>
      <td>Назва компонента ComponentStatus</td>
    </tr>
  </tbody>
</table>
