...
description: "PodTemplate описує шаблон для створення копій попередньо визначеного пода."
title: "PodTemplate"
weight: 110
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Template визначає поди, які будуть створені з цього шаблону пода. Детальніше: <a href="https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status">https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status</a></td>
    </tr>
  </tbody>
</table>
...
PodTemplateSpec описує дані, які повинен мати под при створенні з шаблону.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Specification описує бажану поведінку пода. Детальніше: <a href="https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status">https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status</a></td>
    </tr>
  </tbody>
</table>
...
PodTemplateList описує список PodTemplates.
