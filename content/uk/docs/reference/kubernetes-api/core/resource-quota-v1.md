...
description: "ResourceQuota встановлює агреговані обмеження квот, що застосовуються на рівні простору імен"
title: "ResourceQuota"
weight: 130
...
ResourceQuota встановлює агреговані обмеження квот, що застосовуються на рівні простору імен
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Spec визначає бажану квоту. Детальніше: <a href="https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status">https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status</a></td>
    </tr>
    <tr>
      <td><code>status</code><br/><em><a href="{{< ref "#ResourceQuotaStatus" >}}">ResourceQuotaStatus</a></em></td>
      <td>Status визначає фактичну застосовану квоту та її поточне використання. Детальніше: <a href="https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status">https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status</a></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>hard визначає набір бажаних жорстких обмежень для кожного іменованого ресурсу. Детальніше: <a href="/uk/docs/concepts/policy/resource-quotas/">https://kubernetes.io/docs/concepts/policy/resource-quotas/</a></td>
    </tr>
    <tr>
      <td><code>scopeSelector</code><br/><em><a href="{{< ref "#ScopeSelector" >}}">ScopeSelector</a></em></td>
      <td>scopeSelector також є колекцією фільтрів, подібних до scopes, які повинні відповідати кожному обʼєкту, відстежуваному квотою, але виражені за допомогою ScopeSelectorOperator у поєднанні з можливими значеннями. Щоб ресурс відповідав, обидва scopes І scopeSelector (якщо вказано в spec) повинні відповідати.</td>
    </tr>
    <tr>
      <td><code>scopes</code><br/><em>string array</em></td>
      <td>Колекція фільтрів, які повинні відповідати кожному обʼєкту, відстежуваному квотою. Якщо не вказано, квота відповідає всім обʼєктам.</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td><code>hard</code><br/><em>object</em></td>
      <td>Hard визначає набір фактично застосованих жорстких обмежень для кожного іменованого ресурсу. Детальніше: <a href="/uk/docs/concepts/policy/resource-quotas/">https://kubernetes.io/docs/concepts/policy/resource-quotas/</a></td>
    </tr>
    <tr>
      <td><code>used</code><br/><em>object</em></td>
      <td>Used визначає поточне спостережуване загальне використання ресурсу в просторі імен.</td>
    </tr>
  </tbody>
</table>
...
ResourceQuotaList є списком елементів ResourceQuota.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Items є списком обʼєктів ResourceQuota. Детальніше: <a href="/uk/docs/concepts/policy/resource-quotas/">https://kubernetes.io/docs/concepts/policy/resource-quotas/</a></td>
    </tr>
    <tr>
      <td><code>kind</code><br/><em>string</em></td>
      <td>Kind визначає тип REST-ресурсу, який представляє цей обʼєкт. Сервери можуть визначати це з точки доступу, до якої клієнт надсилає запити. Не може бути оновлено. У CamelCase. Детальніше: <a href="https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds">https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</a></td>
...
Селектор області дії представляє логічну операцію AND між селекторами, представленими вимогами селектора ресурсів з областю дії.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Список вимог селектора області дії за областю ресурсів.</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Представляє відношення області дії до набору значень. Дійсні оператори: In, NotIn, Exists, DoesNotExist.
      <br/><br/>
    ...
    <tr>
      ...
      <td>Імʼя області дії, до якої застосовується селектор.
      <br/><br/>
      Можливі значення enum:
      <ul>
        <li><code>"BestEffort"</code> Всі обʼєкти pod, які мають якість обслуговування best effort</li>
        <li><code>"CrossNamespacePodAffinity"</code> Всі обʼєкти pod, які мають згадку про крос-просторову (анти)спорідненість подів.</li>
        <li><code>"NotBestEffort"</code> Всі обʼєкти pod, які не мають якості обслуговування best effort</li>
        <li><code>"NotTerminating"</code> Всі обʼєкти pod, де spec.activeDeadlineSeconds дорівнює nil</li>
        <li><code>"PriorityClass"</code> Всі обʼєкти pod, які мають згадку про клас пріоритету</li>
        <li><code>"Terminating"</code> Всі обʼєкти pod, де spec.activeDeadlineSeconds >=0</li>
        <li><code>"VolumeAttributesClass"</code> Всі обʼєкти pvc, які мають згадку про клас атрибутів томів</li>
      </ul>
    </td>
    </tr>
    <tr>
      <td><code>values</code><br/><em>string array</em></td>
      <td>Масив рядків. Якщо оператор In або NotIn, масив values повинен бути непорожнім. Якщо оператор Exists або DoesNotExist, масив values повинен бути порожнім. Цей масив замінюється під час стратегічного злиття патчу.</td>
    </tr>
  </tbody>
</table>
