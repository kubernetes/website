...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Яку дію було виконано/не вдалося виконати щодо обʼєкта Regarding.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Обʼєкт, до якого відноситься ця подія.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Час, коли остання подія була зафіксована.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Це має бути короткий рядок, придатний для машинного зчитування, який пояснює причину переходу обʼєкта до поточного стану.</td>
    </tr>
    <tr>
      <td><code>related</code><br/><em><a href="{{< ref "../definitions/object-reference-v1#ObjectReference" >}}">ObjectReference</a></em></td>
      <td>Додатковий обʼєкт для більш складних дій.</td>
    </tr>
    <tr>
      <td><code>reportingComponent</code><br/><em>string</em></td>
      <td>Назва контролера, який створив цю подію, наприклад `kubernetes.io/kubelet`.</td>
    </tr>
    <tr>
      <td><code>reportingInstance</code><br/><em>string</em></td>
      <td>ID екземпляра контролера, наприклад `kubelet-xyzf`.</td>
    </tr>
    <tr>
      <td><code>series</code><br/><em><a href="{{< ref "#EventSeries" >}}">EventSeries</a></em></td>
      <td>Дані про серію подій, яку представляє ця подія, або nil, якщо це одиночна подія.</td>
    </tr>
    <tr>
      <td><code>source</code><br/><em><a href="{{< ref "../definitions/event-source-v1#EventSource" >}}">EventSource</a></em></td>
      <td>Компонент, який повідомляє про цю подію. Має бути коротким рядком, придатним для машинного зчитування.</td>
    </tr>
    <tr>
      <td><code>type</code><br/><em>string</em></td>
      <td>Тип цієї події (Normal, Warning), нові типи можуть бути додані в майбутньому</td>
    </tr>
  </tbody>
</table>
...
EventSeries містить інформацію про серії подій, тобто про те, що відбувалося або відбувається безперервно протягом певного часу.
...
<table>
  ...
  <tbody>
    <tr>
      <td><code>count</code><br/><em>integer</em></td>
      <td>Кількість випадків у цій серії до часу останнього сигналу серця</td>
    </tr>
    <tr>
      <td><code>lastObservedTime</code><br/><em><a href="{{< ref "../definitions/micro-time-v1-meta#MicroTime" >}}">MicroTime</a></em></td>
      <td>Час останнього зафіксованого випадку</td>
    </tr>
  </tbody>
</table>
