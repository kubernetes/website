...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>PodPreemptionPolicy контролює поведінку передчасного завершення на рівні вузла для подів на цьому вузлі. Це альфа-поле і вимагає увімкнення функціональної можливості InPlacePodVerticalScalingSchedulerPreemption.</td>
    </tr>
    <tr>
...
NodePodPreemptionPolicy визначає політики на рівні вузла, що регулюють витіснення для подів на цьому вузлі.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>DisableResizePreemption перераховує власників (наприклад, автомасштабувальники, оператори, адміністратори), які запросили відключення витіснення планувальника та Kubelet для зміни розміру подів на цьому вузлі. Якщо цей список не порожній, витіснення, викликане зміною розміру, відключено на цьому вузлі. Це альфа-поле і вимагає увімкнення функціональної можливості InPlacePodVerticalScalingSchedulerPreemption.</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Вказує, чи вузол працює в просторі імен користувача.</td>
    </tr>
    <tr>
