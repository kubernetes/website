...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      (Бета) Використання цього поля вимагає увімкнення функціональної можливості AnyVolumeDataSource. (Альфа) Використання поля namespace в dataSourceRef вимагає увімкнення функціональної можливості CrossNamespaceVolumeDataSource.</td>
    </tr>
    <tr>
