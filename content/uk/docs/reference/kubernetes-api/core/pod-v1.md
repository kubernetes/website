  ...
  <tbody>
    ...
    <tr>
      ...
      <ul>
        ...
        <li><code>"Pending"</code> означає, що под був прийнятий системою, але один або кілька контейнерів ще не запущені. Це включає час до прив'язки до вузла, а також час, витрачений на завантаження образів на хост.</li>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Вибирає один ClusterTrustBundle за імʼям об'єкта. Взаємовиключно з signerName та labelSelector.</td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>envFrom</code><br/><em><a href="{{< ref "#EnvFromSource" >}}">EnvFromSource array</a></em></td>
      <td>Список джерел для заповнення змінних середовища в контейнері. Ключі, визначені в джерелі, можуть складатися з будь-яких друкованих ASCII-символів, крім '='. Якщо ключ існує в кількох джерелах, значення, пов'язане з останнім джерелом, матиме пріоритет. Значення, визначені за допомогою Env з дубльованим ключем, матимуть пріоритет. Не можна оновлювати.</td>
    </tr>
    <tr>
      <td><code>image</code><br/><em>string</em></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Прапорець <code>sslEnabled</code> вмикає/вимикає SSL-з'єднання з Gateway, зазвичай — false</td>
    </tr>
    <tr>
  ...
  <tbody>
    ...
    <tr>
      ...
      <ol type="a">
        ...
        <li>драйвер сховища підтримує динамічне створення томів через PersistentVolumeClaim (див. EphemeralVolumeSource для отримання додаткової інформації про зв'язок між цим типом тому та PersistentVolumeClaim)</li>
      </ol>
