...
- **spec** (MutatingAdmissionPolicySpec)
  ...
  spec — специфікація бажаної поведінки MutatingAdmissionPolicy.

  <a name="MutatingAdmissionPolicySpec"></a>
  *MutatingAdmissionPolicySpec — визначає специфікацію бажаної поведінки політики допуску.*
  ...
  - **spec.failurePolicy** (string)
    ...
    - `"Fail"` означає, що помилка виклику вебхука призводить до відмови допуску.
  ...
  - **spec.matchConditions** ([]MatchCondition)
    ...
    *MatchCondition представляє умову, яка повинна бути виконана для надсилання запиту до вебхуку.*
  ...
  - **spec.matchConstraints** (MatchResources)
    ...
    *MatchResources вирішує, чи застосовувати політику контролю допуску до обʼєкта на основі того, чи відповідає він критеріям відповідності. Правила виключення мають пріоритет над правилами включення (якщо ресурс відповідає обом критеріям, він виключається)*
    ...
    - **spec.matchConstraints.matchPolicy** (string)
      ...
      Можливі значення enum:
      - `"Equivalent"` означає, що запити повинні бути надіслані до вебхука, якщо вони змінюють ресурс, перелічений у правилах, через іншу групу або версію API.
      - `"Exact"` означає, що запити повинні бути надіслані до вебхука лише у тому випадку, якщо вони точно відповідають вказаному правилу.
...
- **spec** (MutatingAdmissionPolicyBindingSpec)
  ...
  spec — специфікація бажаної поведінки привʼязки MutatingAdmissionPolicyBinding.
  ...
  - **spec.matchResources** (MatchResources)
    ...
    *MatchResources вирішує, чи застосовувати політику контролю доступу до обʼєкта на основі того, чи відповідає він критеріям відповідності. Правила виключення мають пріоритет над правилами включення (якщо ресурс відповідає обом критеріям, він виключається)*
    ...
    - **spec.matchResources.matchPolicy** (string)
      ...
      Можливі значення enum:
      - `"Equivalent"` означає, що запити повинні надсилатися до веб-хука, якщо вони змінюють ресурс, перелічений у правилах, через іншу групу або версію API.
      - `"Exact"` означає, що запити повинні надсилатися до веб-хука лише у тому випадку, якщо вони точно відповідають вказаному правилу.
    ...
    - **spec.matchResources.resourceRules** ([]NamedRuleWithOperations)
      ...
      *NamedRuleWithOperations — це кортеж операцій та ресурсів з іменами ресурсів.*
      ...
      - **spec.matchResources.resourceRules.scope** (string)
        ...
        Можливі значення enum:
        - `"*"` означає, що всі області включені.
        - `"Cluster"` означає, що область обмежена об'єктами з областю дії кластера. Об'єкти простору імен є кластерними.
        - `"Namespaced"` означає, що область обмежена об'єктами з простору імен.
...
- **items** ([]<a href="{{< ref "../policy-resources/mutating-admission-policy-binding-v1#MutatingAdmissionPolicy" >}}">MutatingAdmissionPolicy</a>), обовʼязково

  Перелік MutatingAdmissionPolicy.
...
200 (<a href="{{< ref "../policy-resources/mutating-admission-policy-binding-v1#MutatingAdmissionPolicy" >}}">MutatingAdmissionPolicy</a>): OK
...
200 (<a href="{{< ref "../policy-resources/mutating-admission-policy-v1#MutatingAdmissionPolicyList" >}}">MutatingAdmissionPolicyList</a>): OK
...
- **body**: <a href="{{< ref "../policy-resources/mutating-admission-policy-binding-v1#MutatingAdmissionPolicy" >}}">MutatingAdmissionPolicy</a>, обовʼязково
...
201 (<a href="{{< ref "../policy-resources/mutating-admission-policy-binding-v1#MutatingAdmissionPolicy" >}}">MutatingAdmissionPolicy</a>): Created

202 (<a href="{{< ref "../policy-resources/mutating-admission-policy-binding-v1#MutatingAdmissionPolicy" >}}">MutatingAdmissionPolicy</a>): Accepted
