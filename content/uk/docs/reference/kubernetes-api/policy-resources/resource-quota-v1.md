  ...
  - **scopeSelector.matchExpressions** ([]ScopedResourceSelectorRequirement)
    ...
    *Вимога до селектора ресурсу з областю застосування — це селектор, який містить значення, імʼя області застосування та оператор, який повʼязує імʼя області застосування зі значеннями.*
    ...
    - **scopeSelector.matchExpressions.scopeName** (string), обовʼязково
      ...
      Можливі значення enum:
      - `"BestEffort"` Вибирає всі обʼєкти Pod, які мають якість обслуговування best effort
      - `"CrossNamespacePodAffinity"` Вибирає всі обʼєкти Pod, які мають згадану крос-просторову спорідненість Pod (антиспорідненість).
      - `"NotBestEffort"` Вибирає всі обʼєкти Pod, які не мають якості обслуговування best effort
      - `"NotTerminating"` Вибирає всі обʼєкти Pod, де spec.activeDeadlineSeconds є nil
      - `"PriorityClass"` Вибирає всі обʼєкти Pod, які мають зазначений клас пріоритету
      - `"Terminating"` Вибирає всі обʼєкти Pod, де spec.activeDeadlineSeconds >=0
      - `"VolumeAttributesClass"` Вибирає всі обʼєкти PVC, які мають зазначений клас атрибутів томів.
