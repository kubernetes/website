...
- **spec** (<a href="{{< ref "../authentication-resources/pod-certificate-request-v1alpha1#PodCertificateRequestSpec" >}}">PodCertificateRequestSpec</a>), обовʼязково
...
- **items** ([]<a href="{{< ref "../authentication-resources/pod-certificate-request-v1alpha1#PodCertificateRequest" >}}">PodCertificateRequest</a>), обовʼязково
...
- **body**: <a href="{{< ref "../authentication-resources/pod-certificate-request-v1alpha1#PodCertificateRequest" >}}">PodCertificateRequest</a>, обовʼязково
