...
- **proofOfPossession** ([]byte)
  ...
  Якщо ключ є ECDSA, підпис здійснюється відповідно до [SEC 1, Version 2.0](https://www.secg.org/sec1-v2.pdf) (як реалізовано у функції golang crypto/ecdsa.SignASN1)

  Якщо ключ є ED25519, підпис здійснюється відповідно до [ED25519 Specification](https://ed25519.cr.yp.to/) (як реалізовано у бібліотеці golang crypto/ed25519.Sign).
