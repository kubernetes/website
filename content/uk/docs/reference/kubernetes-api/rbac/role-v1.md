...
Role — це логічне групування PolicyRules у просторі імен, на яке можна посилатися як на одиницю за допомогою RoleBinding.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>rules містить усі PolicyRules для цієї Role</td>
    </tr>
  </tbody>
</table>
