...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>kind — тип обʼєкта, на який посилається. Значення, визначені цією групою API, це "User", "Group" і "ServiceAccount". Якщо авторизатор не розпізнає значення типу, авторизатор повинен повідомити про помилку.</td>
    </tr>
    <tr>
      <td><code>name</code>&nbsp;<strong>*</strong><br/><em>string</em></td>
      <td>name — імʼя обʼєкта, на який посилається.</td>
    </tr>
    <tr>
      <td><code>namespace</code><br/><em>string</em></td>
      <td>namespace — простір імен обʼєкта, на який посилається. Якщо тип обʼєкта не є просторовим, наприклад "User" або "Group", і це значення не порожнє, авторизатор повинен повідомити про помилку.</td>
    </tr>
  </tbody>
</table>
