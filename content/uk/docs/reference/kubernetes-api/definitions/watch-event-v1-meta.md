...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Object — це:
        <ul><li>Якщо Type додано або змінено: новий стан об'єкта.</li><li>Якщо Type видалено: стан обʼєкта безпосередньо перед видаленням.</li><li>Якщо Type помилка: *Status рекомендовано; інші типи можуть мати сенс залежно від контексту.</li></ul></td>
    </tr>
    <tr>
