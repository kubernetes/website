...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>TolerationSeconds представляє період часу, протягом якого толерація (яка повинна мати ефект NoExecute, інакше це поле ігнорується) толерує taint. За замовчуванням не встановлено, що означає толерувати taint назавжди (не виселяти). Нульові та відʼємні значення будуть розглядатися як 0 (виселити негайно) системою.</td>
    </tr>
    <tr>
