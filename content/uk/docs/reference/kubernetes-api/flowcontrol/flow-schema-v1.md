...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>lastTransitionTime є останнім часом, коли стан змінився з одного на інший.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>reason є унікальною, однословною, CamelCase причиною останньої зміни стану.</td>
    </tr>
    <tr>
      <td><code>status</code><br/><em>string</em></td>
      <td>status є статусом стану. Може бути True, False, Unknown. Обовʼязково.</td>
    </tr>
    <tr>
      <td><code>type</code><br/><em>string</em></td>
      <td>type є типом стану. Обовʼязково.</td>
    </tr>
  </tbody>
</table>
