...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Детальніше: <a href="https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata">https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata</a></td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>tolerations додаються (без дублікатів) до подів, що виконуються з цим RuntimeClass під час допуску, фактично об’єднуючи набір вузлів, які допускаються як для пода, так і для RuntimeClass.</td>
    </tr>
  </tbody>
</table>
