    ...
    <tr>
      ...
      <ol>
        ...
        <ul>
          ...
          <li>b. GPU-пристрій, який потребує додаткової памʼяті вузла на кожне виділення GPU, матиме {ResourceName: "memory", allocationMultiplier: "2Gi"}. Кожен виділений екземпляр цього типу GPU-пристрою враховуватиме 2Gi пам'яті.</li>
        </ul>
