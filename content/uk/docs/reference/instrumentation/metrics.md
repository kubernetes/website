...
<div class="metrics">
    <div class="metric" data-stability="stable">
        ...
        <ul>
            ...
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kube-apiserver (/metrics)</li>
                </ul>
            </li>
        </ul>
    </div>
    ...
    <div class="metric" data-stability="stable">
        ...
        <ul>
            ...
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kubelet (/metrics/resource)</li>
                </ul>
            </li>
        </ul>
    </div>
    ...
    <div class="metric" data-stability="stable">
        ...
        <ul>
            ...
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kube-controller-manager (/metrics)</li>
                </ul>
            </li>
        </ul>
    </div>
    ...
    <div class="metric" data-stability="stable">
        ...
        <ul>
            ...
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>cloud-controller-manager (/metrics/slis)</li>
                    <li>kube-apiserver (/metrics/slis)</li>
                    <li>kube-controller-manager (/metrics/slis)</li>
                    <li>kube-proxy (/metrics/slis)</li>
                    <li>kube-scheduler (/metrics/slis)</li>
                    <li>kubelet (/metrics/slis)</li>
                </ul>
            </li>
        </ul>
    </div>
    ...
    <div class="metric" data-stability="stable">
        ...
        <div class="metric_help">Кількість відкладених Podʼів за типом черги. 'active' означає кількість Podʼів в activeQ; 'backoff' означає кількість Podʼів в backoffQ; 'unschedulable' означає кількість Podʼів в unschedulableEntities, які планувальник намагався запланувати, але не зміг; 'gated' означає кількість незапланованих Podʼів, які планувальник ніколи не намагався запланувати, тому що вони є gated; 'incomplete' означає кількість Podʼів в incompletePodGroupPods; 'pending' означає кількість Podʼів в pendingPodGroupPods.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">STABLE</span></li>
            <li data-type="gauge"><label class="metric_detail">Тип:</label> <span class="metric_type">Gauge</span></li>
    ...
    <div class="metric" data-stability="stable">
        ...
        <div class="metric_help">Загальна кількість спроб витіснення в кластері до цього часу</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">STABLE</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
    ...
    <div class="metric" data-stability="stable">
        ...
        <div class="metric_help">Кількість обраних жертв витіснення для витіснення, ініційованого окремим Podʼом</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">STABLE</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
...
<div class="metrics">
    ...
    <div class="metric" data-stability="beta">
        ...
        <div class="metric_help">Час оцінювання CEL у секундах.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">BETA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
    ...
    <div class="metric" data-stability="beta">
        ...
        <div class="metric_help">Кількість отриманих подій etcd з розбивкою за типами (kind).</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">BETA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
    ...
    <div class="metric" data-stability="beta">
        ...
        <div class="metric_help">Розподіл часу відгуку в секундах для запитів зі списку спостереження з розбивкою за групами, версіями, ресурсами та областями дії.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">BETA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
    ...
    <div class="metric" data-stability="beta">
        ...
        <ul>
            ...
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>cloud-controller-manager (/metrics)</li>
                    <li>kube-apiserver (/metrics)</li>
                    <li>kube-controller-manager (/metrics)</li>
                    <li>kube-proxy (/metrics)</li>
                    <li>kube-scheduler (/metrics)</li>
    ...
    <div class="metric" data-stability="beta">
        ...
        <div class="metric_help">Бажана кількість точок доступу</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">BETA</span></li>
            <li data-type="gauge"><label class="metric_detail">Тип:</label> <span class="metric_type">Gauge</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
    ...
    <div class="metric" data-stability="beta">
        ...
        <div class="metric_help">Метрика з постійним значенням '1', що містить такі позначки: основна версія, другорядна версія, версія Git, коміт Git, стан дерева Git, дата збірки, версія Go, компілятор, на якому було зібрано Kubernetes, та платформа, на якій він працює.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">BETA</span></li>
            <li data-type="gauge"><label class="metric_detail">Тип:</label> <span class="metric_type">Gauge</span></li>
    ...
    <div class="metric" data-stability="beta">
        ...
        <div class="metric_help">Показує, де в даний момент працюють екземпляри контролера</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">BETA</span></li>
            <li data-type="gauge"><label class="metric_detail">Тип:</label> <span class="metric_type">Gauge</span></li>
    ...
    <div class="metric" data-stability="beta">
        ...
        <div class="metric_help">Кількість запущених goroutines, розділених за роботою, яку вони виконують, наприклад, звʼязуванням.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">BETA</span></li>
            <li data-type="gauge"><label class="metric_detail">Тип:</label> <span class="metric_type">Gauge</span></li>
    ...
    <div class="metric" data-stability="beta">
        ...
        <div class="metric_help">Сумарна кількість використаних токенів старих службових облікових записів</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">BETA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
    ...
    <div class="metric" data-stability="beta">
        ...
        <div class="metric_help">Сумарна кількість використаних токенів службових облікових записів з простроченим терміном придатності</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">BETA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
    ...
    <div class="metric" data-stability="beta">
        ...
        <div class="metric_help">Сумарна кількість використаних дійсних токенів проєцьованих службових облікових записів</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">BETA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
    ...
    <div class="metric_name">workqueue_adds_total</div>
        <div class="metric_help">Загальна кількість доданих елементів, оброблених робочою чергою</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">BETA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
    ...
    <div class="metric" data-stability="beta">
        ...
        <div class="metric_help">Скільки секунд працює процесор із найтривалішим часом роботи для черги завдань?</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">BETA</span></li>
            <li data-type="gauge"><label class="metric_detail">Тип:</label> <span class="metric_type">Gauge</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">name</span></li>
    ...
    <div class="metric" data-stability="beta">
        ...
        <div class="metric_help">Скільки секунд елемент перебуває в черзі завдань перед тим, як його буде запрошено.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">BETA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">name</span></li>
    ...
    <div class="metric" data-stability="beta">
        ...
        <div class="metric_help">Загальна кількість повторних спроб, оброблених чергою завдань</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">BETA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">name</span></li>
    ...
    <div class="metric" data-stability="beta">
        ...
        <div class="metric_help">Скільки секунд роботи виконується і ще не було зафіксовано за допомогою work_duration. Великі значення вказують на завислі потоки. Можна визначити кількість завислих потоків, спостерігаючи за швидкістю збільшення цього показника.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">BETA</span></li>
            <li data-type="gauge"><label class="metric_detail">Тип:</label> <span class="metric_type">Gauge</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">name</span></li>
    ...
    <div class="metric" data-stability="beta">
        ...
        <div class="metric_help">Скільки секунд займає обробка елемента з черги завдань.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">BETA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">name</span></li>
...
<div class="metrics">
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість обʼєктів, зчитаних із кешу спостереження під час обслуговування запиту LIST</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            ...
            <li class="metric_deprecated_version"><label class="metric_detail">Застаріло у версіях:</label><span>1.37.0</span></li>
        </ul>
    </div>
    <div class="metric" data-stability="alpha">
        <div class="metric_name">apiserver_cache_list_returned_objects_total</div>
        <div class="metric_help">Кількість обʼєктів, повернутих за запитом LIST із кешу спостереження</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">group</span><span class="metric_label">resource</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="timingratiohistogram"><label class="metric_detail">Тип:</label> <span class="metric_type">TimingRatioHistogram</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">priority_level</span></li><li class="metric_labels_constant"><label class="metric_detail">Постійні Мітки:</label><span class="metric_label">phase:executing</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kube-apiserver (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Затримка спроб імперсоніфікації в секундах з розподілом за режимом і рішенням.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">decision</span><span class="metric_label">mode</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kube-apiserver (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Загальна кількість спроб імперсоніфікації з розподілом за режимом і рішенням.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">decision</span><span class="metric_label">mode</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Затримка перевірки авторизації, виконаної обробником імперсоніфікації, в секундах з розподілом за режимом і рішенням.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">decision</span><span class="metric_label">mode</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Загальна кількість перевірок авторизації, виконаних обробником імперсоніфікації, з розподілом за режимом і рішенням.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">decision</span><span class="metric_label">mode</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Мітка часу останнього автоматичного перезавантаження конфігурації допуску з маніфесту, з розподілом за статусом, втулком та ідентифікатором apiserver.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="gauge"><label class="metric_detail">Тип:</label> <span class="metric_type">Gauge</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">apiserver_id_hash</span><span class="metric_label">plugin</span><span class="metric_label">status</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kube-apiserver (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Загальна кількість автоматичних перезавантажень конфігурації допуску з маніфесту, з розподілом за статусом, втулком та ідентифікатором apiserver.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">apiserver_id_hash</span><span class="metric_label">plugin</span><span class="metric_label">status</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Інформація про останню застосовану конфігурацію допуску з маніфесту з хешем у якості мітки, з розподілом за втулками та ідентифікатором apiserver.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="custom"><label class="metric_detail">Тип:</label> <span class="metric_type">Custom</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">plugin</span><span class="metric_label">apiserver_id_hash</span><span class="metric_label">hash</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kube-apiserver (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Загальна кількість помилок, що виникли під час синхронізації інформації про відкриття з peer kube-apiserver</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">type</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Загальна кількість помилок, що виникли під час проксирування запитів до peer kube-apiserver</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">group</span><span class="metric_label">resource</span><span class="metric_label">type</span><span class="metric_label">version</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kube-apiserver (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Загальна кількість запитів, які були перенаправлені на рівноправний kube apiserver через те, що локальний apiserver не зміг їх обслужити, розбитих за 'group', 'version' та 'resource', що вказує на GVR запиту. Якщо всі три порожні (""), запит є запитом на відкриття.`</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">code</span><span class="metric_label">group</span><span class="metric_label">resource</span><span class="metric_label">version</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kube-apiserver (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Затримка виклику GetList шару зберігання в секундах, включаючи декодування обʼєктів, з розбивкою за використанням etcd RangeStream.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">group</span><span class="metric_label">resource</span><span class="metric_label">streamed</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kube-apiserver (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">group</span><span class="metric_label">resource</span><span class="metric_label">storage</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kube-apiserver (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">group</span><span class="metric_label">index</span><span class="metric_label">resource</span><span class="metric_label">storage</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kube-apiserver (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Гістограма тривалості ініціалізації кешу спостереження в секундах, розбита за типом ресурсу.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">group</span><span class="metric_label">resource</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Лічильник помилок ініціалізації кешу спостереження, розбитий за типом ресурсу.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">group</span><span class="metric_label">resource</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Поточна версія ресурсу кешу спостереження з розбивкою за типом ресурсу. Значення обрізане до останніх 15 найменш значущих цифр.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="gauge"><label class="metric_detail">Тип:</label> <span class="metric_type">Gauge</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">group</span><span class="metric_label">resource</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Гістограма затримки доставки подій спостереження, розбита за типом ресурсу та стадією конвеєра. Стадія 'total' — це загальна затримка доставленої події.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">group</span><span class="metric_label">resource</span><span class="metric_label">stage</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kube-apiserver (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Лічильник подій, відфільтрованих за селектором сегмента під час розподілення спостереження, з розподілом за типом ресурсу.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">group</span><span class="metric_label">resource</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість активних сегментованих (sharded) з’єднань спостереження, з розподілом за типом ресурсу.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="gauge"><label class="metric_detail">Тип:</label> <span class="metric_type">Gauge</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">group</span><span class="metric_label">resource</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Загальна кількість запитів на потокове передавання через WebSocket (exec/attach/portforward), які маршрутизує сервер API, з мітками subresource і proxy_type. proxy_type має значення proxied_to_kubelet, коли запит безпосередньо обробляє kubelet; в іншому випадку — translated_at_apiserver.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">proxy_type</span><span class="metric_label">subresource</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kube-apiserver (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Загальна кількість викликів API постачальника хмари, позначена за операцією та результатом.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">operation</span><span class="metric_label">result</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>cloud-controller-manager (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Метрика, що вимірює тривалість у секундах одного виконання циклу MonitorNodes.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Поточні стани здоров'я бекенду сховища вузла CSI (1 = наявний).</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="gauge"><label class="metric_detail">Тип:</label> <span class="metric_type">Gauge</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">driver_name</span><span class="metric_label">reason</span><span class="metric_label">status</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kubelet (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Загальна кількість синхронізацій DaemonSet, пропущених через застарілий кеш спостереження.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">group</span><span class="metric_label">resource</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Сукупна кількість пропусків викликів NodePrepareResources через SkipNodeOperations.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Сукупна кількість пропусків викликів NodeUnprepareResources через SkipNodeOperations.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">driver_name</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість ResourceClaims, класифікованих за статусом виділення, адміністративним доступом та джерелом. Джерело може бути 'resource_claim_template' (створено з шаблону), 'extended_resource' (розширені ресурси) або порожнім (створено вручну користувачем).</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="custom"><label class="metric_detail">Тип:</label> <span class="metric_type">Custom</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість запитів на створення ResourceClaims, класифікована за статусом створення, адміністративним доступом та належною групою API і типом (Pod або scheduling.k8s.io/PodGroup)</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">admin_access</span><span class="metric_label">owner_api_group</span><span class="metric_label">owner_api_kind</span><span class="metric_label">status</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kube-controller-manager (/metrics)</li>
                    <li>kube-scheduler (/metrics)</li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <ul>
            ...
            <li class="metric_deprecated_version"><label class="metric_detail">Застаріло у версіях:</label><span>1.36.0</span></li>
        </ul>
    </div>
    <div class="metric" data-stability="alpha">
        <div class="metric_name">etcd_bookmark_total</div>
        <div class="metric_help">Кількість закладок etcd (подій, що сповіщають про прогрес) з розподілом за типом (kind).</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">group</span><span class="metric_label">resource</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Загальна кількість пропущених синхронізацій HPA через застарілий кеш спостереження.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">group</span><span class="metric_label">resource</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Час, витрачений на обробку подій після вилучення з черги.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">group</span><span class="metric_label">name</span><span class="metric_label">resource</span><span class="metric_label">version</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>cloud-controller-manager (/metrics)</li>
                    <li>kube-apiserver (/metrics)</li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість елементів, які наразі знаходяться в черзі FIFO.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="gauge"><label class="metric_detail">Тип:</label> <span class="metric_type">Gauge</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">group</span><span class="metric_label">name</span><span class="metric_label">resource</span><span class="metric_label">version</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">15 найменш значущих цифр версії ресурсу сховища.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="gauge"><label class="metric_detail">Тип:</label> <span class="metric_type">Gauge</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">group</span><span class="metric_label">name</span><span class="metric_label">resource</span><span class="metric_label">version</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Загальна кількість синхронізацій Job, пропущених через застарілий кеш спостереження.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">group</span><span class="metric_label">resource</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Останній час завершення належного припинення роботи програмного забезпечення в секундах unix</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="gauge"><label class="metric_detail">Тип:</label> <span class="metric_type">Gauge</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість випадків, коли обробники життєвого циклу успішно поверталися до http замість https.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Загальний обсяг cgroup v2 memory.low (у байтах) для podʼів класу Burstable. Ця пам’ять є м’яко зарезервованою і може бути повернена за сильного тиску.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="gauge"><label class="metric_detail">Тип:</label> <span class="metric_type">Gauge</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Загальний обсяг cgroup v2 memory.min (у байтах) для podʼів класу Guaranteed. Ця пам’ять жорстко зарезервована і ніколи не повертається ядром.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="gauge"><label class="metric_detail">Тип:</label> <span class="metric_type">Gauge</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Провайдер метрик, який використовується kubelet для збору статистики контейнерів. Значення можуть бути 'cadvisor' та 'cri'</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="gauge"><label class="metric_detail">Тип:</label> <span class="metric_type">Gauge</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">provider</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kubelet (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Тривалість у секундах для повторного отримання відомостей окремого podʼа в PLEG.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Тривалість у секундах, протягом якої зміна розміру Pod'а залишається відкладеною до завершення. Мітка 'priority_bucket' класифікує пріоритет Pod'а (system-critical: >=2000000000, high: 100000..1999999999, medium: 1..99999, normal: 0/default, low: -999..-1, very-low:</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">priority_bucket</span><span class="metric_label">resolution</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kubelet (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Загальна кількість Pod'ів, допущених під час допуску Kubelet, класифікована за режимом конфігурації ресурсів (pod_and_container_level, pod_level, container_level або порожній для неконфігурованого/BestEffort) та класом QoS.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">config_mode</span><span class="metric_label">qos_class</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kubelet (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість очікуючих змін розміру для podʼів. Мітка 'priority_bucket' класифікує пріоритет поду (system-critical: >=2000000000, high: 100000..1999999999, medium: 1..99999, normal: 0/default, low: -999..-1, very-low: <=-1000, unknown: nil pod). Мітка 'reason' описує стан (deferred, infeasible).</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="gauge"><label class="metric_detail">Тип:</label> <span class="metric_type">Gauge</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">priority_bucket</span><span class="metric_label">reason</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kubelet (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість запитів до ендпоінту Get PodsAPI. Розбито за версією API сервера та кодом статусу.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">server_api_version</span><span class="metric_label">status_code</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kubelet (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість запитів до ендпоінту List PodsAPI. Розбито за версією API сервера та кодом статусу.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">server_api_version</span><span class="metric_label">status_code</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Сукупна кількість запитів до ендпоінту PodsAPI. Розбито за версією API сервера та кодом статусу.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">server_api_version</span><span class="metric_label">status_code</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість запитів до ендпоінту Watch PodsAPI. Розбито за версією API сервера та кодом статусу.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">server_api_version</span><span class="metric_label">status_code</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Сумарна кількість втрачених подій спостереження в розрізі podʼів.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Загальна кількість витіснень Podʼів за ресурсом витіснення.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість помилок, виявлених під час ексклюзивного виділення ресурсів.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">resource_name</span><span class="metric_label">source</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kubelet (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість ексклюзивних виділень ресурсів, виконаних менеджером ресурсів.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">resource_name</span><span class="metric_label">source</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість контейнерів із певним типом призначення ресурсів.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">assignment_type</span><span class="metric_label">resource_name</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kubelet (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кумулятивна кількість запущених podʼів з іменами просторів користувачів. Цей показник збирається тільки в Linux.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Сумарна кількість завершених контейнерів.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">container_type</span><span class="metric_label">exit_code</span><span class="metric_label">reason</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kubelet (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Загальна кількість WebSocket-запитів на потокове передавання (exec/attach/portforward), отриманих kubelet.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">subresource</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kubelet (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість невдалих створень слухачів проксі користувацького простору localhost NodePort.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">ip_family</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість активних слухачів проксі користувацького простору localhost NodePort.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="gauge"><label class="metric_detail">Тип:</label> <span class="metric_type">Gauge</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">ip_family</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість пакетів, відхилених на localhost NodePorts. UDP та SCTP завжди відхиляються; TCP відхиляється, коли проксі localhost NodePort не запущено</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="custom"><label class="metric_detail">Тип:</label> <span class="metric_type">Custom</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">ip_family</span><span class="metric_label">protocol</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kube-proxy (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Сукупна кількість невдалих створень winkernel lb проксі</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">error</span><span class="metric_label">ip_family</span><span class="metric_label">lb_type</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kube-proxy (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Сукупна кількість невдалих видалень winkernel lb проксі</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">error</span><span class="metric_label">ip_family</span><span class="metric_label">lb_type</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Сукупна кількість невдалих оновлень winkernel lb проксі</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">error</span><span class="metric_label">ip_family</span><span class="metric_label">lb_type</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Співвідношення віку вибраних видалених Podʼів до поточного наймолодшого віку Podʼів (на даний момент). Має бути менше ніж 2. Мета цієї метрики — виміряти приблизну ефективність сортування (і видалення) Podʼів при зменшенні масштабу набору реплік. При обчисленні та створенні звітів враховуються лише готові Podʼи.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Загальна кількість синхронізацій ReplicaSet, пропущених через застарілий кеш спостереження.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">group</span><span class="metric_label">resource</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Час обробки запиту ResourcePoolStatusRequest</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">driver_name</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Загальна кількість помилок, що виникає під час обробки запитів ResourcePoolStatusRequests</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">driver_name</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Загальна кількість оброблених запитів ResourcePoolStatusRequests</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">driver_name</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість спроб перезавантаження центру сертифікації (CA), поділена за результатом і причиною спроби перезавантаження</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">reason</span><span class="metric_label">result</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>cloud-controller-manager (/metrics)</li>
                    <li>kube-apiserver (/metrics)</li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість викликів очищення GC спробами видалити запис кешу транспорту, поділена за результатом: видалено, пропущено</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">result</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість викликів функції cancel goroutine циклу ротації сертифіката через очищення GC відповідного транспорту</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість викликів для отримання нового транспорту, розділена за результатом операції hit: отримано з кешу, miss: створено та додано до кешу, miss-gc: перестворено та додано назад до кешу після збору сміття, uncacheable: створено та не кешовано</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">result</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Метрика, що рахує кількість злагоджень маршрутів з хмарним провайдером, позначена тригером (періодичний або node_change) та результатом (помилка, якщо злагодження не вдалося, змінено, якщо було створено або видалено принаймні один маршрут, в іншому випадку без змін).</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">outcome</span><span class="metric_label">trigger</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>cloud-controller-manager (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Підрахунок спроб перерахунку під час Opportunistic batching.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Затримка перерахунку вузла під час Opportunistic batching.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">profile</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість алокацій з використанням пристроїв із BindingConditions, підрахована за драйвером за кожну спробу планування</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">driver</span><span class="metric_label">profile</span><span class="metric_label">status</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kube-scheduler (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Час в секундах очікування виконання умов BindingConditions під час PreBind.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">driver</span><span class="metric_label">profile</span><span class="metric_label">status</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість згенерованих кандидатів розміщень під час планування груп Pod'ів.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">profile</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Затримка в секундах оцінки окремого кандидата розміщення під час планування груп Podʼів, за результатом. 'feasible' означає, що група Podʼів відповідає розміщенню, тоді як 'infeasible' означає, що ні.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">profile</span><span class="metric_label">result</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість оцінених кандидатів розміщень під час планування груп Podʼів, за результатом. 'feasible' означає, що група Podʼів відповідає розміщенню, тоді як 'infeasible' означає, що ні.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">profile</span><span class="metric_label">result</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість Podʼів, які були успішно заплановані після того, як вони були видалені з unschedulableEntities через тайм-аут. Ця метрика допомагає виявляти потенційні проблеми з конфігурацією черги або обробкою подій.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість спроб запланувати групу подів, за результатом. 'unschedulable' означає, що групу подів не вдалося запланувати, тоді як 'error' означає внутрішню проблему планувальника.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">profile</span><span class="metric_label">result</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Затримка алгоритму планування групи подів у секундах</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Затримка спроби планування групи Podʼів у секундах</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">profile</span><span class="metric_label">result</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість оцінок PreQueueingHint, позначена за втулком та результатом (all_pods або narrowed).</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">plugin</span><span class="metric_label">result</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kube-scheduler (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Тривалість у секундах для визначення цільових жертв витіснення.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">preemptor</span><span class="metric_label">result</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kube-scheduler (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Тривалість у секундах для витіснення цільових жертв витіснення. За увімкненого асинхронного витіснення виконання витіснення не блокує планування інших Pod'ів.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">preemptor</span><span class="metric_label">result</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Загальна кількість порушень бюджету зриву Pod'ів, спричинених витісненням.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">preemptor</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kube-scheduler (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість одиниць зриву робочого навантаження, що підлягають витісненню. Одиниця витіснення може бути всім Pod'ами в групі Pod'ів (у випадку DisruptionMode=all) або одним Pod'ом (у випадку DisruptionMode=single).</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">preemptor</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість сутностей планування, доданих до черг планування за подіями, типом черги та типом сутності. Типи сутностей — це 'pod' (для окремих Pod'ів, які не є членами жодної podgroup) або 'podgroup'.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">event</span><span class="metric_label">queue</span><span class="metric_label">type</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kube-scheduler (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість сутностей планування в черзі ('pod' або 'podgroup'; 'pod' означає окремі Pod'и, які не є членами жодної podgroup) за типом черги. 'active' означає кількість сутностей в activeQ; 'backoff' означає кількість сутностей в backoffQ; 'unschedulable' означає кількість сутностей в unschedulableEntities, які планувальник намагався запланувати і не зміг; 'gated' означає кількість незапланованих сутностей, які планувальник ніколи не намагався запланувати, тому що вони є gated.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="gauge"><label class="metric_detail">Тип:</label> <span class="metric_type">Gauge</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">queue</span><span class="metric_label">type</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kube-scheduler (/metrics)</li>
                </ul>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Затримка збереження результатів планування.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">profile</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Загальна кількість спроб витіснення, ініційованих робочим навантаженням (включаючи групи Pod'ів), у кластері на даний момент.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">result</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість жертв витіснення Pod'ів, спричинених витісненням робочого навантаження.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Загальна кількість пропущених синхронізацій StatefulSet через застарілий кеш спостереження.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">group</span><span class="metric_label">resource</span></li>
