...
<div class="metrics">
    ...
    <div class="metric" data-stability="beta">
        ...
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">BETA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">group</span><span class="metric_label">resource</span><span class="metric_label">scope</span><span class="metric_label">version</span></li><li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kube-apiserver (/metrics)</li>
                </ul>
            </li>
...
<div class="metrics">
    ...
    <div class="metric" data-stability="alpha">
        ...
        <ul>
            ...
            <li class="metric_deprecated_version"><label class="metric_detail">Застаріло у версіях:</label><span>1.31.0</span></li>
        </ul>
    </div>
    <div class="metric" data-stability="alpha">
        ...
        <ul>
            ...
            <li class="metric_deprecated_version"><label class="metric_detail">Застаріло у версіях:</label><span>1.30.0</span></li>
        </ul>
    </div>
    <div class="metric" data-stability="alpha">
    ...
    <div class="metric" data-stability="alpha">
        ...
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="gauge"><label class="metric_detail">Тип:</label> <span class="metric_type">Gauge</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">endpoint</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>kube-apiserver (/metrics)</li>
                </ul>
            </li>
            <li class="metric_deprecated_version"><label class="metric_detail">Застаріло у версіях:</label><span>1.28.0</span></li>
        </ul>
    </div>
    <div class="metric" data-stability="alpha">
    ...
    <div class="metric" data-stability="alpha">
        ...
        <ul>
            ...
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
                <ul>
                    <li>etcd-version-monitor (/metrics)</li>
                </ul>
            </li>
        </ul>
    </div>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість помилок, що виникає під час ексклюзивного виділення ресурсів.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Метрика, що рахує кількість разів, коли маршрути були синхронізовані з провайдером хмари.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Кількість подів, які були успішно заплановані після того, як вони були видалені з unschedulablePods через тайм-аут. Ця метрика допомагає виявляти потенційні проблеми з конфігурацією черги або обробкою подій.</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="counter"><label class="metric_detail">Тип:</label> <span class="metric_type">Counter</span></li>
            <li class="metric_component_endpoints"><label class="metric_detail">Компоненти:</label>
    ...
    <div class="metric" data-stability="alpha">
        ...
        <div class="metric_help">Затримка спроби планування групи подів у секундах (алгоритм планування + привʼязка)</div>
        <ul>
            <li><label class="metric_detail">Рівень стабільності:</label><span class="metric_stability_level">ALPHA</span></li>
            <li data-type="histogram"><label class="metric_detail">Тип:</label> <span class="metric_type">Histogram</span></li>
            <li class="metric_labels_varying"><label class="metric_detail">Мітки:</label><span class="metric_label">profile</span><span class="metric_label">result</span></li>
