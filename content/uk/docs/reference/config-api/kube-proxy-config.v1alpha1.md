...
<table class="table">
    ...
    <tbody>
        <tr>
            ...
            <td>
                <span class="text-muted">Немає опису.</span></td>
        </tr>
    </tbody>
</table>
...
<table class="table">
    ...
    <tbody>
        <tr>
            ...
            <td>
                <span class="text-muted">Опис не надається</span></td>
        </tr>
    </tbody>
</table>
...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <p>nodePortAddresses — це список діапазонів CIDR та/або ключових слів, які розгортаються в діапазони CIDR. Сервіси NodePort доступні лише на IP-адресах вузлів, охоплених цим списком. Підтримувані ключові слова: 'primary' (основні IPv4 та/або IPv6 адреси об'єкта Node), 'localhost' (127.0.0.0/8 та ::1/128) та 'all' (0.0.0.0/0 та ::/0). У список може бути включена будь-яка комбінація допустимих ключових слів та CIDR.</p>
                <p>Обслуговування NodePorts на loopback IP-адресах підтримується лише в режимі iptables (тільки IPv4, див. iptables.localhostNodePorts), а також, лише для TCP, у режимі nftables, коли увімкнено функціональну можливість KubeProxyNFTablesLocalhostNodePorts і список явно містить loopback (наприклад, 'localhost').</p>
                <p>Якщо не задано, за замовчуванням використовується 'all' у режимах iptables та ipvs, і 'primary' у режимі nftables.</p>
            </td>
        </tr>
        <tr>
            <td>
...
<table class="table">
    ...
    <tbody>
        <tr>
            ...
            <td>
                <p>maxPerCore — максимальна кількість NAT зʼєднань, які слід відстежувати на одне процесорне ядро (0 для того, щоб залишити обмеження без змін і проігнорувати min).</p>
            </td>
        </tr>
        <tr>
            <td>
