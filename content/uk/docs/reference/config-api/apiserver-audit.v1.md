    ...
    <tbody>
        ...
        <tr>
            <td><code>user</code> <b>[Обовʼязково]</b><br/>
                <a href="/docs/reference/generated/kubernetes-api/ v1.36/#userinfo-v1-authentication-k8s-io"><code>authentication/v1.UserInfo</code></a>
            </td>
        ...
        <tr>
            <td><code>responseStatus</code><br/>
                <a href="/docs/reference/generated/kubernetes-api/ v1.36/#status-v1-meta"><code>meta/v1.Status</code></a>
            </td>
        ...
        <tr>
            <td><code>requestReceivedTimestamp</code><br/>
                <a href="/docs/reference/generated/kubernetes-api/ v1.36/#microtime-v1-meta"><code>meta/v1.MicroTime</code></a>
            </td>
    ...
    <tbody>
        ...
        <tr>
            <td><code>metadata</code><br/>
                <a href="/docs/reference/generated/kubernetes-api/ v1.36/#listmeta-v1-meta"><code>meta/v1.ListMeta</code></a>
            </td>
...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            <td><code>metadata</code><br/>
                <a href="/docs/reference/generated/kubernetes-api/ v1.36/#objectmeta-v1-meta"><code>meta/v1.ObjectMeta</code></a>
            </td>
...
<table class="table">
    ...
    <tbody>
        <tr>
          ...
          <td><p>Група — це назва API групи, яка містить ресурси. Порожній рядок представляє основну API групу. <code>*</code> відповідає всім групам.</p></td>
        </tr>
        <tr>
