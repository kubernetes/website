...
[`kind`](https://kind.sigs.k8s.io/) — це інструмент для запуску локальних кластерів Kubernetes за допомогою вузлів контейнерів Docker. kind в основному призначений для тестування самого Kubernetes, але також може використовуватися для локальної розробки або CI.
