...
Запити на імперсонізацію спочатку автентифікуються як запити від імені запитувача, потім переключаються на інформацію для імперсонованої особи.
...
Використовуйте цей режим для виконання дій від імені ServiceAccounts.
