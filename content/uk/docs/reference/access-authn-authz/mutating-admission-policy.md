...
{{< note >}}
Імена, що закінчуються на `.static.k8s.io`, зарезервовані для [конфігурацій на основі маніфестів](/docs/reference/access-authn-authz/manifest-admission-control/) і не можуть використовуватися для політик або привʼязок на основі API. Це обмеження застосовується, коли функціональна можливість `ManifestBasedAdmissionControlConfig` [увімкнена](/docs/reference/command-line-tools-reference/feature-gates/#ManifestBasedAdmissionControlConfig).
{{< /note >}}
...
Починаючи з Kubernetes v1.37,
[вебхуки допуску](/docs/reference/access-authn-authz/extensible-admission-controllers/#excluded-virtual-resources) також виключають ці віртуальні ресурси за замовчуванням.
