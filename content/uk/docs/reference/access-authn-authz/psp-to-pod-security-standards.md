...
Нижче наведено таблиці, що перераховують параметри конфігурації обʼєктів `PodSecurityPolicy`, чи поле змінює або перевіряє поди, та як значення конфігурації зіставляються з [Стандартами безпеки Podʼів](/docs/concepts/security/pod-security-standards/).
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <p><b>Restricted</b>: повинен містити <code>ALL</code></p>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        ...
        <code>seLinux.rule</code> є <code>MustRunAs</code>, з наступними <code>options</code></p>
        <ul>
...
<table class="no-word-break">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Перевірка</td>
      <td>
        <p><b>Baseline</b>: <code>"runtime/default,"</code> <i>(Кома в кінці, щоб дозволити невстановлене значення)</i></p>
