...
Цей контролер допуску додає {{< glossary_tooltip text="taint" term_id="taint" >}} до новостворених вузлів таких як `NotReady` та `NoSchedule`. Це позначення дозволяє уникнути стану перегонів, який може призвести до того, що Podʼи будуть заплановані на нових вузлах до того, як їх taint будуть оновлені для точної відповідності їх звітних умов.
