...
Контролери допуску є кодом в {{< glossary_tooltip term_id="kube-apiserver" text="API server" >}} Kubernetes, який перевіряє дані, що надходять на запит на зміну ресурсів.
...
У повному [списку](#what-does-each-admission-controller-do) є чотири спеціальні контролери: [MutatingAdmissionWebhook](#mutatingadmissionwebhook), [MutatingAdmissionPolicy](#mutatingadmissionpolicy), [ValidatingAdmissionWebhook](#validatingadmissionwebhook) та [ValidatingAdmissionPolicy](#validatingadmissionpolicy). Обдва контролери веб-хуків виконують мутацію та валідацію (відповідно) [веб-хуки контролю доступу](/docs/reference/access-authn-authz/extensible-admission-controllers/#admission-webhooks), які налаштовуються в API. MutatingAdmissionPolicy та ValidatingAdmissionPolicy надають спосіб вбудувати декларативний код мутації/валідації в API, не покладаючись на будь-які зовнішні HTTP-виклики.

Ви можете використовувати ці чотири контролери допуску, щоб налаштувати поведінку кластера під час допуску.
...
{{< figure src="/uk/docs/reference/access-authn-authz/admission-control-phases.svg" alt="Діаграма послідовності обробки запитів kube-apiserver під час фази допуску, яка показує мутацію вебхуків, потім перевірку політик допуску і, нарешті, перевірку вебхуків. З діаграми видно, що процес продовжується до першої відмови або до того моменту, поки всі вони не будуть прийняті. Також показано, що мутації шляхом мутації вебхуків призводять до повторного виклику всіх раніше викликаних вебхуків." class="diagram-large" link="https://mermaid.live/edit#pako:eNrFV11vE0cU_SujraKCuvnATuJkVSHRILUIIVUK5aHyy3h3Yg-sd9yZ2SQmihSglD6gUiEEUtUfYVIQIYHkvU-z_6jnznod20l4aIXqh3h35t5z7z3nzuR6J4hVIoIomJlh3_FNwaxiRli2oTK7Lu8L1k5Vi6dpn3HDbEcaJk32pWVamJ6IrUhYknunjrU9E83Pt6Xt5K25WHXnu0J3uUxm75rqcV4akwszX19dXWhmMzM7MpM22mkGtiO6ohlEzSATudU8bQZhM6iSwAZrBrVabxvLeDLip1xksV-Hc1dqrfS12CptsGR1LnbDZsbwGSLf4VryVipM6eG3ym1OXt_ca_vYX9Rry7FYotjTJrfFtl1TqdLecKsjrZgyS5XqjVuxi_AyZQUijtm1tehPGZ1XejPb3d2dmWlmzaxi4Lrkbc27tER-EPF2qRG0EoyndtYiJaipGY9jYYxsyVTafsh4ljDTUXmasJZgeS_hJKbYFLrPrOwKD5CU8MCbKwMA5LowsR4ncX2Yy8iaot3LW2KW96QRGpCsg3CpzNroGxgba9A2mt59mkkXfSFVxnodbgSltUV73dxyS8tbotVR6p4JAZ2maguJtvpsk6cSWcNyBNBTqYylML66DZn5xj21GwHNsdP0b1gfkBjj1ucTg3uZoa1zfKd-aUNqQ01_Fz2POCFDiS1BkERrz5YZIRxTG-TQnYrAU6PGw1SlGXIrX8bSYzHPjfBwPS02pcoN6ojxjjgjIxw6KDdc5W0us6FIu1U79Li24KPHM8t-gBJ0ht0f7rjYcwfFg-Jh8cjtu0HxhJ01v_b9DbK-CRl1JiwopZV1r-Y51rntePDf3X7x0L11H_H3oPi5eOkOEeCX4mXxjH1Vbfv47l21MWrdCcSku2Z1SqDXRu2xBmG0SkuHltpm36Jo01Ja-bIoKqCP3ZF7W-wx9waPJ8Wj4oE7LB6xr1v6qnuOwIfYP_B5vYD9UxDxzNsyd0J-xa9I8BVDpi-x-gEY--7gbMm3KtGo7D9h9aYqGBF_K54gxPuJFM5C3DltTAJ57gbuyAf1xLj37uMFICJLSOLyxQs7e_WqFyhi7hVgTpDLQ3YJAHgu9uZCRnKjkFJ6aEPFIufLQ-nJ12NAyOjTMuLxTAO5AYPloOTYswhnEIhvOJYVvKPwvsD9CzCqiugmZe4FbJ-RDA-A85h5Jc7hmLZOSmBKtqLIF0VdSVVVWkVsvAHOh_TaTwBW6tNnpPoYWRPij2ii7IZNVDwGzBHRCUJR0rF7_feH4gVCEmeX6CT4kL5737rX7uDyhM7_ipN9Qioeg91Dovy_suL-ogMyBkpy_e-s4DSdJWX_vHN0pk1Ceh8AeuCTOCqewuz4gppOT-o0WecF-3QLjZ36aRXGaBke0jFSPgslU13yOUn5ZAd9ZlJGPY97LiJ6RtdRhTmA4_FkZw533lX36QiM7koCo5u3ytDrXXo_ZZM3L13cJ6UOwyhk-8HHAAnINggxAsqkHF3DYDgsYyj3U9bpdIxHLZJ8ezYuZ0cMhHDF_5IflepW3lrl7U4QbWDkwFs52A3HxJEJqBF6TWG-CaJao-Exgmgn2A6ilfrcldpSfXlhebFRX1xsrIZBP4gWsbpSr63WasuNRn1leXE3DO77oAtzK42lBXxqjeWVpSsri_UwEInEyHyr_GHhf1-EAc-tWu9n8XA-_wd2QOFq" >}}

## Навіщо вони мені потрібні? {#why-do-i-need-them}

Кілька важливих функцій Kubernetes вимагають увімкнення контролера допуску, щоб належним чином підтримувати функцію. Як наслідок, сервер API Kubernetes, який не налаштований належним чином з правильним набором контролерів допуску, є неповним сервером і не буде підтримувати всі функції, які ви очікуєте.
...
[Цей контролер допуску](/docs/reference/access-authn-authz/mutating-admission-policy/) використовує Common Expression Language (CEL) для оголошення мутацій ресурсів. Мутації можуть бути визначені або за допомогою конфігурації застосування, яка обʼєднується за допомогою стратегії обʼєднання на стороні сервера, або за допомогою JSON-патча.

Він увімкнений, коли і функціональна можливість `mutatingadmissionpolicy`, і група/версія `admissionregistration.k8s.io/v1alpha1` обидві увімкнені.

Якщо будь-яка з MutatingAdmissionPolicy не вдається, запит не вдається.
...
* **Заборонено** (Kubelets не можуть змінювати ці елементи):
  * Мітки з префіксом `node-restriction.kubernetes.io/`. Цей префікс зарезервовано для адміністраторів, щоб вони могли позначати обʼєкти `Node` з метою ізоляції робочих навантажень.
...
Цей контролер допуску додає {{< glossary_tooltip text="taint" term_id="taint" >}} до новостворених вузлів таких як `NotReady` та `NoSchedule`. Це позначення дозволяє уникнути гонитви, яка може призвести до того, що Podʼи будуть заплановані на нових вузлах до того, як їх taint будуть оновлені для точної відповідності їх звітних умов.
