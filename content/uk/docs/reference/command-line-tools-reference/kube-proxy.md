...
<table style="width: 100%; table-layout: fixed;">
   ...
   <tbody>
      ...
      <tr>
         <td></td>
         <td style="line-height: 130%; word-wrap: break-word;"><p>Логи з цим або вище цього порогу будуть виводитися в stderr, коли -alsologtostderr=true (не має ефекту, коли -logtostderr=true)</p></td>
      </tr>
      <tr>
      ...
      <tr>
         <td></td>
         <td style="line-height: 130%; word-wrap: break-word;"><p>IP-адреса та порт для сервера перевірки справності, типово &quot;0.0.0.0:10256&quot;. Цей параметр ігнорується, якщо конфігураційний файл вказано за допомогою --config.</p></td>
      </tr>
      <tr>
      ...
      <tr>
         <td colspan="2">--legacy_stderr_threshold_behavior&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Типово: true</td>
      </tr>
      <tr>
         <td></td><td style="line-height: 130%; word-wrap: break-word;"><p>Якщо true, stderrthreshold ігнорується, коли logtostderr=true (спадкова поведінка). Якщо false, stderrthreshold враховується навіть коли logtostderr=true</p></td>
      </tr>
      <tr>
      ...
      <tr>
         <td></td>
         <td style="line-height: 130%; word-wrap: break-word;"><p>IP-адреса та порт для сервера метрик, типове значення: &quot;127.0.0.1:10249&quot;. (Встановіть значення &quot;0.0.0.0:10249&quot; / &quot;[::]:10249&quot; для привʼязки на всіх інтерфейсах). Цей параметр ігнорується, якщо конфігураційний файл вказано за допомогою --config.</p></td>
      </tr>
      <tr>
      ...
      <tr>
         <td></td>
         <td style="line-height: 130%; word-wrap: break-word;"><p>Список діапазонів CIDR та/або ключових слів, які розгортаються в діапазони CIDR. Сервіси NodePort доступні лише на IP-адресах вузлів, які покриваються списком. Підтримувані ключові слова: 'primary' (основні IPv4 та/або IPv6 адреси обʼєкта Node), 'localhost' (127.0.0.0/8 та ::1/128) та 'all' (0.0.0.0/0 та ::/0). До списку може бути включена будь-яка комбінація допустимих ключових слів та CIDR. Обслуговування NodePort на loopback IP-адресах підтримується лише в режимі iptables (лише IPv4, див. --iptables-localhost-nodeports), а також, лише для TCP, у режимі nftables, коли увімкнено функціональну можливість KubeProxyNFTablesLocalhostNodePorts і список явно включає loopback (наприклад, 'localhost'). Якщо не встановлено, за замовчуванням використовується 'all' у режимах iptables та ipvs, і 'primary' у режимі nftables. Цей параметр ігнорується, якщо конфігураційний файл вказано за допомогою --config.</p></td>
      </tr>
      <tr>
      ...
      <tr>
         <td></td>
         <td style="line-height: 130%; word-wrap: break-word;"><p>Режим проксі-сервера: у Linux це може бути 'iptables' (типово), 'ipvs' або 'nftables'. У Windows єдиним підтримуваним значенням є 'kernelspace'. Цей параметр ігнорується, якщо у конфігураційному файлі вказано --config.</p></td>
      </tr>
      <tr>
      ...
      <tr>
         <td></td>
         <td style="line-height: 130%; word-wrap: break-word;"><p>логи на рівні або вище цього порогу потрапляють до stderr під час запису до файлів та stderr (не впливає, якщо -logtostderr=true або -alsologtostderr=true, якщо -legacy_stderr_threshold_behavior=false)</p></td>
      </tr>
      <tr>
      ...
      <tr>
         <td></td>
         <td style="line-height: 130%; word-wrap: break-word;"><p>Якщо встановлено, записати значення типової конфігурації до цього файлу і вийти.</p></td>
      </tr>
   </tbody>
</table>
