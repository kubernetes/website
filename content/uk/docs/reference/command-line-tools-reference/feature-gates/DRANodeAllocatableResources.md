...
Для отримання додаткової інформації див. [Ресурси вузла, доступні для виділення](/docs/concepts/resource-management/dynamic-resource-allocation/how-dra-works/#node-allocatable-resources) у документації з Dynamic Resource Allocation.
