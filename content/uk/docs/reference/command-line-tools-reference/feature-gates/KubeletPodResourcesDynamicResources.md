...
kubelet List і Get, щоб включити ресурси, виділені в ResourceClaims за допомогою [Динамічного розподілу ресурсів](/docs/concepts/resource-management/dynamic-resource-allocation/).
