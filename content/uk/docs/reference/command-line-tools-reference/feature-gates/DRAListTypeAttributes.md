...
Для отримання додаткової інформації див. [Атрибути типу список](/docs/concepts/resource-management/dynamic-resource-allocation/dra-api/#list-type-attributes) у документації з динамічного розподілу ресурсів.
