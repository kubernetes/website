...
<table style="width: 100%; table-layout: fixed;">
   ...
   <tbody>
      ...
      <tr>
         ...
         Можливі варіанти:<br/>
         kube=1.33..1.36 (default=1.36) Якщо компонент не вказано, типово використовується &quot;kube&quot;</p></td>
      </tr>
      <tr>
      ...
      <tr>
         <td></td>
         <td style="line-height: 130%; word-wrap: break-word;"><p>Мінімальна версія компонентів панелі управління, з якою повинен бути сумісний сервер. <br/>Повинна бути меншою або дорівнювати емульованій версії. Формат версії може бути тільки major.minor, наприклад: '--min-compatibility-version=wardle=1.2,kube=1.31'.<br/>Варіанти: kube=1.33..1.36 (default: 1.35)<br/>Якщо компонент не вказано, типово використовується &quot;kube&quot;</p></td>
      </tr>
      <tr>
