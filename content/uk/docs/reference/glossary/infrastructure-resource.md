...
Ви також можете використовувати [динамічний розподіл ресурсів](/docs/concepts/resource-management/dynamic-resource-allocation/) для автоматичного керування складними розподілами ресурсів.
