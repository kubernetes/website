...
Функція Kubernetes, яка дозволяє вам запитувати ресурси та ділитися ними з іншими Podʼами. Ці ресурси часто приєднуються до {{< glossary_tooltip text="пристроїв" term_id="device" >}}, наприклад, до апаратних прискорювачів.
