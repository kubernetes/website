...
{{< glossary_tooltip text="пристрої" term_id="device" >}}, які підключені до вузлів. Драйвери створюють і керують ResourceSlices у кластері. ResourceSlices використовуються для [динамічного виділення ресурсів (DRA)](/docs/concepts/resource-management/dynamic-resource-allocation/).
