...
Для отримання додаткової інформації дивіться репозиторій [kubernetes/community](https://github.com/kubernetes/community) та поточний список [SIGs та робочих груп](https://github.com/kubernetes/community/blob/main/sig-list.md).
