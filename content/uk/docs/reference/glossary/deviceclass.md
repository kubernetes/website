...
Для отримання додаткової інформації див. [Динамічне виділення ресурсів](/docs/concepts/resource-management/dynamic-resource-allocation/dra-api/#deviceclass)
