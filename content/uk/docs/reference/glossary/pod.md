...
short_description: >
  Pod є групою контейнерів, що запущені у вашому кластері.
...
Найменший та найпростіший обʼєкт Kubernetes. Pod є групою {{< glossary_tooltip text="контейнерів" term_id="container" >}}, що запущені у вашому кластері.
