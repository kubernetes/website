...
Визначає шаблон для Kubernetes для створення {{< glossary_tooltip text="ResourceClaims" term_id="resourceclaim" >}}. ResourceClaimTemplates використовуються в [динамічному виділенні ресурсів (DRA)](/docs/concepts/resource-management/dynamic-resource-allocation/) для надання _доступу до окремих, подібних ресурсів на рівні Pod або {{< glossary_tooltip text="PodGroup" term_id="podgroup" >}}_.
