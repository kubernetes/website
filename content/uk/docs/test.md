...
Ви можете додавати списки з маркерами в markdown:
...
{{< warning >}}
Заголовки всередині табличних списків не зʼявляться у Змісті.
{{< /warning >}}
...
Прості таблиці мають один рядок на рядок, а стовпці розділені символами `|`. Заголовок відокремлюється від тіла комірками, що містять лише щонайменше три символи `-`. Для зручності обслуговування намагайтеся тримати всі роздільники комірок на одному рівні, навіть якщо потрібно використовувати додатковий простір.
