...
При розробці застосунку у Kubernetes ви зазвичай програмуєте або налагоджуєте один сервіс. Цей сервіс може потребувати доступу до інших сервісів для тестування та налагодження. Один із варіантів — використання конвеєра постійного розгортання (continuous
...
Також відвідайте [вебсайт Telepresence](https://www.telepresence.io).
