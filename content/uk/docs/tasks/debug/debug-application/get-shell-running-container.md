...
Якщо в Podʼі є більше одного контейнера, використовуйте `--container` або `-c` для зазначення контейнера в команді `kubectl exec`. Наприклад, припустимо, у вас є Pod на імʼя my-pod, і в Podʼі є два контейнери з іменами _main-app_ та _helper-app_. Наступна команда відкриє оболонку до контейнера _main-app_.
