...
```shell
kubectl exec <ІМʼЯ-ПОДА> -c <ІМʼЯ-КОНТЕЙНЕРА> -- <КОМАНДА>
```
...
Якщо ви можете зробити пошук повного імені, але не відносного, вам потрібно перевірити, чи правильний ваш файл `/etc/resolv.conf` в Podʼі. Зсередини Podʼа:
