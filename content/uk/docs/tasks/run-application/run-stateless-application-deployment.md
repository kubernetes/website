...
Для детальних процедур масштабування, включаючи зменшення кількості реплік та масштабування до нуля, дивіться [Масштабування Deployment вручну](/docs/tasks/run-application/scale-deployment/).
...
- Дізнайтеся, як [оновити Deployment без простою](/docs/tasks/run-application/update-deployment-rolling/).
