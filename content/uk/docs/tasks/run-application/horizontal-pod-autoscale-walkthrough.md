...
## Автомасштабування за допомогою кількох метрик та власних метрик {#autoscaling-on-multiple-metrics-and-custom-metrics}
...
### Автомасштабування за більш конкретними метриками {#autoscaling-on-more-specific-metrics}
...
## Додаток: Умови стану горизонтального автомасштабування Podʼів {#appendix-horizontal-pod-autoscaler-conditions}
