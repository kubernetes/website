...
Функціональна можливість [`StorageVersionMigrator`](/docs/reference/command-line-tools-reference/feature-gates/#StorageVersionMigrator) та REST API `storagemigration.k8s.io/v1` увімкнені стандартно у всіх кластерах.
...
- Також перевірте, що статус збереженої версії CRD тепер лише v2:
