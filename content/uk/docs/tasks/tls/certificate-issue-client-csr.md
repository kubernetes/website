...
Ви використовуєте запит [CertificateSigningRequest](/docs/reference/access-authn-authz/certificate-signing-requests/) як частину цього процесу; ви або інша довірена особа маєте схвалити запит.
...
На цьому кроці ви створюєте приватний ключ. Ви повинні тримати цей приватний ключ в таємниці; будь-хто, хто його має, може видавати себе за користувача.
...
```shell
# Змініть загальне імʼя "myuser" на фактичне імʼя користувача, яке ви хочете використовувати
...
Ви також можете створити маніфест YAML та застосувати його за допомогою `kubectl`:
