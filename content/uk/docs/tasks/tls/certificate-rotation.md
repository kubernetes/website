...
Kubelet використовує сертифікати для автентифікації з Kubernetes API. Типово ці сертифікати випускаються з однорічним терміном дії, щоб їх не потрібно було оновлювати занадто часто.
