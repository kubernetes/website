...
Якщо надбудова DNS кластера не налаштована правильно, попередній крок може не працювати для вас. Ви також можете знайти IP-адресу для цього Service у змінній середовища:
...
## Заповнення черги завданнями {#fill-the-queue-with-tasks}
