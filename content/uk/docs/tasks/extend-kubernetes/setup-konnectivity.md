...
1. Переконайтеся, що функція [Проєкція токенів службових облікових записів](/docs/tasks/configure-pod-container/configure-service-account/#serviceaccount-token-volume-projection) увімкнена у вашому кластері. Вона є типово увімкненою з версії Kubernetes v1.20.
...
4. Якщо ви використовуєте з'єднання UDS, додайте конфігурацію томів до kube-apiserver:
