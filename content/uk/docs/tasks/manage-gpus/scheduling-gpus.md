...
Ось приклад маніфесту для Podʼа, який запитує GPU:
...
metadata:
  name: example-vector-add
spec:
  # Ви можете використовувати Kubernetes node affinity для планування цього Podʼа на вузол
  # який надає тип GPU, який потрібен його контейнеру для роботи
  affinity:
    nodeAffinity:
