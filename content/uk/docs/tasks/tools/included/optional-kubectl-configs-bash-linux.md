...
bash-completion надається багатьма менеджерами пакунків (див. [тут](https://github.com/scop/bash-completion#installation)). Ви можете встановити його за допомогою `apt-get install bash-completion` або `dnf install bash-completion` тощо.
