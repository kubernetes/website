...
1. Отримайте публічну IP-адресу одного з ваших вузлів, що запускає Pod Hello World. Як ви отримаєте цю адресу залежить від того, як ви налаштували свій кластер. Наприклад, якщо ви використовуєте Minikube, ви можете побачити адресу вузла, виконавши команду `kubectl cluster-info`. Якщо ви використовуєте Google Compute Engine, ви можете використати команду `gcloud compute instances list` для перегляду публічних адрес ваших вузлів.
