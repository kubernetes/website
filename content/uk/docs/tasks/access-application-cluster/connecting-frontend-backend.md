...
Подібно до бекенду, фронтенд має Deployment та Service. Важливою відмінністю між Serviceʼами бекенду та фронтенду є те, що конфігурація для Service фронтенда має `type: LoadBalancer`, що означає, що Service використовує балансувальник навантаження, який надається вашим хмарним провайдером, і буде доступним за межами кластера.
