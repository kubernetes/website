...
Проєкт Kubernetes Dashboard перебуває в архівованому стані і більше активно не підтримується. Для нових встановлень розгляньте можливість використання [Headlamp](https://headlamp.dev/).
{{% /pageinfo %}}
...
Dashboard дозволяє створювати та розгортати контейнеризований застосунок як Deployment та необовʼязковий Service за допомогою простого майстра. Ви можете або вручну вказати деталі застосунку, або завантажити YAML або JSON файл _маніфесту_, що містить конфігурацію застосунку.
...
- **Назва застосунку** (обовʼязково): Назва вашого застосунку. [Мітка](/docs/concepts/overview/working-with-objects/labels/) з цією назвою буде додана до Deployment та Service (якщо є), які будуть розгорнуті.
...
- **Кількість Podʼів** (обовʼязково): Кількість Podʼів, з використанням яких ви хочете розгорнути свій застосунок. Значення повинно бути позитивним цілим числом.
...
- **Service** (необовʼязково): Для деяких частин вашого застосунку (наприклад, фронтендів) ви можете захотіти експонувати [Service](/docs/concepts/services-networking/service/) на зовнішню, можливо, публічну IP-адресу за межами вашого кластера (зовнішній Service).
