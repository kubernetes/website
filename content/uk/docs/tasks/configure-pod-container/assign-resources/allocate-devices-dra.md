...
На цій сторінці показано, як призначати пристрої для ваших Podʼів за допомогою _динамічного розподілу ресурсів (DRA)_. Ці інструкції призначені для операторів робочих навантажень. Перед прочитанням цієї сторінки ознайомтеся з принципами роботи DRA та термінами, такими як {{< glossary_tooltip text="ResourceClaims" term_id="resourceclaim" >}} і {{< glossary_tooltip text="ResourceClaimTemplates" term_id="resourceclaimtemplate" >}}. Докладніше дивіться у розділі [Динамічний розподіл ресурсів (DRA)](/docs/concepts/resource-management/dynamic-resource-allocation/).
