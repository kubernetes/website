...
* **Менеджери ресурсів:** Менеджери ресурсів Topology Manager, Memory Manager та CPU Manager підтримують ресурси на рівні podʼа, коли увімкнено функціональну можливість [`PodLevelResourceManagers`](/docs/reference/command-line-tools-reference/feature-gates/#PodLevelResourceManagers). Див. [Менеджери ресурсів на рівні pod](/docs/concepts/workloads/resource-managers/#pod-level-resource-managers) для отримання додаткової інформації. Без увімкнення цього feature gate вони не вирівнюють podʼи та контейнери на основі ресурсів на рівні pod.
...
* [Менеджери ресурсів на рівні Podʼа](/docs/concepts/workloads/resource-managers/#pod-level-resource-managers)
