...
Для налаштування DeviceClass та прикладів див. [Розподіл розширених ресурсів за допомогою DRA](/docs/concepts/resource-management/dynamic-resource-allocation/dra-api/#extended-resource).
