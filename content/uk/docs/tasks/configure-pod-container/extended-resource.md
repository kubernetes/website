...
## Розширені ресурси, що підтримуються DRA {#extended-resources-backed-by-dra}

{{< feature-state feature_gate_name="DRAExtendedResource" >}}

Вправа вище використовує розширений ресурс, який оголошує вузол. Розширені ресурси також можуть підтримуватися {{< glossary_tooltip text="динамічним розподілом ресурсів" term_id="dra" >}} (DRA): DeviceClass встановлює `extendedResourceName`, і планувальник задовольняє відповідні запити розширених ресурсів за допомогою пристроїв DRA замість потужності, оголошеної вузлом.

Pod запитує ресурс однаково в обох випадках, через `resources.requests.<resource_name>`, тому робоче навантаження не повинно знати, чи надає його втулок пристрою чи DRA. Те саме імʼя ресурсу може навіть надаватися втулком пристрою на одних вузлах і DRA на інших.

Для налаштування DeviceClass та прикладів див. [Розподіл розширених ресурсів за допомогою DRA](/docs/concepts/resource-management/dynamic-resource-allocation/dra-features/#extended-resource).
