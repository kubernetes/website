...
Спостерігайте за `spec.resources` (200m CPU, 200Mi памʼяті). Зверніть увагу на `status.containerStatuses[0].restartCount` (повинно бути 0) і `status.containerStatuses[1].restartCount` (повинно бути 0).
