...
Ви можете налаштувати kubelet за допомогою [параметрів конфігурації](/uk/docs/reference/config-api/kubelet-config.v1beta1/) використовуючи [конфігураційний файл kubelet](/uk/docs/tasks/administer-cluster/kubelet-config-file/).
