...
Якщо ваш кластер використовує [Динамічний розподіл ресурсів (DRA)](/docs/concepts/resource-management/dynamic-resource-allocation/), перегляньте авторизацію синтетичних підресурсів DRA (`resourceclaims/binding` та `resourceclaims/driver`) і надайте кожному компоненту лише мінімально необхідні дієслова. Для деталей дивіться [Посібник із зміцнення безпеки — Динамічний розподіл ресурсів](/docs/concepts/security/hardening-guide/dynamic-resource-allocation/) та [Посилення безпеки динамічного розподілу ресурсів у вашому](/docs/tasks/administer-cluster/hardening-dra/).
