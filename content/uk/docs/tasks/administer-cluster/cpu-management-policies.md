---
title: Налаштування політик керування ЦП на вузлі
content_type: task
...
Окрім верхнього рівня `CPUManagerPolicyOptions`, параметри політики розділені на дві групи: якість альфа (типово прихована) та якість бета (типово видима). На відміну від стандарту Kubernetes, ці feature gate захищають групи параметрів, оскільки було б надто складно додати feature gate для кожного окремого параметра.
...
{{< note >}}
Якщо на вузлі змінюється набір доступних процесорів, то вузол необхідно вивести з експлуатації та вручну перезавантажити CPU manager, видаливши
...
* `prefer-align-cpus-by-uncorecache` (GA, типово видимий) (1.36 або вище)
...
Докладні відомості про поведінку окремих параметрів, які ви можете налаштувати, наведено у документації [Менеджери ресурсів вузлів](/docs/concepts/policy/node-resource-managers).

## {{% heading "whatsnext" %}}

* Дізнайтеся більше про [Менеджер ресурсів на рівні подів](/docs/concepts/resource-management/resource-managers/#pod-level-resource-managers).
