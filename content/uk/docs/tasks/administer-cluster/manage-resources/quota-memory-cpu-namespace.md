...
Кожен вузол у вашому кластері повинен мати принаймні 1 GiB памʼяті.
...
* Загальний запит памʼяті для всіх Podʼів у цьому просторі імен не повинен перевищувати 1 GiB.
* Загальне обмеження памʼяті для всіх Podʼів у цьому просторі імен не повинно перевищувати 2 GiB.
