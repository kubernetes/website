...
weight: 30
description: >-
  Визначте діапазон допустимих обмежень ресурсів памʼяті для простору імен, так щоб кожний новий Pod у цьому просторі імен знаходився в межах встановленого вами діапазону.
---
...
## Застосування мінімальних та максимальних обмежень памʼяті {#enforcement-of-minimum-and-maximum-memory-constraints}
