---
title: Налаштування мінімальних та максимальних обмежень CPU для простору імен
content_type: task
weight: 40
description: >
...
* Перевірте, що кожен контейнер у цьому Podʼі вказує CPU-запит, який є не меншим за 200 мілі-CPU.

* Перевірте, що кожен контейнер у цьому Podʼі вказує обмеження CPU, яке є не більшим за 800 мілі-CPU.
...
800 мілі-CPU. Це задовольняє обмеження, накладені LimitRange.
...
Тому що цей контейнер не вказав свій власний запит CPU та обмеження, панель управління застосовує [типові обмеження та запит CPU](/docs/tasks/administer-cluster/manage-resources/cpu-default-namespace/) з LimitRange для цього простору імен.
