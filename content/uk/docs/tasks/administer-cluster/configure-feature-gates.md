...
{{< note >}}
Загальнодоступні функції (GA) є завжди стандартно увімкненими. Зазвичай ви налаштовуєте можливості для функцій Alpha або Beta.
{{< /note >}}

<!-- steps -->

## Розуміння рівня зрілості функціональних можливостей {#understand-feature-gate-maturity}
...
### Перевірка маніфестів компонентів панелі управління {#check-control-plane-component-manifests}
