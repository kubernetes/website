...
1. Завантажте, розпакуйте та ініціалізуйте виправлену версію `easyrsa3`.
...
9. Додайте наступні параметри до параметрів запуску сервера API:
...
2. Створіть теку для зберігання артефактів та ініціалізації cfssl:
