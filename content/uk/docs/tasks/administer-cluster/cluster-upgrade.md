...
{{< caution >}}
Ці кроки не враховують сторонніх розширень, таких як мережеві втулки та втулки сховищ.
{{< /caution >}}
...
{{< caution >}}
Виснаження вузлів перед оновленням kubelet забезпечує повторний вхід Podʼів та перезапуск контейнерів, що може бути необхідно для розвʼязання деяких проблем безпеки або інших важливих помилок.
{{</ caution >}}
