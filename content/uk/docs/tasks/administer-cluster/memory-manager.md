...
Щоб вирівняти ресурси памʼяті з іншими запитуваними ресурсами в специфікації Podʼа:
...
Ви можете пропустити цей параметр, однак слід памʼятати, що обсяг зарезервованої памʼяті з усіх вузлів NUMA повинен дорівнювати обсягу памʼяті, яку можна _розподілити між вузлами_.
