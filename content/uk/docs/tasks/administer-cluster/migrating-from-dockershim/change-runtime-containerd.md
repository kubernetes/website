...
Відредагуйте файл `/var/lib/kubelet/kubeadm-flags.env` та додайте containerd як середовище виконання контейнерів до прапорців; `--container-runtime-endpoint=unix:///run/containerd/containerd.sock`.
