...
Це обмеження застосовується лише до kubelet (ідентичності вузлів) і не впливає на інших виконавців API `TokenRequest`. Для деталей та прикладів RBAC див. [Обмеження аудиторії токенів службового облікового запису](/docs/reference/access-authn-authz/node/#service-account-token-audience-restriction).
