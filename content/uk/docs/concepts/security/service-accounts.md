...
- **Привʼязані до простору імен:** Кожен службовий обліковий запис привʼязаний до {{<glossary_tooltip text="простору імен" term_id="namespace">}} Kubernetes. Кожен простір імен отримує [`default` ServiceAccount](#default-service-accounts) при створенні.
