...
Ізоляцію вузлів можна реалізувати за допомогою [селекторів вузла Podʼу](/docs/concepts/scheduling-eviction/assign-pod-node/) або [Virtual Kubelet](https://github.com/virtual-kubelet).
...
[API Priority and Fairness](/docs/concepts/cluster-administration/flow-control/) — це
