...
<!-- overview -->
{{< glossary_tooltip text="Планувальник" term_id="kube-scheduler" >}} у Kubernetes є одним з критично важливих компонентів {{< glossary_tooltip text="панелі управління" term_id="control-plane" >}}.
