...
На вузлах Linux томи з підтримкою памʼяті (наприклад, монтування томів [`secret`](/docs/concepts/configuration/secret/) або [`emptyDir`](/docs/concepts/storage/volumes/#emptydir) з `medium: Memory`) реалізовано за допомогою файлової системи `tmpfs`.
