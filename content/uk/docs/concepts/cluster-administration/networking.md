...
Мережі є центральною частиною Kubernetes, але часто важко зрозуміти, як саме вони мають працювати. Існують 4 відмінні мережеві проблеми, які потрібно вирішити:
...
2. Взаємодія між Podʼами: це основна мета даного документа.
...
- IPv4/IPv6 або IPv6/IPv4 [подвійний стек](/docs/concepts/services-networking/dual-stack/):
  ...
  - Усі компоненти повинні узгоджуватися щодо налаштованого основного типу IP адрес.
