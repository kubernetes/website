...
{{< caution >}}
Пакунки `unattended-upgrades` з Debian конфліктують з належним вимкненням вузла у своїй стандартній конфігурації. Якщо ви використовуєте стандартну конфігурацію `unattended-upgrades`, яка налаштовує період очікування завершення роботи сервера, kubelet не зможе отримати необхідний механізм блокування для правильної обробки подій вимкнення.
