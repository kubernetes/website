...
Ці різні методи підходять для різних способів моделювання даних, які споживаються. Для перших трьох методів {{< glossary_tooltip text="kubelet" term_id="kubelet" >}} використовує дані з ConfigMap при запуску контейнер(ів) для Podʼа.
