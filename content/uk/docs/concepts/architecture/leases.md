...
Прочитайте [координовані вибори лідера](/uk/docs/concepts/cluster-administration/coordinated-leader-election), щоб дізнатися про те, як Kubernetes використовує Lease API для вибору екземпляра компонента, який буде виконувати роль лідера.
...
Ви можете вимкнути лізинги ідентичності API сервера, вимкнувши [функціональну можливість](/uk/docs/reference/command-line-tools-reference/feature-gates/) `APIServerIdentity`.
