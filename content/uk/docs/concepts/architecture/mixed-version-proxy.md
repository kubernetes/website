...
* Якщо API-сервер обробки визначив і вибрав API-сервер-партнера, але цей партнер не відповідає (через проблеми з підключенням до мережі або гонитвою даних між отриманим запитом і контролером, що реєструє інформацію про партнера в панелі управління), API-сервер обробки відповідає помилкою 503 («Service Unavailable»).
