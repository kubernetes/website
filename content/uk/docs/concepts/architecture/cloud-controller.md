...
Cloud-controller-manager структурується за допомогою механізму втулків, який дозволяє різним постачальникам хмар інтегрувати свої платформи з Kubernetes.
...
Менеджер контролера хмар працює в панелі управління як реплікований набір процесів (зазвичай це контейнери в Podʼах). Кожен cloud-controller-manager реалізує кілька {{< glossary_tooltip text="контролерів" term_id="controller" >}} в одному процесі.
...
Контролер Node відповідає за оновлення обʼєктів {{< glossary_tooltip text="Node" term_id="node" >}} при створенні нових серверів у вашій хмарній інфраструктурі. Контролер Node отримує інформацію про хости, які працюють у вашому обліковому записі у хмарному провайдері. Контролер Node виконує наступні функції:
