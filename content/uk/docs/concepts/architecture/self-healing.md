...
feature:
  ...
  description: >
    Kubernetes перезапускає контейнери, що зазнали збою, за потреби замінює цілі Podʼи, повторно підключає системи зберігання даних у разі масштабних збоїв, а також може інтегруватися з механізмами автоматичного масштабування вузлів для самовідновлення навіть на рівні вузлів.
---
<!-- overview -->
...
- **Контролери Deployment (через ReplicaSet), ReplicaSet, StatefulSet і DaemonSet:** Підтримують бажану кількість реплік Podʼа.
...
- Читайте про [автомасштабування вузлів](/docs/concepts/cluster-administration/node-autoscaling/). Автомасштабування вузлів також забезпечує автоматичне відновлення, якщо вузли виходять з ладу у вашому кластері.
