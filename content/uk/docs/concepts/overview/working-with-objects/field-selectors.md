...
_Селектори полів_ дозволяють вам вибирати {{< glossary_tooltip text="обʼєкти" term_id="object" >}} Kubernetes на основі значень одного або кількох полів ресурсу. Ось кілька прикладів запитань для селекторів полів:
...
{{< note >}}
Селектори полів, по суті, є _фільтрами_ ресурсів. Типово селектори/фільтри не застосовуються, а це означає, що вибрані всі ресурси вказаного типу. Це робить запити `kubectl get pods` та `kubectl get pods --field-selector ""` еквівалентними.
{{< /note >}}
