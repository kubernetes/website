...
Ви можете використовувати завершувачі для управління {{<glossary_tooltip text="збиранням сміття" term_id="garbage-collection">}} з {{< glossary_tooltip text="обʼєктів" term_id="object" >}} сповіщаючи {{<glossary_tooltip text="контролери" term_id="controller">}} про необхідність виконання певних завдань з очищення перед видаленням цільового ресурсу.
...
## Посилання на власників, мітки та завершувачі {#owners-labels-finalizers}
