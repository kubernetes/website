...
Опція `percentageOfNodesToScore` приймає цілі числові значення від 0 до 100. Значення 0 є спеціальним числом, яке позначає, що kube-scheduler повинен використовувати типове вбудоване значення. Якщо ви встановлюєте `percentageOfNodesToScore` більше 100, kube-scheduler діє так, ніби ви встановили значення 100.
...
{{< note >}}
У кластерах з менш ніж 100 відповідними вузлами планувальник все ще перевіряє всі вузли, тому що недостатньо відповідних вузлів для того, щоб рано зупинити пошук планувальника.
...
При плануванні великих робочих навантажень Podʼи часто мають еквівалентні обмеження планування та вимагають від планувальника виконання одних і тих же операцій знову і знову. Функція [Opportunistic Batching](/docs/reference/command-line-tools-reference/feature-gates/#OpportunisticBatching) дозволяє планувальнику повторно використовувати результати фільтрації та оцінювання між циклами планування, що значно прискорює процес планування.

Завдяки повторній оцінці планувальник може продовжувати пакетну обробку в такій ситуації. Коли наступний Pod все ще може розміститися на раніше обраному вузлі, планувальник оновлює бал цього вузла та повертає його до кешованого списку кандидатів. Якщо повторна оцінка не вдається, планувальник повертається до наявної поведінки та очищає кеш.
...
1. Не запитують розширені ресурси, які підтримуються DRA
...
1. Встановити `IgnorePreferredTermsOfExistingPods` [InterPodAffinityArgs](/docs/reference/config-api/kube-scheduler-config.v1/#kubescheduler-config-k8s-io-v1-InterPodAffinityArgs) на `true`, щоб зробити пакетну обробку більш ефективною
