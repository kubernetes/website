...
У Kubernetes _планування_ означає забезпечення того, що {{< glossary_tooltip text="Podʼи" term_id="pod" >}} призначаються відповідним {{< glossary_tooltip text="вузлам" term_id="node" >}}, щоб їх можна було запустити за допомогою {{< glossary_tooltip term_id="kubelet" >}}.
