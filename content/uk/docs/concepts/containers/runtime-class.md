...
Кожна конфігурація, налаштована на кроці 1, повинна мати асоційований `handler`, який ідентифікує конфігурацію. Для кожного handler створіть обʼєкт RuntimeClass.
...
### Накладні витрати Podʼів {#pod-overhead}

{{< feature-state for_k8s_version="v1.24" state="stable" >}}

Ви можете вказати ресурси _overhead_, що повʼязані із запуском Pod. Вказівка накладних витрат дозволяє кластеру (включаючи планувальник) враховувати це при прийнятті рішень про Podʼи та ресурси.

Накладні витрати Podʼа визначаються через поле `overhead` в RuntimeClass. За допомогою цього поля ви можете вказати накладні витрати запуску Podʼів, що використовують цей RuntimeClass, та забезпечити облік цих накладних витрат в Kubernetes.
...
- {{< api-reference page="node/runtime-class-v1" text="Довідник RuntimeClass API" >}}
- Читайте про концепцію [накладних витрат, повʼязаних з роботою Podʼів](/docs/concepts/scheduling-eviction/pod-overhead/)
