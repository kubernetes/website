...
Починаючи з Kubernetes 1.27, kubelet переводить видалені Podʼи в термінальну фазу (`Failed` або `Succeeded` залежно від статусів завершення ролботи контейнерів Podʼа) перед їх видаленням з сервера API, за винятком двох випадків:
