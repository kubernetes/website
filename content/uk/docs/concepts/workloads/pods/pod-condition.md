...
4. `ContainersReady`: всі контейнери в Podʼі готові. Готовність контейнера визначається його [пробою готовності](/docs/concepts/configuration/liveness-readiness-startup-probes/), якщо вона налаштована.
...
- Дізнайтесь про [Проби контейнерів](/docs/concepts/configuration/liveness-readiness-startup-probes/) та як вони впливають на готовність Pod.
