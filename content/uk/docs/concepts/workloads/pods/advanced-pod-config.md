...
Для отримання додаткової інформації див. [Пріоритет і витіснення Podʼів](/docs/concepts/scheduling-eviction/pod-priority-preemption/).
...
#### Приклад Podʼа {#pod-level-security-context-example}
...
- Прочитайте про [Пріоритет і витіснення Podʼів](/docs/concepts/scheduling-eviction/pod-priority-preemption/)
