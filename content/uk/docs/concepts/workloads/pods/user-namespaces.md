...
* Кількість допоміжних ID повинна бути кратною 65536. (для Kubernetes {{< skew currentVersion >}} кількість підпорядкованих ідентифікаторів для кожного Pod жорстко закодовано до 65536).
