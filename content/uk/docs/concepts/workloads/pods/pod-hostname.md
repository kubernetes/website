...
Ця сторінка пояснює, як встановити імʼя хосту Podʼа, можливі побічні ефекти після налаштування та механізми, що лежать в основі.
...
## Імʼя хосту з полями hostname та subdomain Podʼа {#hostname-with-pods-hostname-and-subdomain-fields}
...
## Імʼя хосту з полем setHostnameAsFQDN Podʼа {#hostname-with-pods-sethostnameasfqdn-fields}
...
## Імʼя хосту з полем hostnameOverride Podʼа {#hostname-with-pods-hostnameoverride}
