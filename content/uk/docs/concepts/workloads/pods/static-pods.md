...
Специфікація статичного Podʼа не може посилатися на інші об'єкти API, такі як {{< glossary_tooltip text="ServiceAccount" term_id="service-account" >}}, {{< glossary_tooltip text="ConfigMap" term_id="configmap" >}}, або {{< glossary_tooltip text="Secret" term_id="secret" >}}.
