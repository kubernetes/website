...
## Приклад бюджету розладів пода {#pdb-example}
...
## Умови розладу пода {#pod-disruption-conditions}
...
: Pod має бути {{<glossary_tooltip term_id="preemption" text="витіснений">}} планувальником для надання місця новому Podʼа з вищим пріоритетом. Докладніше дивіться [Витіснення за пріоритетом Podʼа](/docs/concepts/scheduling-eviction/pod-priority-preemption/).
...
- Розробляти застосунки, що терплять розлади, і використовувати бюджети розладу Podʼів.
  ...
  - Написання застосунків, що терплять розлади, складне, але робота з підтримкою добровільних розладів в основному збігається з роботою з підтримкою автомасштабування і толеруючи інші типи розладів.
