...
Якщо вам потрібно змінити селектор, вам доведеться видалити Deployment і створити його заново. Будьте дуже обережні та переконайтеся, що ви розумієте наступні наслідки:
