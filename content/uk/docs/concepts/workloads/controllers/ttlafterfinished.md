...
{{<glossary_tooltip text="Контролер" term_id="controller">}} часу життя Kubernetes після завершення забезпечує механізм TTL (time to live), щоб обмежити термін життя обʼєктів задачі, які завершили виконання.
