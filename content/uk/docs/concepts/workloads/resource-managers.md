...
Зауважте, що коли стандартні init-контейнери завершують виконання, їхні ресурси додаються до повторно використовуваного набору на рівні пода, а не повертаються до пулу ресурсів вузла. Оскільки вони виконуються послідовно, ці ресурси стають повторно використовуваними для наступних контейнерів застосунків (або для їхніх власних ексклюзивних sliceʼів, або для спільного пулу).
