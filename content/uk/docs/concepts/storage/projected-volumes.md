...
У цьому документі описано _проєкційні томи_ в Kubernetes. Рекомендується ознайомитися з [томами](/docs/concepts/storage/volumes/) для кращого розуміння.
...
Зараз наступні типи джерел томів можуть бути проєкційні:
...
## Проєкційні томи clusterTrustBundle {#clustertrustbundle}
...
Проєкційний том `clusterTrustBundle` робить інʼєкцію вмісту одного чи більше обʼєктів [ClusterTrustBundle](/docs/reference/access-authn-authz/certificate-signing-requests/#cluster-trust-bundles) як автоматично оновлюваний файл у файловій системі контейнера.
