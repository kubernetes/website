...
{{< note >}}
Ingress заморожений. Нові функції додаються до [Gateway API](/docs/concepts/services-networking/gateway/).
{{< /note >}}
...
Можливо, вам доведеться розгорнути контролер Ingress, такий як [ingress-nginx](https://kubernetes.github.io/ingress-nginx/deploy/). Ви можете вибрати з-поміж [контролерів Ingress](/docs/concepts/services-networking/ingress-controllers).
