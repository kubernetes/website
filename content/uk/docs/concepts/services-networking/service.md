...
Два додаткових значення доступні, якщо увімкнено `PreferSameTrafficDistribution` [функціональну можливість](/docs/reference/command-line-tools-reference/feature-gates/):
