...
* [Контролер Ingress HAProxy для Kubernetes](https://github.com/haproxytech/kubernetes-ingress#readme) — це контролер Ingress для [HAProxy](https://www.haproxy.org/#desc).
...
* [N42 Gateway](https://n42-gateway.github.io/) — це контролер Ingress та Gateway API для [HAProxy](https://www.haproxy.org/#desc).
