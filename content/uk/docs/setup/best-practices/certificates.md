...
На додачу до цих ЦС також необхідно отримати пару ключ/сертифікат для управління служюовими обліковими записами, `sa.key` та `sa.pub`. Наведений нижче приклад ілюструє файли ключа та сертифіката ЦС, показані в попередній таблиці:
