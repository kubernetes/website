...
- [Red Hat CodeReady Containers (CRC)](https://developers.redhat.com/products/openshift-local) запускає мінімальний кластер OpenShift локально (OpenShift є сумісним з Kubernetes)
