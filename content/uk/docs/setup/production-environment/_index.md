...
- *Автомасштабування вузлів*: Ознайомтесь з [Автомасштабуванням кластера](/docs/concepts/cluster-administration/cluster-autoscaling), щоб дізнатись про інструменти доступні для автоматизованого керування вашими вузлами та ресурсами, які вони надають.
