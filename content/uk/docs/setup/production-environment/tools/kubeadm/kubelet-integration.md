...
Якщо ви хочете внести зміни, ви можете створити теку `/etc/systemd/system/kubelet.service.d/` (зверніть увагу, не `/usr/lib/systemd/system/kubelet.service.d/`) та внести власні налаштування у файл там. Наприклад, ви можете додати новий локальний файл `/etc/systemd/system/kubelet.service.d/local-overrides.conf` для того, щоб перевизначити налаштування елементів в `kubeadm`.
