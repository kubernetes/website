...
Щоб перегенерувати кожен набір довідки для релізу та подати результат як pull request-и, дивіться [Генерація довідкової документації для релізу](/docs/contribute/generate-ref-docs/release-generation/).
