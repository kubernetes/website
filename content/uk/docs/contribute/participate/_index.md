...
SIG Docs є однією з [робочих груп](https://github.com/kubernetes/community/blob/main/sig-list.md) в проєкті Kubernetes, яка зосереджена на написанні, оновленні та підтримці документації для Kubernetes в цілому. Дивіться [SIG Docs в репозиторії спільноти GitHub](https://github.com/kubernetes/community/tree/main/sig-docs) для отримання додаткової інформації про SIG.
...
Щоб дізнатися більше про участь у SIG Docs, дивіться:

- [Ролі та обовʼязки](/docs/contribute/participate/roles-and-responsibilities/)
- [Відповідальні за тікети](/docs/contribute/participate/issue-wrangler/)
- [Відповідальні за PR](/docs/contribute/participate/pr-wranglers/)
