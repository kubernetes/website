...
{{< table caption = "Як робити та не робити — Використовуйте першу велику літеру для фаз підвищення рівня вдосконалення" >}}
Рекомендовано | Небажано
:--| :-----
Dynamic Resource Allocation (DRA) тепер в Beta. | Dynamic Resource Allocation (DRA) тепер в beta.
{{< /table >}}
