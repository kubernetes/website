...
Ви також можете знайти корисним [фреймворк документації Diátaxis](https://diataxis.fr/) як довідковий матеріал для написання кожного з цих типів контенту сторінок.
...
- У розділі `overview` використовуйте абзац для встановлення контексту для всієї теми. Коротко поясніть, чому читач може захотіти виконати це завдання (мотивація або випадок використання), щоб читач міг вирішити, чи є сторінка для нього релевантною перед ознайомленням з подальшими кроками.
...
- У розділі `steps` використовуйте пронумеровані списки. Зосередьтеся на самому завданні. Якщо крок вимагає значного розуміння, додайте посилання на відповідну концептуальну сторінку замість повторення пояснення тут.
