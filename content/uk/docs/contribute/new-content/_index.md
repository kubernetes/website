...
Усі учасники Kubernetes **повинні** ознайомитись з [Настановами для учасників](https://github.com/kubernetes/community/blob/main/contributors/guide/README.md) та [підписати Угоду про ліцензування внесків (CLA, Contributor License Agreement)](https://github.com/kubernetes/community/blob/main/CLA.md).
