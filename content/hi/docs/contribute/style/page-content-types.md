...
कुबेरनेट्स दस्तावेज़ कई प्रकार की पृष्ठ सामग्री का पालन करता है:
...
पृष्ठ कुबेरनेट्स डिप्लॉयमेंट ऑब्जेक्ट का वर्णन कर सकता है और उस भूमिका की व्याख्या कर सकता है
जो यह एक एप्लिकेशन के रूप में निभाता है जब इसे डिप्लॉयमेंट, स्केल और अपडेट किया जाता है। आमतौर पर, अवधारणा
पृष्ठों में चरणों के अनुक्रम शामिल नहीं होते हैं, बल्कि इसके बजाय कार्यों या
ट्यूटोरियल के लिंक प्रदान करते हैं।

एक नया अवधारणा पृष्ठ लिखने के लिए, `/content/en/docs/concepts` निर्देशिका की एक सबडायरेक्टरी में
...
एक नया कार्य पृष्ठ लिखने के लिए, `/content/en/docs/tasks` निर्देशिका की एक सबडायरेक्टरी में
एक Markdown फ़ाइल बनाएँ, जिसमें निम्नलिखित विशेषताएँ हों:
...
- `prerequisites` के लिए, जब संभव हो बुलेट सूचियों का उपयोग करें। `include` के नीचे अतिरिक्त
  पूर्वापेक्षाएँ जोड़ना शुरू करें। डिफ़ॉल्ट पूर्वापेक्षाओं में एक चालू कुबेरनेट्स क्लस्टर शामिल है।
...
एक प्रकाशित कार्य विषय का उदाहरण [कुबेरनेट्स API तक पहुँचने के लिए HTTP प्रॉक्सी का उपयोग करना](/docs/tasks/extend-kubernetes/http-proxy-access-api/) है।
...
कोड नमूने का पूर्वाभ्यास प्रदान कर सकता है जो कुबेरनेट्स की एक निश्चित विशेषता को दर्शाता है। ट्यूटोरियल में
सतही स्तर की व्याख्याएँ शामिल हो सकती हैं, लेकिन गहरी व्याख्याओं के लिए संबंधित अवधारणा विषयों
से लिंक करना चाहिए।

एक नया ट्यूटोरियल पृष्ठ लिखने के लिए, `/content/en/docs/tutorials` निर्देशिका की एक सबडायरेक्टरी में
एक Markdown फ़ाइल बनाएँ, जिसमें निम्नलिखित विशेषताएँ हों:
...
एक घटक उपकरण संदर्भ पृष्ठ एक कुबेरनेट्स घटक उपकरण के लिए वर्णन और फ्लैग विकल्प आउटपुट दिखाता है।
