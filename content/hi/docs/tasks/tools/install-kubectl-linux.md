...
{{% tab name="Snap" %}}
यदि आप उबंटू या किसी अन्य Linux वितरण पर हैं जो [snap](https://snapcraft.io/docs/core/install) पैकेज मैनेजर को सपोर्ट करता है, kubectl [snap](https://snapcraft.io/) एप्लिकेशन के रूप में उपलब्ध है.
