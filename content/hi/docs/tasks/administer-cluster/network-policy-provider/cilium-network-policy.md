...
<!-- steps -->
## बेसिक टेस्टिंग के लिए Minikube पर Cilium को डिप्लॉय करना {#deploying-cilium-on-minikube-for-basic-testing}
...
## प्रोडक्शन उपयोग के लिए Cilium को डिप्लॉय करना  {#deployment-cilium-for-production-use}
...
<!-- discussion -->
## Cilium कॉम्पोनेंट्स को समझना  {#understanding-cilium-components}
