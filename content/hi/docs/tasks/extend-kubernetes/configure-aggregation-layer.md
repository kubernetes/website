...
### एक्सटेंशन Apiserver अनुरोध को प्रमाणित करता है {#extension-apiserver-authenticates-the-request}
...
### एक्सटेंशन Apiserver अनुरोध को प्राधिकृत करता है {#extension-apiserver-authorizes-the-request}

एक्सटेंशन apiserver अब यह सत्यापित कर सकता है कि हेडर से पुनर्प्राप्त उपयोगकर्ता/समूह दिए गए अनुरोध को निष्पादित करने के लिए प्राधिकृत हैं। यह कुबेरनेट्स apiserver को एक मानक [SubjectAccessReview](/docs/reference/access-authn-authz/authorization/) अनुरोध भेजकर ऐसा करता है।
...
### एक्सटेंशन Apiserver निष्पादित करता है {#extension-apiserver-executes}

यदि `SubjectAccessReview` पास हो जाता है, तो एक्सटेंशन apiserver अनुरोध को निष्पादित करता है।

## कुबेरनेट्स Apiserver फ्लैग सक्षम करें {#enable-kubernetes-apiserver-flags}
...
* `--client-ca-file`: जब कुबेरनेट्स apiserver पर एक अनुरोध आता है, यदि यह विकल्प सक्षम है, तो कुबेरनेट्स apiserver अनुरोध के सर्टिफिकेट की जांच करता है। यदि यह `--client-ca-file` द्वारा संदर्भित फ़ाइल में CA सर्टिफिकेट में से एक द्वारा साइन किया गया है, तो अनुरोध को वैध माना जाता है, और उपयोगकर्ता कॉमन नेम `CN=` का मान है, जबकि समूह संगठन `O=` है। [TLS प्रमाणीकरण पर दस्तावेज़ीकरण](/docs/reference/access-authn-authz/authentication/#x509-client-certificates) देखें।
...
एक APIService ऑब्जेक्ट का नाम एक वैध [पथ सेगमेंट नाम](/docs/concepts/overview/working-with-objects/names#path-segment-names) होना चाहिए।

#### एक्सटेंशन apiserver से संपर्क करना {#contacting-the-extension-apiserver}
