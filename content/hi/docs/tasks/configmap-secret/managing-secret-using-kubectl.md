...
यह पेज आपको `kubectl` कमांड-लाइन टूल का उपयोग करके कुबेरनेट्स {{<glossary_tooltip text="सीक्रेट" term_id="secret">}} को कैसे बनाने, संपादित करने, प्रबंधित करने और हटाने का तरीका दिखाता है।
...
1. क्रेडेंशियल्स को फाइलों में संग्रह करें:
...
1. `password` डेटा को डिकोड करें:
   ...
   यह विधि एनकोडेड डेटा के साथ कमांड को आपके शेल इतिहास में संग्रह कर सकती है। आपके कंप्यूटर तक पहुंच रखने वाला कोई भी व्यक्ति कमांड को ढूंढ सकता है और सीक्रेट को डिकोड कर सकता है। एक बेहतर दृष्टिकोण व्यू और डिकोड कमांड को संयोजित करना है।
   {{< /caution >}}
...
आप एक मौजूदा सीक्रेट ऑब्जेक्ट को संपादित कर सकते हैं जब तक कि वह [अपरिवर्तनीय](/docs/concepts/configuration/secret/#secret-immutable) नहीं है। सीक्रेट को संपादित करने के लिए, निम्नलिखित कमांड चलाएं:
