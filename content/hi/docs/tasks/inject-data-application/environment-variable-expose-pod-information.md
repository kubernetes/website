...
यह पृष्ठ दिखाता है कि एक पॉड कैसे एनवायरनमेंट वेरिएबल्स का उपयोग कर सकता है अपने कंटेनरों को खुद की जानकारी प्रदान करने के लिए, _डाउनवर्ड API_ का उपयोग करके। आप एनवायरनमेंट वेरिएबल्स का उपयोग पॉड फ़ील्ड्स, कंटेनर फ़ील्ड्स, या दोनों को एक्सपोज़ करने के लिए कर सकते हैं।

कुबेरनेट्स में, एक चल रहे कंटेनर को पॉड और कंटेनर फ़ील्ड्स एक्सपोज़ करने के दो तरीके हैं:

* एनवायरनमेंट वेरिएबल्स, जैसा कि इस कार्य में समझाया गया है
* [वॉल्यूम फ़ाइलें](/docs/tasks/inject-data-application/downward-api-volume-expose-pod-information/)

ये दोनों तरीके मिलकर पॉड और कंटेनर फ़ील्ड्स को एक्सपोज़ करने के लिए डाउनवर्ड एपीआई कहलाते हैं।

चूँकि सर्विसेज़ कुबेरनेट्स द्वारा प्रबंधित कंटेनरयुक्त अनुप्रयोगों के बीच संचार का प्राथमिक तरीका हैं,
रनटाइम पर उन्हें खोजने में सक्षम होना उपयोगी है।
सर्विसेज़ तक पहुँचने के बारे में अधिक पढ़ें [यहाँ](/docs/tutorials/services/connect-applications-service/#accessing-the-service)।
...
एरे का पहला तत्व निर्दिष्ट करता है कि `MY_NODE_NAME` एनवायरनमेंट
...
* उन  [उपलब्ध फ़ील्ड्स](/docs/concepts/workloads/pods/downward-api/#available-fields) की सूची पढ़ें जिन्हें आप डाउनवर्ड एपीआई का उपयोग करके एक्सपोज़ कर सकते हैं।
