...
यह पृष्ठ दिखाता है कि कुबेरनेट्स पॉड में किसी कंटेनर के लिए एनवायरनमेंट वेरिएबल्स कैसे परिभाषित करें।
...
## कंटेनर के लिए एक एनवायरनमेंट वेरिएबल परिभाषित करें {#define-an-environment-variable-for-a-container}

जब आप एक पॉड बनाते हैं, तो आप उस पॉड में चलने वाले कंटेनरों के लिए एनवायरनमेंट वेरिएबल्स सेट कर सकते हैं।
...
`envFrom`
: आपको एक कॉनफिगमैप या सीक्रेट का संदर्भ देकर कंटेनर के लिए एनवायरनमेंट वेरिएबल्स सेट करने की अनुमति देता है।
जब आप `envFrom` का उपयोग करते हैं, तो संदर्भित कॉनफिगमैप या सीक्रेट में मौजूद सभी की-वैल्यू जोड़े कंटेनर के लिए एनवायरनमेंट वेरिएबल्स के रूप में सेट हो जाते हैं।
आप एक सामान्य प्रीफ़िक्स स्ट्रिंग भी निर्दिष्ट कर सकते हैं।

आप [कॉनफिगमैप](/docs/tasks/configure-pod-container/configure-pod-configmap/#configure-all-key-value-pairs-in-a-configmap-as-container-environment-variables)
और [सीक्रेट](/docs/tasks/inject-data-application/distribute-credentials-secure/#configure-all-key-value-pairs-in-a-secret-as-container-environment-variables) के बारे में अधिक पढ़ सकते हैं।

यह पृष्ठ आपको `env` का उपयोग करना सिखाता है।

इस अभ्यास में, आप एक ऐसा पॉड बनाएँगे जिसमें एक कंटेनर चलता है।
पॉड के लिए कॉन्फ़िगरेशन फ़ाइल में `DEMO_GREETING` नामक एनवायरनमेंट वेरिएबल और `"Hello from the environment"` मान परिभाषित किया गया है।
यह रहा पॉड के लिए कॉन्फ़िगरेशन मैनिफ़ेस्ट:

{{% code_sample file="pods/inject/envars.yaml" %}}

1. उस मैनिफ़ेस्ट के आधार पर एक पॉड बनाएँ:
...
3. पॉड के कंटेनर के एनवायरनमेंट वेरिएबल्स की सूची देखें:
...
{{< note >}}
एनवायरनमेंट वेरिएबल्स एक-दूसरे का संदर्भ दे सकते हैं, लेकिन क्रम महत्वपूर्ण होता है।  
जो वेरिएबल्स दूसरों का उपयोग करते हैं, उन्हें सूची में बाद में आना चाहिए।  
इसी तरह, सर्कुलर रेफरेंस से बचें।
{{< /note >}}

## अपने कॉन्फ़िग में एनवायरनमेंट वेरिएबल्स का उपयोग करना {#using-environment-variables-inside-of-your-config}

पॉड के कॉन्फ़िगरेशन में `.spec.containers[*].env[*]` के अंतर्गत परिभाषित किए गए  
एनवायरनमेंट वेरिएबल्स का उपयोग कॉन्फ़िगरेशन के अन्य हिस्सों में भी किया जा सकता है,  
उदाहरण के लिए, उन कमांड्स और आर्ग्युमेंट्स में जो आप पॉड के कंटेनरों के लिए सेट करते हैं।
