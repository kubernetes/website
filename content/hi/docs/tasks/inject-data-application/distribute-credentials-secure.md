...
## एक सीक्रेट बनाएँ {#create-a-Secret}
...
तो आप उसी सीक्रेट को `kubectl create secret` कमांड का उपयोग करके बना सकते हैं। उदाहरण के लिए:
...
- उस सीक्रेट ऑब्जेक्ट की `password` कुंजी प्रोजेक्ट नहीं की जाती है।
...
### सीक्रेट कुंजियों के लिए POSIX अनुमतियाँ सेट करें {#set-POSIX-permissions-for-secret-keys}
...
सीक्रेट `/etc/foo` पर माउंट किया गया है;
सीक्रेट वॉल्यूम माउंट द्वारा बनाई गई सभी फ़ाइलों की अनुमति `0400` होगी।
...
## सीक्रेट डेटा का उपयोग करके कंटेनर एनवायरनमेंट वेरिएबल परिभाषित करें {#define-container-environment-variables-using-Secret-data}
...
तो सीक्रेट अपडेट कंटेनर द्वारा तब तक नहीं देखा जाएगा जब तक कि कंटेनर को पुनः प्रारंभ न किया जाए। ऐसे कई थर्ड पार्टी समाधान उपलब्ध हैं जो सीक्रेट बदलने पर कंटेनर को पुनः प्रारंभ करते हैं।

### किसी एक सीक्रेट से डेटा के साथ कंटेनर एनवायरनमेंट वेरिएबल परिभाषित करें {#define-a-container-environment-variable-with-data-from-a-single-Secret}

- सीक्रेट में की-वैल्यू जोड़े के रूप में एक एनवायरनमेंट वेरिएबल परिभाषित करें:
  
  ```shell
  kubectl create secret generic backend-user --from-literal=backend-username='backend-admin'
  ```
- पॉड विनिर्देशन में `SECRET_USERNAME` नामक एनवायरनमेंट वेरिएबल को
...
### एक से अधिक सीक्रेट्स के डेटा से कंटेनर एनवायरनमेंट वेरिएबल्स परिभाषित करें {#define-container-environment-variables-with-data-from-multiple-Secrets}
...
## सीक्रेट के सभी की-वैल्यू जोड़ों को कंटेनर एनवायरनमेंट वेरिएबल्स के रूप में कॉन्फ़िगर करें {#configure-all-key-value-pairs-in-a-Secret-as-container-environment-variables}

{{< note >}}
यह सुविधा Kubernetes v1.6 और बाद के संस्करणों में उपलब्ध है।
{{< /note >}}

- कई की-वैल्यू जोड़ों के साथ सीक्रेट बनाएं:
...
सीक्रेट में जो की है वह पॉड में एनवायरनमेंट वेरिएबल्स का नाम बन जाता है।
...
## उदाहरण: सीक्रेट्स का उपयोग करके प्रॉड/टेस्ट क्रेडेंशियल्स को पॉड्स में उपलब्ध कराना {#provide-prod-test-creds}
...
3. पॉड manifests बनाएं:
   ...
   {{< note >}}
   दोनों पॉड्स के विनिर्देश केवल एक फ़ील्ड में भिन्न होते हैं; यह एक सामान्य पॉड टेम्पलेट से विभिन्न क्षमताओं वाले पॉड्स बनाना आसान बनाता है।
   {{< /note >}}
