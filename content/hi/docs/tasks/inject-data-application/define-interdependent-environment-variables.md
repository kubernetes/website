---
title: आश्रित एनवायरनमेंट वेरिएबल्स परिभाषित करें
content_type: task
weight: 20
---
...
यह पृष्ठ दिखाता है कि Kubernetes पॉड में किसी कंटेनर के लिए आश्रित (dependent) एनवायरनमेंट वेरिएबल्स कैसे परिभाषित करें।
...
## कंटेनर के लिए एक आश्रित एनवायरनमेंट वेरिएबल परिभाषित करें

जब आप एक Pod बनाते हैं, तो आप उसमें चलने वाले कंटेनरों के लिए आश्रित एनवायरनमेंट वेरिएबल्स सेट कर सकते हैं।आश्रित एनवायरनमेंट वेरिएबल्स सेट करने के लिए, आप कॉन्फ़िगरेशन फ़ाइल में `env` की `value` में $(VAR_NAME) का उपयोग कर सकते हैं।

इस अभ्यास में, आप एक ऐसा Pod बनाएंगे जो एक कंटेनर चलाता है।  
Pod के लिए कॉन्फ़िगरेशन फ़ाइल एक सामान्य उपयोग के साथ आश्रित एनवायरनमेंट वेरिएबल परिभाषित करती है।  
Pod के लिए कॉन्फ़िगरेशन मैनिफेस्ट इस प्रकार है:

{{% code_sample file="pods/inject/dependent-envars.yaml" %}}

1. उस मैनिफेस्ट के आधार पर एक Pod बनाएँ:
...
3. अपने Pod में चल रहे कंटेनर के लॉग्स देखें:
...
ध्यान दें कि `env` सूची में क्रम (order) महत्वपूर्ण होता है।
अगर कोई वेरिएबल सूची में नीचे परिभाषित है, तो उसे "defined" नहीं माना जाता।
...
एस्केप किए गए रेफरेंस कभी भी विस्तारित (expand) नहीं होते, चाहे संबंधित वेरिएबल परिभाषित हो या नहीं।
