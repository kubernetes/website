...
एक नोड (Node) पर चलने वाले प्रोग्रामों के उदाहरण हैं: {{< glossary_tooltip text="क्यूबलेट" term_id="kubelet" >}}, {{< glossary_tooltip text="क्यूब-प्रॉक्सी" term_id="kube-proxy" >}}, और कंटेनर रनटाइम जैसे कि {{< glossary_tooltip  text="डॉकर" term_id="docker" >}}
