...
feature:
  ...
  description: >
    कुबेरनेट्स विफल होने वाले कंटेनरों को पुनः आरंभ करता है, नोड्स के खराब होने पर कंटेनरों को बदलता और पुनर्निर्धारित करता है। यह उन कंटेनरों को हटा देता है जो आपके द्वारा परिभाषित स्वास्थ्य जांच का जवाब नहीं देते हैं, और जब तक कंटेनर सेवा देने के लिए तैयार नहीं हो जाते, तब तक उन्हें ग्राहकों को नहीं दिखाता।
content_type: concept
description: >-
  रेप्लिकासेट का उद्देश्य किसी भी समय चलने वाले रेप्लिका पॉड्स के एक स्थिर सेट को बनाए रखना है।
  आमतौर पर, आप एक परिनियोजन को परिभाषित करते हैं और उस परिनियोजन को रेप्लिकासेट्स को स्वचालित रूप से प्रबंधित करने देते हैं।
weight: 20
