...
- apiVersion: "apps/v1"
  kind: "Deployment"
feature:
  title: स्वचालित रोलआउट और रोलबैक
  description: >
    कुबेरनेट्स आपके एप्लिकेशन या उसकी कॉन्फ़िगरेशन में धीरे-धीरे बदलाव करता है और एप्लिकेशन की सेहत की निगरानी करते हुए यह सुनिश्चित करता है कि सभी उदाहरण एक साथ बंद न हों। अगर कुछ गलत होता है, तो कुबेरनेट्स आपके लिए बदलाव को वापस कर देगा। बढ़ते हुए परिनियोजन समाधानों के पारिस्थितिकी तंत्र का लाभ उठाएं।
description: >-
  एक डिप्लॉयमेंट किसी एप्लिकेशन वर्कलोड को चलाने के लिए पॉड्स के एक सेट का प्रबंधन करता है, आमतौर पर वह पॉड्स जो स्थिति को बनाए नहीं रखता है।
