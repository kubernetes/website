...
उदाहरण के लिए, पॉड्स में चलने वाले कंटेनर एक `kube_pod_container_info` मेट्रिक बनाते हैं।
इसमें लेबल के रूप में कंटेनर का नाम, जिस पॉड का यह हिस्सा है उसका नाम, जिस {{< glossary_tooltip text="namespace" term_id="namespace" >}} में पॉड चल रहा है, कंटेनर इमेज का नाम, इमेज की ID, कंटेनर के spec से इमेज का नाम, चल रहे कंटेनर की ID और पॉड की ID शामिल होती है।
...
यदि आप Prometheus या समान क्वेरी भाषा का उपयोग करने वाले किसी अन्य टूल का उपयोग करते हैं, तो निम्नलिखित PromQL क्वेरी उन पॉड्स की संख्या लौटाती है जो तैयार नहीं हैं:
...
यदि आप Prometheus या समान अलर्ट नियम भाषा का उपयोग करने वाले किसी समान टूल का उपयोग करते हैं, तो निम्नलिखित अलर्ट तब सक्रिय होगा जब ऐसे पॉड्स हों जो 5 मिनट से अधिक समय से `Terminating` स्थिति में हैं:
