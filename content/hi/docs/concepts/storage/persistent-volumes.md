...
- msau42
- xing-yang
title: परसिस्टेंट वॉल्यूम
api_metadata:
- apiVersion: "v1"
  kind: "PersistentVolume"
feature:
  title: स्टोरेज ऑर्कस्ट्रैशन
  description: >
    अपनी पसंद के स्टोरेज सिस्टम को स्वचालित रूप से माउंट करें, चाहे वह स्थानीय स्टोरेज से हो, सार्वजनिक क्लाउड प्रदाता से हो, या आईएससीएसआई या एनएफएस जैसे नेटवर्क स्टोरेज सिस्टम से हो।
