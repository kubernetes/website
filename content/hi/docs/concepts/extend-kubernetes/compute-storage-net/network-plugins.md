...
इम्प्लीमेंट करने के लिए आवश्यक CNI प्लगइन लोड करने के लिए कॉन्फ़िगर किया जाना चाहिए।

{{< note >}}
कुबरनेट्स 1.24 से पहले, CNI प्लगइन को `cni-bin-dir` और `network-plugin` कमांड-लाइन पैरामीटर का
उपयोग करके kubelet द्वारा भी मैनेज किया जा सकता था। ये कमांड-लाइन पैरामीटर कुबरनेट्स 1.24 में हटा दिए
गए, और CNI का मैनेजमेंट अब kubelet के दायरे में नहीं है।
...
किसी कंटेनर रनटाइम द्वारा CNI प्लगइन को मैनेज करने के तरीके के बारे में विशेष जानकारी के लिए, उस
कंटेनर रनटाइम का डॉक्यूमेंटेशन देखें, उदाहरण के लिए:

- [containerd](https://github.com/containerd/containerd/blob/main/script/setup/install-cni)
- [CRI-O](https://github.com/cri-o/cri-o/blob/main/contrib/cni/README.md)

किसी CNI प्लगइन को इंस्टॉल और मैनेज करने के तरीके के बारे में विशेष जानकारी के लिए, उस प्लगइन या
...
कुबरनेट्स नेटवर्क मॉडल को इम्प्लीमेंट करने के लिए नोड पर इंस्टॉल्ड CNI प्लगइन के अलावा, कुबरनेट्स को
यह भी आवश्यकता होती है कि कंटेनर रनटाइम एक लूपबैक इंटरफ़ेस `lo` प्रदान करे, जिसका उपयोग हर सैंडबॉक्स
(पॉड सैंडबॉक्स, vm सैंडबॉक्स, ...) के लिए किया जाता है। लूपबैक इंटरफ़ेस को इम्प्लीमेंट करना
...
CNI नेटवर्किंग प्लगइन `hostPort` को सपोर्ट करता है। आप CNI प्लगइन टीम द्वारा प्रदान किया गया आधिकारिक
...
अगर आप `hostPort` सपोर्ट एनेबल करना चाहते हैं, तो आपको अपने `cni-conf-dir` में `portMappings capability`
...
### ट्रैफ़िक शेपिंग का सपोर्ट

**एक्सपेरिमेंटल फ़ीचर**

CNI नेटवर्किंग प्लगइन पॉड ingress और egress ट्रैफ़िक शेपिंग को भी सपोर्ट करता है। आप CNI प्लगइन टीम
...
अगर आप ट्रैफ़िक शेपिंग सपोर्ट एनेबल करना चाहते हैं, तो आपको अपनी CNI कॉन्फ़िगरेशन फ़ाइल (डिफ़ॉल्ट
