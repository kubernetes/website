...
API के साथ एक्सटेंड करने की अनुमति देती है।
...
एग्रीगेशन लेयर kube-apiserver के साथ इन-प्रोसेस चलती है। जब तक कोई एक्सटेंशन रिसोर्स रजिस्टर नहीं हो
जाता, एग्रीगेशन लेयर कुछ नहीं करती। किसी API को रजिस्टर करने के लिए, आप एक _APIService_ ऑब्जेक्ट जोड़ते
हैं, जो कुबरनेट्स API में URL पाथ का "दावा" करता है। इस बिंदु पर, एग्रीगेशन लेयर उस API पाथ पर भेजी
गई किसी भी चीज़ (जैसे `/apis/myextension.mycompany.io/v1/…`) को रजिस्टर्ड APIService पर प्रॉक्सी कर
देगी।

APIService को इम्प्लीमेंट करने का सबसे सामान्य तरीका यह है कि आप अपने क्लस्टर में चलने वाले पॉड में एक
*एक्सटेंशन API सर्वर* चलाएँ। अगर आप अपने क्लस्टर में रिसोर्स मैनेज करने के लिए एक्सटेंशन API सर्वर का
...
* [डिक्लेरेटिव वैलिडेशन कॉन्सेप्ट](/docs/reference/using-api/declarative-validation/) के बारे में जानें,
  यह वैलिडेशन नियम परिभाषित करने का एक इंटरनल मैकेनिज़्म है जो भविष्य में एक्सटेंशन API सर्वर डेवलपमेंट
  के लिए वैलिडेशन सपोर्ट करने में मदद करेगा।
...
का उपयोग करके कुबरनेट्स API को कैसे एक्सटेंड करें।
