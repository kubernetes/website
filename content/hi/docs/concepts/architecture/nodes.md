...
इस अवधि को `--नोड-मॉनिटर-पीरियड` फ्लैग का उपयोग करके कॉन्फ़िगर किया जा सकता है
`क्यूब-नियंत्रक-प्रबंधक` घटक।

### बेदखली पर दर सीमा

 ज्यादातर मामलों में, नोड नियंत्रक बेदखली दर को सीमित करता है
`--नोड-बेदखली-दर' (डिफ़ॉल्ट 0.1) प्रति सेकंड, जिसका अर्थ है कि यह पॉड्स को बेदखल नहीं करेगा
...
`--नोड-बेदखली-दर` की सामान्य दर। कोने का मामला तब होता है जब सभी जोन होते हैं
