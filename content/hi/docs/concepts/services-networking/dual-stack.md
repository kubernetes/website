---
title: IPv4/IPv6 डुअल स्टैक
description: >-
  Kubernetes आपको सिंगल-स्टैक IPv4 नेटवर्किंग कॉन्फ़िगर करने देता है,
  सिंगल-स्टैक IPv6 नेटवर्किंग, या डुअल-स्टैक नेटवर्किंग
  दोनों नेटवर्क फैमिली सक्रिय हैं। यह पृष्ठ बताता है कि कैसे।
feature:
  title: IPv4/IPv6 डुअल स्टैक
  description: >
    पॉड्स और सर्विस को IPv4 और IPv6 अड्रेस का आवंटन
