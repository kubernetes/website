...
- apiVersion: "v1"
  kind: "Service"
feature:
  title: सर्विस डिस्कवरी और लोड बैलेंसिंग
  description: >
    किसी अपरिचित सर्विस डिस्कवरी तंत्र का उपयोग करने के लिए अपने एप्लिकेशन को संशोधित करने की आवश्यकता नहीं है। कुबेरनेट्स पॉड्स को अपने स्वयं के आईपी पते और पॉड्स के एक सेट के लिए एक एकल डीएनएस नाम देता है, और उन पर लोड-बैलेंस कर सकता है।
description: >-
  अपने क्लस्टर में एकल आउटवर्ड-फेसिंग के पीछे चल रहे एप्लिकेशन को बेनकाब करें
  समापन बिंदु, तब भी जब कार्यभार कई बैकएंड में विभाजित हो।
