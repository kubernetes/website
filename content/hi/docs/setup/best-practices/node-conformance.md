...
## नोड अनुरूपता परीक्षण कैसे चलाएं
...
1. क्यूबलेट के लिए `--kubeconfig` विकल्प के मान की गणना करें; उदाहरण के लिए:
    ...
    क्योंकि परीक्षण ढांचा क्यूबलेट का परीक्षण करने के लिए एक स्थानीय कण्ट्रोल प्लेन शुरू करता है,
...
कुबेरनेट्स अन्य वास्तुकला के लिए नोड अनुरूपता परीक्षण डॉकर चित्र भी प्रदान करता है:
...
## चयनित परीक्षण कैसे चलाएं 

विशिष्ट परीक्षण चलाने के लिए, पर्यावरण चर `FOCUS` को उन परीक्षणों की नियमित अभिव्यक्ति के साथ अधिलेखित करें, जिन्हें आप चलाना चाहते हैं।
...
विशिष्ट परीक्षणों को छोड़ने के लिए, पर्यावरण चर `SKIP` को उन परीक्षणों की नियमित अभिव्यक्ति के साथ अधिलेखित करें जिन्हें आप छोड़ना चाहते हैं।
