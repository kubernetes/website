...
=======
Linux और Windows वर्क-लोड को उनके संबंधित ओएस-विशिष्ट नोड्स पर रखें।
>>>>>>> 2b74a200d (content/hi/docs/setup/production-environment/windows/user-guide-windows-containers.md)
