...
Windows कंटेनर के साथ अपने अनुभव को शुरू करने के लिए नीचे दिए गए अनुभाग में उदाहरण दिया गया है।
...
नीचे दिया गया उदाहरण YAML फ़ाइल से एक साधारण वेबसर्वर एप्लिकेशन बनाता है। 
...
spec:
  ports:
    # जिस पोर्ट पर इस सेवा को काम करना चाहिए
    - port: 80
      targetPort: 80
  selector:
    app: win-webserver
...
1. परिनियोजन सफल हुआ यह सत्यापित करने के लिए:
...
## अवलोकनीयता (Observability) {#अवलोकनीयता}
...
उदाहरण के लिए विंडोज वर्कलोड आमतौर पर ETW (Event Tracing for Windows) में लॉग इन करने के लिए कॉन्फ़िगर किया गया है।
...
1. क्लस्टर व्यवस्थापक के रूप में उपयोग करके `kubectl create -f runtimeClasses.yml` चलाएँ
