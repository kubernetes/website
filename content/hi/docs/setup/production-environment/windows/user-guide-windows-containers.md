...
कुबेरनेट्स पर Windows कंटेनर को परिनियोजित करने के लिए, आपको पहले एक उदाहरण एप्लिकेशन बनाना होगा। 
...
1. जांचें कि परिनियोजन सफल हुआ। सत्यापित करना:
    ...
    * विंडोज नोड पर प्रति पॉड दो कंटेनर, उपयोग करें `docker ps` 
    ...
    * आउटबाउंड कनेक्टिविटी, `curl` बाहरी आईपी पॉड के अंदर से kubectl exec का उपयोग करके

{{< note >}}
विंडोज नेटवर्किंग स्टैक की वर्तमान प्लेटफॉर्म सीमाओं के कारण विंडोज कंटेनर होस्ट उन पर निर्धारित सेवाओं के आईपी तक पहुंचने में सक्षम नहीं हैं।
...
क्योंकि विंडोज कंटेनर और विंडोज कंटेनर के अंदर वर्कलोड Linux कंटेनर से अलग व्यवहार करते हैं,
