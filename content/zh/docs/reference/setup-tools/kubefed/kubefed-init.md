...
```
  ...
  -h, --help                                     init 的帮助信息
      ...
      --node-selector string                     逗号分隔的 nodeSelector 参数列表，例如："arg1=value1,arg2=value2..."
```
...
```
  ...
  -s, --server string                                Kubernetes API 服务器的地址和端口
      ...
      --username string                              用户名，用于 API 服务器的基本身份验证
  -v, --v Level                                      V 日志的日志级别
...
### 其他参考
* [kubefed](/docs/reference/setup-tools/kubefed/kubefed/)  - 用 kubefed 控制 Kubernetes 集群联邦

<!--
###### Auto generated by spf13/cobra on 25-Mar-2018
-->
###### 原文由 spf13/cobra 自动生成于 2018-3-25
