...
<table style="width: 100%; table-layout: fixed;">
  ...
  <tbody>
    ...
    <tr>
      ...
      -->
      API Server 将通知它正在监听的 IP 地址。如果没有设置，将使用默认网络接口。
      </td>
    </tr>
    ...
    <tr>
      ...
      -->
      用于 API Server 服务证书的可选额外替代名称（SANs）。可以同时使用 IP 地址和 DNS 名称。
      </td>
    </tr>
