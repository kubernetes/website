...
无论证书的到期日期如何，续订都会无条件地进行； SANs 等额外属性将基于现有文件/证书，因此无需重新提供它们。
...
<table style="width: 100%; table-layout: fixed;">
  ...
  <tbody>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">保存 certificates 的路径</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;"> CSR 和私钥输出路径</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">创建 CSR 而不是生成证书</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;"> apiserver-etcd-client 帮助</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">使用 Kubernetes 证书 API 续订证书</td>
    </tr>
