...
此注解表示 Kubernetes 审计日志中的请求是否被授权。
...
例子：`authorization.k8s.io/decision: "Human-readable reason for the decision"`

这个注解给出了 Kubernetes 审计日志中的 [decision](#authorization-k8s-io-decision) 的原因。
