...
[Install Docker Engine - Enterprise on Windows Servers](https://docs.microsoft.com/zh-CN/virtualization/windowscontainers/quick-start/set-up-environment?tabs=Windows-Server#install-docker)
处找到。
