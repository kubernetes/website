...
此外，你可以阅读 [检查 Dockershim 删除是否影响你](/zh/docs/tasks/administer-cluster/migrating-from-dockershim/check-if-dockershim-removal-affects-you/)
以检查它是否会影响你。
...
(参见 [从 dockercli 命令映射到 crictl](/zh/docs/reference/tools/map-crictl-dockercli/))；
对于后者，可以用新的容器创建选项，比如
