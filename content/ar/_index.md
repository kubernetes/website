...
[كوبيرنيتيس]({{< relref "/docs/concepts/overview/" >}})، يُعرف أيضًا باسم ك8س، هو نظام مفتوح المصدر لتنسيق، تكييف و إدارة التطبيقات المعبأة في حاويات.


يقوم بتجميع الحاويات التي تشكل تطبيقًا في وحدات منطقية لتسهيل الإدارة والاكتشاف. يستند كوبيرنيتيس على [15 عامًا من الخبرة في إدارة أعباء عمل الإنتاج في جوجل](http://queue.acm.org/detail.cfm?id=2898444)، إلى جانب أفضل الأفكار والممارسات من المجتمع.
{{% /blocks/feature %}}

{{% blocks/feature image="scalable" %}}
#### مهما كان المقياس

تم تصميم كوبيرنيتيس وفقًا لنفس المبادئ التي تسمح لجوجل بتشغيل مليارات الحاويات أسبوعيًا، ويمكنه التوسع دون الحاجة لزيادة فريق العمليات لديك.

{{% /blocks/feature %}}

{{% blocks/feature image="blocks" %}}
#### مهما كان التعقيد
سواء كنت تُجري إختبارا محليًا أو تدير مؤسسة عالمية، فإن مرونة كوبيرنيتيس تتكيف معك لتقديم تطبيقاتك دون إنقطاع وبسهولة بغض النظر عن مدى تعقيد حاجتك.
