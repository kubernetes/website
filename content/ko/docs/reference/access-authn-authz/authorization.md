...
인증에 대한 자세한 내용은 [쿠버네티스 API 접근 제어하기]((/docs/concepts/security/controlling-access/)를
참고한다.
...
* 인증에 대한 자세한 내용은 [쿠버네티스 API 접근 제어하기](/docs/concepts/security/controlling-access/)에서 **인증**을 참조한다.
