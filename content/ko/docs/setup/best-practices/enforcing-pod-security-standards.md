...
이 페이지에서는 [파드 보안 표준](/docs/concepts/security/pod-security-standards)을 
적용할때 관련된 모범 사례에 대한 개요를 제공합니다.

<!-- body -->

## 기본 제공되는 포드 보안 허용 컨트롤러 사용하기

{{< feature-state for_k8s_version="v1.23" state="beta" >}}

[파트 보안 허용 컨트롤러](/docs/reference/access-authn-authz/admission-controllers/#podsecurity)는
