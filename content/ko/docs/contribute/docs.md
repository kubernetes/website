...
이 웹사이트는 [쿠버네티스 SIG Docs](/ko/docs/contribute/#sig-docs에-참여)에 의해서 관리된다.
...
그림 1은 신규 기여자를 위한 로드맵을 간략하게 보여준다. `가입` 및 `리뷰` 단계의 일부 또는 전체를 따를 수 있다. 이제 `PR 열기` 아래에 나열된 항목들을 수행하여 당신의 기여 목표를 달성할 수 있다. 다시 말하지만 질문은 언제나 환영입니다!

일부 작업에는 쿠버네티스 조직에서 더 많은 신뢰와 더 많은 접근이 필요할 수 있다.
역할과 권한에 대한 자세한 내용은
[SIG Docs 참여](/ko/docs/contribute/participate/)를 본다.

## 첫 번째 기여

몇 가지 단계를 미리 검토하여 첫 번째 기여를 준비할 수 있습니다. 그림 2는 각 단계를 설명하며, 그 다음에 세부 사항도 설명되어 있다.
...
- [페이지 콘텐츠 유형](/docs/contribute/style/page-content-types/)과
  [휴고(Hugo) 단축코드(shortcodes)](/docs/contribute/style/hugo-shortcodes/)에 대해 배워본다.
...
- [SIG Docs](/ko/docs/contribute/participate/)에 참여하고,
  [멤버 또는 검토자](/ko/docs/contribute/participate/roles-and-responsibilities/)가 되어본다.

- [현지화](/ko/docs/contribute/localization_ko/)를 시작하거나 도와준다.
