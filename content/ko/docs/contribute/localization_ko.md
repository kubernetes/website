...
[용어집(Glossary)](/docs/reference/glossary)은 쿠버네티스 문서를 읽는 독자가 용어의 의미를 이해할 수 있도록 정의를 제공하기 위한 용어집이다.
해당 용어집은 Hugo의 툴팁 기능에 사용되며, 용어집의 목적에 따라 현지화 시 영문을 함께 병기한다. 
예를 들어, `파드(원문: Pod)`와 같이 표기한다.
