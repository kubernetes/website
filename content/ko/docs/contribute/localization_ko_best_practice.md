...
| 구분     | 설명                                           |
|----------|----------------------------------------------|
| [이슈](#이슈)        | 한글화 팀 내에서 진행된 논의 및 이슈        |
| [번역](#번역)        | 한국어 문체 및 표현 관련 사항             |
| [원문](#원문)        | 영어 원문 관련                         |
| [용어](#용어)        | 특정 용어에 대한 번역 방식                |
| [프로세스](#프로세스)  | 기여 프로세스 관련                      |
| [형식](#형식)        | 문서 형식 관련 규칙                     |
...
본 문서는 누구든지 참고하고, PR을 통해 추가 및 개선 할 수 있다.

- 신규 사례를 작성할 때는 다음의 작성 템플릿을 준수
- 추가 사례는 반드시 **한글화 팀 논의**나 **리뷰어 검토** 등 합의 근거 확인 필수
- 추가 사례의 경우, 이전 사례와 구분하기 위해 구분선(`---`)을 추가한 뒤 작성
- 사례에는 원문의 불필요한 부분은 제거하고 꼭 필요한 내용만 간결히 기록
- 사례 설명에서 강조가 필요한 부분은 마크다운(Markdown) 서식을 활용
...
#### 참고 링크
- [이슈 준수 관련 사례(#51885)](https://github.com/kubernetes/website/issues/51885#issuecomment-3301329235)
...
#### 참고 링크
- [번역 준수 관련 사례(#37514)](https://github.com/kubernetes/website/pull/37154#discussion_r987523014)
- [번역 준수 관련 사례(#51865)](https://github.com/kubernetes/website/pull/51864#discussion_r2265217513)
...
#### 참고 링크
- [번역 준수 관련 사례(#41253)](https://github.com/kubernetes/website/pull/41253#discussion_r1201534937)
- [번역 준수 관련 사례(#51871)](https://github.com/kubernetes/website/pull/51871#discussion_r2293015065)
...
#### 참고 링크
- [번역 준수 관련 사례(#51871)](https://github.com/kubernetes/website/pull/51871#discussion_r2292997194)
...
#### 참고 링크
- [번역 준수 관련 사례(#37154)](https://github.com/kubernetes/website/pull/37154#discussion_r987521776)

---

#### [번역] 블로그 게시글 번역 시 격식체(‘~습니다/합니다’체)를 사용한다.

#### 설명

- 블로그 게시글의 번역은 기술 문서와 달리 격식체를 사용한다.

#### 참고 링크
- [번역 준수 관련 사례(#52692)](https://github.com/kubernetes/website/pull/52692/files)
...
#### 참고 링크
- [프로세스 준수 관련 사례(#51845)](https://github.com/kubernetes/website/pull/51845#issuecomment-3213296290)

---

#### [프로세스] Github Profile Name은 가급적 영문으로 한다.
...
#### [프로세스] 이슈, 풀 리퀘스트, 커밋 메시지는 영문으로 작성한다.
...
#### 참고 링크
- [형식 준수 관련 사례(#51936)](https://github.com/kubernetes/website/pull/51936#discussion_r2323705504)
