...
- [용어집(Glossary)](/docs/reference/glossary)은 쿠버네티스 문서를 읽는 독자가 용어의 의미를 이해할 수 있도록 정의를 제공한다. 한글화 시, 해당 용어집의 목적을 고려하여 기존 영어 원문의 철자를 그대로 병기하여 독자가 원문의 철자를 빠르게 파악할 수 있도록 돕는다. 원문 병기 방식(예): `title: 파드(원문: Pod)` 
