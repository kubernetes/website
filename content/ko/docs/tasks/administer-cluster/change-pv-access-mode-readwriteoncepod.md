...
"cat-pictures-pv" 퍼시스턴트볼륨클레임(PersistentVolumeClaim)과, 해당 퍼시스턴트볼륨클레임을 
사용하는 "cat-pictures-writer" 디플로이먼트(Deployment)가 존재한다고 가정한다.
...
* [스토리지로 퍼시스턴트볼륨을 사용하도록 파드 구성하기](/docs/tasks/configure-pod-container/configure-persistent-volume-storage/)에 대해 더 알아보기.
