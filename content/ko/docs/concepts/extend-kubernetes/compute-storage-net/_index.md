...
* [CSI](/docs/concepts/storage/volumes/#csi) 와 [FlexVolume](/docs/concepts/storage/volumes/#flexvolume) 스토리지 플러그인
  ...
  [FlexVolume](/docs/concepts/storage/volumes/#flexvolume) 플러그인에 대한 지원도 포함한다.
