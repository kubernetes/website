...
이 페이지에서는 리눅스 운영 체제에서의 보안 고려 사항과 모범 사례에 대해 기술한다.
...
더 자세한 정보는 [스왑 메모리 관리](/docs/concepts/cluster-administration/swap-memory-management/#memory-backed-volumes)에서 
알아볼 수 있다.