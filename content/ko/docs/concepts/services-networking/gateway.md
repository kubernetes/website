...
이 API 종류의 전체 정의에 대해서는 [GRPC라우트](https://gateway-api.sigs.k8s.io/reference/api-spec/main/spec/#grpcroute)
레퍼런스를 참고한다.
...
[적합성](https://gateway-api.sigs.k8s.io/docs/concepts/conformance/) 문서를 참고한다.
...
모든 게이트웨이 API 종류에 대한 추가적인 세부 정보는 [API 사양](https://gateway-api.sigs.k8s.io/reference/api-spec/main/spec/)을
참고한다.
