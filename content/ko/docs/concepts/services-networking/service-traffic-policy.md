...
* [토폴로지 인지 라우팅](/docs/concepts/services-networking/topology-aware-routing/)에 대해서 읽기
...
* [서비스와 애플리케이션 연결하기](/docs/tutorials/services/connect-applications-service/) 를 따르기
