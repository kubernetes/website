...
* [초기화 컨테이너를 가진 파드 생성하기](https://kubernetes.io/ko/docs/tasks/configure-pod-container/configure-pod-initialization/)
* [초기화 컨테이너 디버깅](https://kubernetes.io/ko/docs/tasks/debug/debug-application/debug-init-containers/) 알아보기
* [kubelet](https://kubernetes.io/docs/reference/command-line-tools-reference/kubelet/)과 [kubectl](https://kubernetes.io/ko/docs/reference/kubectl/) 개요
* [프로브의 종류](https://kubernetes.io/ko/docs/concepts/workloads/pods/pod-lifecycle/#types-of-probe): liveness, readiness, startup 프로브
