...
CCM은 쿠버네티스 컨트롤러 매니저 (KCM)의 기능 일부를 독립시키고 분리된 프로세스로서 그것을 작동시킨다. 구체적으로, 클라우드 종속적인 KCM 내 컨트롤러들을 독립시킨다. KCM은 다음과 같은 클라우드 종속적인 컨트롤러 루프를 가진다.
...
위에서 강조되었던 4개의 공유 컨트롤러의 , 그리고 공유 cloudprovider 인터페이스와 더불어 일부 골격은 쿠버네티스 코어 내에 유지될 것이다. 클라우드 제공사업자 특유의 이행은 코어의 외부에 탑재되어 코어 내에 정의된 인터페이스를 이행할 것이다.
