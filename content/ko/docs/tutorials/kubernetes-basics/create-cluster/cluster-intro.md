...
스케줄링하거나, 애플리케이션의 의도한 상태를 유지하거나, 애플리케이션을 스케일링하고, 새로운
...
{{< glossary_tooltip term_id="cri-o" >}}와 같은 툴도 갖는다. 일반적이며 지원되는 배포
...
구동시킬지 스케줄한다. **kubelet과 같은 노드 수준의 컴포넌트는 컨트롤 플레인이 노출하는
[쿠버네티스 API](/docs/concepts/overview/kubernetes-api/)를 사용해서 컨트롤 플레인과 통신한다.**
...
첫 번째 앱을 배포하고 쿠버네티스 대시보드를 살펴보는 전체 과정은 [Hello Minikube](/docs/tutorials/hello-minikube/) 튜토리얼을 참고한다.
