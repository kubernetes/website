...
{{< note >}}
[로컬에서 Minikube](/docs/tasks/tools/install-minikube/)를 설치하셨다면 이 튜토리얼도 따라할 수 있습니다.
{{< /note >}}
...
1. **Launch Terminal** 을 클릭.
    ...
    {{< note >}}Minikube를 로컬에 설치했다면 `minikube start`을 실행합니다.{{< /note >}}

2. 브라우저에서 쿠버네티스 대쉬보드를 열어봅니다:
...
파드를 쿠버네티스 [*서비스*](/docs/concepts/services-networking/service/)로 노출해야 합니다.
