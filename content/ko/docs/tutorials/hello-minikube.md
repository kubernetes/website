...
설치 안내는 [minikube 시작](https://minikube.sigs.k8s.io/docs/start/)를 참조한다.
{{< /note >}}
...
minikube 툴은 활성화하거나 비활성화 할 수 있고 로컬 쿠버네티스 환경에서 접속해 볼 수 있는 내장 {{< glossary_tooltip text="애드온" term_id="addons" >}} 셋이 포함되어 있다.
