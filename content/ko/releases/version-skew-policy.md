...
자세한 내용은 [쿠버네티스 릴리스 버전](https://github.com/kubernetes/sig-release/blob/master/release-engineering/reference/versioning.md#kubernetes-release-versioning)을 참조한다.
