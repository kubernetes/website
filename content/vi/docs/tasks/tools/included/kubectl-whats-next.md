...
description: "Sau khi cài đặt kubectl, bước tiếp theo là gì?"
headless: true
_build:
  list: never
  render: never
...
* Học thêm về [kubectl](/docs/concepts/overview/kubectl/) và vai trò của nó trong hệ sinh thái Kubernetes.
