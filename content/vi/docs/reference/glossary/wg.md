...
Để biết thêm thông tin, xem repo [kubernetes/community](https://github.com/kubernetes/community) và danh sách hiện tại của [SIGs và working groups](https://github.com/kubernetes/community/blob/main/sig-list.md).
