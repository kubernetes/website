...
SIG phải tuân thủ [hướng dẫn quản trị SIG](https://github.com/kubernetes/community/blob/main/committee-steering/governance/sig-governance.md), nhưng có thể có chính sách đóng góp và kênh giao tiếp riêng.

Để biết thêm thông tin, hãy xem kho [kubernetes/community](https://github.com/kubernetes/community) và danh sách hiện tại các [SIG và Nhóm Làm Việc](https://github.com/kubernetes/community/blob/main/sig-list.md).
