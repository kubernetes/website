...
* [Thông tin thêm về FlexVolume](https://github.com/kubernetes/community/blob/main/contributors/devel/sig-storage/flexvolume.md)
* [Câu hỏi thường gặp về Volume Plugin cho nhà cung cấp Storage](https://github.com/kubernetes/community/blob/main/sig-storage/volume-plugin-faq.md)
