...
suivant les principes du topic [commencez à contribuer](/docs/contribute/start/),
...
à ce qu'une personne les fasses toutes tout le temps.

## Vérifier les pull requests

Au cours d’une semaine donnée, un approbateur spécifique des documentations se porte volontaire
pour effectuer le triage initial et revoir les [pull requests et issues](#triage-and-categorize-issues).
