...
[Kubernetes API](/fr/docs/concepts/overview/kubernetes-api/). When you use the `kubectl` command-line
...
[Kubernetes Object Management](/fr/docs/concepts/overview/working-with-objects/object-management/)
