...
В зависимотри от кластера узел может быть виртуальной или физической машиной. Каждый узел
...
Обычно у вас есть несколько узлов в кластере; в среде обучения или среде
...
1. Kubelet на узле саморегистрируется узел в плоскости управления
...
попробуйте создать Узел при помощи следующего JSON манифеста:
...
остановить проверку здоровья узла.
{{< /note >}}
