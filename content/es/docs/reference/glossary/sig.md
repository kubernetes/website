...
Los SIGs deben cumplir las guías de SIG [pautas de gobernanza](https://github.com/kubernetes/community/blob/main/committee-steering/governance/sig-governance.md), pero pueden tener sus propias normas de contribución y canales de comunicación.

Para más información, consulta el repositorio [kubernetes/community](https://github.com/kubernetes/community) y la lista de los [SIGs y Grupos de Trabajo (WGs)](https://github.com/kubernetes/community/blob/main/sig-list.md).
