...
* [Easegress IngressController](https://github.com/megaease/easegress/blob/main/doc/reference/ingresscontroller.md) es un [Easegress](https://megaease.com/easegress/) basado en una API Gateway que puede correr como un controlador Ingress.
