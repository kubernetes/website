...
Los usuarios pueden escribir sus propios controladores, como por ejemplo un planificador o [scheduler](https://github.com/kubernetes/community/blob/main/contributors/devel/scheduler.md),
usando [sus propias
