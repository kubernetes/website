...
Este proyecto introduce un sistema declarativo para gestionar los *taints* de los *nodes*, extendiendo las salvaguardas de preparación (*readiness*) durante el *bootstrapping* del *node* más allá de las condiciones estándar.
...
- **Definiciones de Readiness personalizadas**: Define qué significa que un *node* esté *ready* (listo) para tu plataforma específica.
...
El *controller* reacciona a las *Node Conditions* (condiciones del nodo) en lugar de realizar las verificaciones de estado por sí mismo. Este diseño desacoplado le permite integrarse sin problemas con otras herramientas del ecosistema, así como con soluciones personalizadas:
