...
Pod Security Admission یک کنترل‌کنندهٔ پذیرش است که هنگام ایجاد پادها،
[استانداردهای امنیت پاد](/docs/concepts/security/pod-security-standards/) را اعمال می‌کند.
این قابلیت در نسخهٔ ۱٫۲۵ به وضعیت GA (عرضهٔ عمومی) رسید.  
در این آموزش، استاندارد امنیت پاد `baseline` را به‌صورت جداگانه روی هر فضای نام اعمال خواهید کرد.

همچنین می‌توانید استانداردهای امنیت پاد را در سطح کلاستر و به‌طور هم‌زمان روی چند فضای نام اعمال کنید.  
برای دستورالعمل‌ها، به
[اعمال استانداردهای امنیت پاد در سطح کلاستر](/docs/tutorials/security/cluster-level-pss/) مراجعه کنید.
