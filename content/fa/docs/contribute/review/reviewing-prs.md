...
بازخورد زودهنگام درباره پست‌های وب‌نوشت از طریق Google Doc یا HackMD استقبال می‌شود.
لطفاً درخواست خود را از [کانال Slack #sig-docs-blog](https://kubernetes.slack.com/archives/CJDHVD54J) زودتر ارسال کنید.

پیش از بازبینی PRهای وب‌نوشت، با [راهنمای وب‌نوشت](/docs/contribute/blog/guidelines/)
و [ارسال پست وب‌نوشت و مطالعات موردی](/docs/contribute/new-content/blogs-case-studies/) آشنا باشید.
...
مقالات وب‌نوشت ممکن است شامل [نقل‌قول مستقیم](https://en.wikipedia.org/wiki/Direct_discourse) و
...
به‌عنوان پروژه، فقط زمانی مقالات وب‌نوشت را با برچسب نگه‌داری (`evergreen: true` در front matter) علامت می‌کنیم
...
[راهنمای محتوا](/docs/contribute/style/content-guide/) بدون قید و شرط بر مقالات وب‌نوشت
و PRهایی که آن‌ها را اضافه می‌کنند اعمال می‌شود. به یاد داشته باشید برخی محدودیت‌ها فقط
به مستندات مربوط‌اند و برای مقالات وب‌نوشت صدق نمی‌کنند.
