...
{{< توجه >}} اگر قبلاً درخواست ادغام خود را ارسال کرده‌اید و می‌دانید که شاخه پایه اشتباه بوده است، شما (و فقط شما، به عنوان ارسال‌کننده) می‌توانید آن را تغییر دهید. {{<
/توجه >}}
