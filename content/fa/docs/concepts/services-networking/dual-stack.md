---
title: دو پشته IPv4/IPv6
description: >-
  کوبرنتیز به شما امکان می‌دهد شبکه IPv4 تک پشته‌ای، شبکه IPv6 تک پشته‌ای یا شبکه دو پشته‌ای را با هر دو خانواده شبکه فعال پیکربندی کنید. این صفحه نحوه‌ی پیکربندی را توضیح می‌دهد..
feature:
  title: دو پشته IPv4/IPv6
  description: >
