...
- apiVersion: "v1"
  kind: "Service"
feature:
  title: کشف سرویس و تعادل بار
  description: >
    نیازی نیست برنامه خود را برای استفاده از یک سازوکار کشف سرویس ناآشنا تغییر دهید. کوبرنتیز به Podها نشانی IP مخصوص به خودشان و یک نام DNS واحد برای مجموعه‌ای از Podها می‌دهد و می‌تواند بین آنها تعادل بار ایجاد کند.
description: >-
  یک برنامه‌ی در حال اجرا در خوشه شما را پشت یک نقطه‌ی پایانی رو به بیرون قرار می‌دهد، حتی زمانی که حجم کار بین چندین backend تقسیم شده باشد.
