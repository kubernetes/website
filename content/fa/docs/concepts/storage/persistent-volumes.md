...
feature:
  title: ارکستراسیون ذخیره‌سازی
  description: >
    سیستم ذخیره‌سازی مورد نظر خود را، چه از ذخیره‌سازی محلی، چه از یک ارائه‌دهنده ابر عمومی یا یک سیستم ذخیره‌سازی شبکه‌ای مانند iSCSI یا NFS، به‌طور خودکار نصب کنید.
