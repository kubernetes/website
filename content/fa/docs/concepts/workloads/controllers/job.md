...
description: >-
  کارها نمایانگر وظایف یک‌باره هستند که تا اتمام اجرا می‌شوند و سپس متوقف می‌شوند..
feature:
  title: اجرای دسته‌ای
  description: >
    علاوه بر سرویس‌ها، کوبرنتیز می‌تواند بارهای کاری دسته‌ای و CI شما را مدیریت کند و در صورت تمایل، کانتینرهایی را که از کار می‌افتند، جایگزین کند.
weight: 50
