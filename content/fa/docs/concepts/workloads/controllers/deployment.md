...
- apiVersion: "apps/v1"
  kind: "Deployment"
feature:
  title: انتشار و انتشار مجدد خودکار
  description: >
...
description: >-
  یک Deployment مجموعه‌ای از Podها را برای اجرای یک بار کاری برنامه مدیریت می‌کند، که معمولاً برنامه‌ای است که وضعیت (state) را حفظ نمی‌کند.
