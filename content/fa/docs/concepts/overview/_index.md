...
* یک زبان یا سیستم پیکربندی (مانند Jsonnet) ارائه می‌دهد و نه استفاده از آن را الزامی می‌کند. در عوض، یک API اعلامی (Declarative API) فراهم می‌کند که می‌تواند توسط هر نوع مشخصات اعلامی مورد استفاده قرار گیرد.
