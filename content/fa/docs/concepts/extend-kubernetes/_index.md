---
title: گسترش کوبرنتیز
weight: 999 # this section should come last
description: روش‌های مختلف برای تغییر رفتار خوشه کوبرنتیز شما.
reviewers:
- xirehat
feature:
  title: طراحی شده برای توسعه‌پذیری
  description: >
    بدون تغییر کد منبع بالادست، ویژگی‌هایی را به خوشه کوبرنتیز خود اضافه کنید.
