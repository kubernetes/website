...
metadata:
  ...
  managedFields:
  - manager: kubectl
    operation: Apply #  توجه داشته باشید که با حروف بزرگ نوشته شده است: "Apply" (یا "Update")
    apiVersion: v1 
...
| Golang    | OpenAPI پسوند            | مقادیر ممکن                                 | توضیحات نشانگر                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| --------------- | ---------------------------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
## مهاجرت بین سمت کلاینت و سمت سرور اعمال می‌شود

### ارتقا از سمت کلاینت به سمت سرور اعمال می‌شود
...
### اعمال دانگرید از سمت سرور به سمت کلاینت
