...
* به دلیل احتمال تغییرات ناسازگار در نسخه‌های بعدی، فقط برای کاربردهای غیر حیاتی تجاری توصیه می‌شود. اگر چندین خوشه دارید که می‌توانند به طور مستقل ارتقا یابند، ممکن است بتوانید این محدودیت را کاهش دهید.
