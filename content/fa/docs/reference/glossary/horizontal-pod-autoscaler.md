---
title: مقیاس‌دهنده خودکار افقی پاد
id: horizontal-pod-autoscaler
date: 2018-04-12
full_link: /docs/tasks/run-application/horizontal-pod-autoscale/
short_description: >
  یک منبع API که تعداد رپلیکای پاد را بر اساس میزان استفاده هدف CPU یا اهداف سفارشی متریک به‌طور خودکار مقیاس می‌کند.
...
- operation
---
 یک منبع API که تعداد رپلیکای {{< glossary_tooltip term_id="pod" >}} را بر اساس میزان استفاده هدف CPU یا اهداف سفارشی متریک به‌طور خودکار مقیاس می‌کند.
