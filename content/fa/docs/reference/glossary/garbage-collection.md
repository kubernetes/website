...
short_description: >
  یک اصطلاح کلی برای سازوکارهای مختلفی که کوبرنتیز برای پاکسازی منابع کلاستر استفاده می‌کند.
...
جمع‌آوری زباله(Garbage Collection) یک اصطلاح کلی برای سازوکارهای مختلفی است که کوبرنتیز برای پاکسازی منابع کلاستر استفاده می‌کند. 
