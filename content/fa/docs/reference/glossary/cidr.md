...
در زمینه کوبرنتیز، به هر {{< glossary_tooltip text="Node" term_id="گره (Node)" >}} از طریق آدرس شروع و یک ماسک زیرشبکه با استفاده از CIDR، طیفی از آدرس‌های IP اختصاص داده می‌شود. این به گره‌ها اجازه می‌دهد تا به هر {{< glossary_tooltip text="Pod" term_id="پاد" >}} یک آدرس IP منحصر به فرد اختصاص دهند. اگرچه در ابتدا مفهومی برای IPv4 بود، CIDR گسترش یافته و شامل IPv6 نیز می‌شود. 
