...
{{< glossary_tooltip text="node" term_id="node" >}} در خوشه شما اجرا می‌شود و بخشی از مفهوم
...
kube-proxy در صورت وجود و در دسترس بودن، از لایه فیلتر بسته سیستم‌عامل استفاده می‌کند؛
