...
اگر یک پاد نتواند schedule شود، scheduler تلاش می‌کند پادهای با اولویت پایین‌تر را
[پیش‌دستی (preempt)](/docs/concepts/scheduling-eviction/pod-priority-preemption/#preemption)
کند (از دسترس خارج کند) تا scheduling (زمان بندی) پاد در انتظار (pending) ممکن شود.
