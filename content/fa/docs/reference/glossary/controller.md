...
short_description: >
  یک حلقه کنترلی که وضعیت مشترک کلاستر(cluster) را از طریق apiserver رصد می‌کند و با ایجاد تغییرات، سعی در انتقال وضعیت فعلی به سمت وضعیت مطلوب دارد.
...
- fundamental
---
در کوبرنتیز، کنترل‌کننده‌ها حلقه‌های کنترلی هستند که وضعیت {{< glossary_tooltip term_id="cluster" text="کلاستر">}} شما را زیر نظر دارند، سپس در صورت لزوم تغییراتی را اعمال یا درخواست می‌کنند. هر کنترل‌کننده سعی می‌کند وضعیت فعلی خوشه را به وضعیت مطلوب نزدیک‌تر کند.
