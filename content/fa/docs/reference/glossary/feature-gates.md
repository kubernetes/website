...
دروازه‌های ویژگی (Feature Gates) مجموعه‌ای از کلیدها (مقادیر رشته‌ای غیرشفاف) هستند که می‌توانید از آن‌ها برای کنترل فعال بودن ویژگی‌های کوبرنتیز در کلاستر خود استفاده کنید.
