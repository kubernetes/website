---
title: اخراج(eviction) به‌دلیل فشار گره
id: node-pressure-eviction
full_link: /fa/docs/concepts/scheduling-eviction/node-pressure-eviction/
short_description: >
  «اخراج به‌دلیل فشار گره» فرایندی است که در آن kubelet به‌صورت پیش‌دستانه
...
- operation
---
«اخراج به‌دلیل فشار گره» فرایندی است که در آن {{<glossary_tooltip term_id="kubelet" text="kubelet">}} به‌صورت پیش‌دستانه
...
«اویکشن به‌دلیل فشار گره» با [اخراج آغازشده از طریق API](/fa/docs/concepts/scheduling-eviction/api-eviction/) یکسان نیست.
