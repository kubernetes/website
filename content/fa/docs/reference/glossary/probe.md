...
- tool
---
 بررسی‌ای است که {{< glossary_tooltip text="kubelet" term_id="kubelet" >}} به‌طور دوره‌ای روی یک کانتینرِ در حال اجرای یک پاد انجام می‌دهد تا وضعیت و سلامت آن را تعیین کرده و چرخه عمر کانتینر را به‌روز کند.
