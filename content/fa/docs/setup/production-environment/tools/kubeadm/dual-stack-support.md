...
{{< note >}}
اگر در حال ارتقاء یک خوشه موجود با دستور `kubeadm upgrade` هستید، `kubeadm` از ایجاد تغییر در محدوده آدرس IP پاد ("cluster CIDR") و همچنین محدوده آدرس سرویس خوشه ("Service CIDR") پشتیبانی نمی‌کند.
{{< /note >}}

### ایجاد یک خوشه dual-stack 

برای ایجاد یک خوشه dual-stack  با `kubeadm init` می‌توانید آرگومان‌های خط فرمان را مشابه مثال زیر ارسال کنید:
...
شما می‌توانید یک خوشه تک پشته‌ای را که ویژگی شبکه دو پشته‌ای در آن فعال است، مستقر کنید.
{{< /note >}}
