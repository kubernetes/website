...
#reviewers:
#- Random-Liu
title: اعتبارسنجی تنظیمات گره(Node)
weight: 30
---
...
صلاحیت پیوستن به یک کلاستر کوبرنتیز را دارد.
...
* آزمون تعدادی image داکر را روی گره باقی می‌گذارد؛ از جمله image آزمون انطباق گره و image
