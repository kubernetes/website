...
اگر کوبرنتیز را با [kubeadm](/docs/reference/setup-tools/kubeadm/) نصب کنید، گواهینامه‌هایی که خوشه شما نیاز دارد به طور خودکار تولید می‌شوند.
...
این صفحه گواهینامه‌هایی را که خوشه شما نیاز دارد توضیح می‌دهد.
