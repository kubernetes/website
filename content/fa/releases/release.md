...
توجه: نسخه‌های ۱.۱۹ و جدیدتر، ۱ سال پشتیبانی انتشار (patch)وصله(patch) دریافت می‌کنند و نسخه‌های ۱.۱۸ و قبل از آن، ۹ ماه پشتیبانی انتشار وصله دریافت می‌کنند.
...
ددر زمان ایجاد، Pull Requestهایی که به شاخه `master` ارسال می‌شوند نیاز دارند که افراد به صورت دستی مشخص کنند که این PR باید به کدام milestone (milestone) اختصاص یابد.
