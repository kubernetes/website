...
![ایمیج یک چرخه انتشار کوبرنتیز](/images/releases/release-cycle.jpg)
...
گره github  این مسعولیت را بر عهده داردند که اپدیت ها و artifact  های جدید را بروز رسانی کنند 
[نگهداری می شود](https://git.k8s.io/sig-release/release-team/README.md#milestone-maintainers) بررسی میشنود و اخرین اپدیت های leadership ها در این جا قرار می گیرند این گروه توسط 
