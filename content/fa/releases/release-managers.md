...
- [رهبران SIG Release](#sig-release-leads)
  - [رؤسا](#chairs)
...
لطفا به [سیاست تحریم امنیتی](https://github.com/kubernetes/committee-security-response/blob/main/private-distributors-list) مراجعه کنید.
برای اطلاعات بیشتر
...
- [مدیران شاخه ها][handbook-branch-mgmt]
...
- هماهنگی و کاهش انتشارهای کوبرنتیز:
  ...
  چرخه انتشار
  - تنظیم [زمان‌بندی و آهنگ انتشار patch ها][patches]
