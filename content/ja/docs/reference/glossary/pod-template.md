...
[ワークロードコントローラー](/docs/concepts/workloads/controllers/)は、1つ以上の{{< glossary_tooltip text="Pod" term_id="pod" >}}を定義・管理するために、(DeploymentやStatefulSetのような別のオブジェクトの中に埋め込まれた)Podテンプレートを使用します。
