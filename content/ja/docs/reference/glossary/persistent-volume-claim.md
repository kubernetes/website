...
- storage
---
 {{< glossary_tooltip text="container" term_id="container" >}}内でボリュームとしてマウントするために {{< glossary_tooltip text="PersistentVolume" term_id="persistent-volume" >}}内で定義されたストレージリソースを要求します。
