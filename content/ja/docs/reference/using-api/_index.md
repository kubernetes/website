...
[API and release versioning proposal](https://github.com/kubernetes/sig-release/blob/master/release-engineering/reference/versioning.md)は、APIバージョニングとソフトウェアバージョニングの関係を説明しています。
