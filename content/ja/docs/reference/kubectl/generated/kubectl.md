...
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;"><p>使用するkubeconfigのクラスタ名</p></td>
</tr>
...
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;"><p>trueにすると、サーバー証明書の有効性を検証しません。この設定はHTTPS接続を非安全にします</p></td>
</tr>
...
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;"><p>KubernetesAPIサーバーのアドレスとポート</p></td>
</tr>
...
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;"><p>APIサーバーへの認証に使用するBearer token</p></td>
</tr>
...
<tr>
<td></td><td style="line-height: 130%; word-wrap: break-word;"><p>--versionまたは--version=rawを指定するとバージョン情報を表示して終了します。--version=vX.Y.Z...の形式で指定すると、出力されるバージョンを設定できます</p></td>
</tr>
...
* [kubectl apply](/docs/reference/kubectl/generated/kubectl_apply/)	 - ファイル名または標準入力から構成を適用します
...
* [kubectl config](/docs/reference/kubectl/generated/kubectl_config/)	 - kubeconfigファイルを操作します
...
* [kubectl delete](/docs/reference/kubectl/generated/kubectl_delete/)	 - ファイル名、標準入力、リソース名、またはラベルセレクターでリソースを削除します
...
* [kubectl kustomize](/docs/reference/kubectl/generated/kubectl_kustomize/)	 - ディレクトリまたはURLからkustomizationターゲットをビルドします
...
* [kubectl port-forward](/docs/reference/kubectl/generated/kubectl_port-forward/)	 - ローカルポートをPodにフォワードします
...
* [kubectl wait](/docs/reference/kubectl/generated/kubectl_wait/)	 - 実験的：1つまたは複数のリソースに対して特定の条件を待機します
