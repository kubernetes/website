...
Kubernetesでは、分離を改善し、コンテナ化されたワークロードを強化するために、Linuxカーネルの機能を設定して使用できます。
一般的な機能には、次のものがあります。
...
詳細については、[Podとコンテナにセキュリティコンテキストを設定する](/ja/docs/tasks/configure-pod-container/security-context/)を参照してください。
...
KubernetesでAppArmorを使用する方法については、[AppArmdiorでコンテナのリソースアクセスを制限する](/ja/docs/tutorials/security/apparmor/)を参照してください。
...
KubernetesでSELinuxを使用する方法については、[コンテナにSELinuxラベルを割り当てる](/ja/docs/tasks/configure-pod-container/security-context/#assign-selinux-labels-to-a-container)を参照してください。
...
コンテナの[`securityContext`](/ja/docs/tasks/configure-pod-container/security-context/)フィールドに`privileged: true`フィールドを設定すると、Pod内の任意のコンテナで*特権モード*を有効にできます。
...
* カーネルレベルのセキュリティケーパビリティを設定する前に、ネットワークレベルの分離の実装を検討すべきです。
  詳細については、[セキュリティチェックリスト](/ja/docs/concepts/security/security-checklist/#network-security)を参照してください。
...
手順については、[Podでユーザー名前空間を使用する](/ja/docs/tasks/configure-pod-container/user-namespaces/)を参照してください。

## {{% heading "whatsnext" %}}

* [AppArmorの使用方法を学ぶ](/ja/docs/tutorials/security/apparmor/)
* [seccompの使用方法を学ぶ](/ja/docs/tutorials/security/seccomp/)
* [SELinuxの使用方法を学ぶ](/ja/docs/tasks/configure-pod-container/security-context/#assign-selinux-labels-to-a-container)
