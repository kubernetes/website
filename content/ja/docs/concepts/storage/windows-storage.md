...
特定のストレージバックエンドやプロトコルに関連付けられた永続ボリュームの管理には、ボリュームのプロビジョニング・プロビジョニング解除・サイズ変更、Kubernetesノードへのアタッチ・デアタッチ、およびデータを永続化する必要があるPod内の各コンテナへのボリュームマウント・アンマウントといった操作が含まれます。
