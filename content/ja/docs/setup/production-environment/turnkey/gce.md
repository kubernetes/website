...
By default, some containers will already be running on your cluster. Containers like `fluentd` provide [logging](/ja/docs/concepts/cluster-administration/logging/), while `heapster` provides [monitoring](https://releases.k8s.io/master/cluster/addons/cluster-monitoring/README.md) services.
...
[Kubernetes Forum](https://discuss.kubernetes.io), or come ask questions on [Slack](/ja/docs/troubleshooting/#slack).
...
The [kubectl](/ja/docs/user-guide/kubectl/) tool controls the Kubernetes cluster
...
downloaded by the get.k8s.io install script. See [Installing kubectl](/ja/docs/tasks/kubectl/install/)
...
should show a set of [services](/ja/docs/user-guide/services) that look something like this:
...
Similarly, you can take a look at the set of [pods](/ja/docs/user-guide/pods) that were created during cluster startup.
...
Then, see [a simple nginx example](/ja/docs/user-guide/simple-nginx) to try out your new cluster.
