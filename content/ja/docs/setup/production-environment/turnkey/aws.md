...
* [conjure-up](/ja/docs/getting-started-guides/ubuntu/) is an open-source installer for Kubernetes that creates Kubernetes clusters with native AWS integrations on Ubuntu.
...
An up-to-date documentation page for this tool is available here: [kubectl manual](/ja/docs/user-guide/kubectl/)

By default, `kubectl` will use the `kubeconfig` file generated during the cluster startup for authenticating against the API.
For more information, please read [kubeconfig files](/ja/docs/tasks/access-application-cluster/configure-access-multiple-clusters/)

### 例

See [a simple nginx example](/ja/docs/tasks/run-application/run-stateless-application-deployment/) to try out your new cluster.
...
AWS                  | CoreOS       | CoreOS        | flannel     | [docs](/ja/docs/getting-started-guides/aws)      |          | Community
AWS                  | Juju         | Ubuntu        | flannel, calico, canal     | [docs](/ja/docs/getting-started-guides/ubuntu)      | 100%     | Commercial, Community
