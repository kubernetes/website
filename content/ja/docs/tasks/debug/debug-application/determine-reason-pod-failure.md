...
* [イメージ](/docs/concepts/containers/images/)の[ImagePullBackOff](/docs/concepts/containers/images/#imagepullbackoff)を参照
* [ログ取得](/docs/concepts/cluster-administration/logging/)について
* [Goテンプレート](https://pkg.go.dev/text/template)について
* [Podのステータス](/docs/tasks/debug/debug-application/debug-init-containers/#understanding-pod-status)と[Podのフェーズ](/docs/concepts/workloads/pods/pod-lifecycle/#pod-phase)について
* [コンテナのステータス](/docs/concepts/workloads/pods/pod-lifecycle/#container-states)について
