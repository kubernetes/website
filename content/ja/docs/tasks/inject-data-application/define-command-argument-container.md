...
つまり、[ConfigMap](/docs/tasks/configure-pod-container/configure-pod-configmap/)や[Secret](/docs/concepts/configuration/secret/)など、環境変数を定義するために利用可能な技術のどれを使っても、Podの引数を定義できるということです。
