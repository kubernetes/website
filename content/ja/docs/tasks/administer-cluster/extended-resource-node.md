...
* [拡張リソースをコンテナに割り当てる](/docs/tasks/configure-pod-container/extended-resource/)
* [DRAによる動的リソース割り当て](/docs/concepts/scheduling-eviction/dynamic-resource-allocation/#extended-resource)
