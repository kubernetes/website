...
{{% code_sample file="service/access/hello.yaml" %}}
...
{{% code_sample file="service/access/hello-service.yaml" %}}
...
{{% code_sample file="service/access/frontend.conf" %}}
...
{{% code_sample file="service/access/frontend.yaml" %}}
...
* [Service](/docs/concepts/services-networking/service/)の詳細
