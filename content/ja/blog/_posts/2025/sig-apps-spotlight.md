...
[charter](https://github.com/kubernetes/community/blob/main/sig-apps/charter.md#scope)に記載されているとおり、私たちはKubernetes上でアプリケーションを開発、デプロイ、運用することに関連する幅広い領域をカバーしています。
